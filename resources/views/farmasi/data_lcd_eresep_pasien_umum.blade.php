 ...
 {{-- <p class="text-right">* klik di mana saja, jika suara tidak muncul</p> --}}
  {{-- <div class="row">
    <div class="text-center col-md-12" style="margin: 3rem 0; height: 100%;">
      <h3 class="text-bold">UMUM</h3>
  ...
  <div class="row">
    <div class="text-center col-md-6" style="margin: 3rem 0; height: 100%;">
      ...
      @if (!empty($sedang_dipanggil_nonracik))
        <h2 class="text-bold" style="font-size: 300pt;" id="nomor_antrian">{{@$sedang_dipanggil_nonracik->kelompok.''.@$sedang_dipanggil_nonracik->nomor}}</h2>
        <h4 class="text-bold" style="font-size: 48pt;" id="nama_pasien">{{@$sedang_dipanggil_nonracik->pasien->nama}}</h4>
      @endif
    </div>

    <div class="text-center col-md-6" style="margin: 3rem 0; height: 100%;">
      <h3 class="text-bold">RACIK</h3>
      @if (!empty($sedang_dipanggil_racik))
        <h2 class="text-bold" style="font-size: 300pt;" id="nomor_antrian">{{@$sedang_dipanggil_racik->kelompok.''.@$sedang_dipanggil_racik->nomor}}</h2>
        <h4 class="text-bold" style="font-size: 48pt;" id="nama_pasien">{{@$sedang_dipanggil_racik->pasien->nama}}</h4>
      @endif
    </div>
  </div>
 {{-- <div class="row">
