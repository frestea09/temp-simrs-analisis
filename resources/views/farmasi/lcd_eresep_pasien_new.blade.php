    ...
    <div class="row">
      <div class="col-md-12">
            <div class="blockloket">
                <div class="loketheader text-center" style="font-size: 20pt !important;">
                    <td><img src="{{ asset('/images/'.configrs()->logo) }}" style="height: 70px"></td>
                    <td>Dashboard E-Resep Pasien {{date('d-m-Y')}} {{ucfirst($unit)}}</td>
                </div>
                <div class="text-center" style="z-index: 99">
                    <div style="background-color: red; padding:0px; color: white;">
                      <marquee direction="left"><h4 style="font-weight: bold;">Mohon menunggu antrian anda untuk dipanggil, terimakasih!</h4></marquee>
                    </div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $('.loading').css("display","none");
          $('#layarlcd').load("{{ route('farmasi.data_lcd_eresep_pasien_new', $unit) }}");
