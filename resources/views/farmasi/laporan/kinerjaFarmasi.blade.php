            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="user" class="form-control select2" style="width: 100%">
                  ...
                  @foreach (\App\User::all() as $d)
                    @if (isset($_POST['user']) && $_POST['user'] == $d->id)
                      <option value="{{ $d->id }}" selected="true">{{ baca_user($d->id) }}</option>
                    @else
                      <option value="{{ $d->id }}">{{ baca_user($d->id) }}</option>
                    @endif
                  @endforeach
                </select>
              </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <div class="col-sm-9 col-sm-offset-3">
                {{-- @if (Auth::user()->id == 671 || Auth::user()->id == 801 || Auth::user()->id == 716) --}}
