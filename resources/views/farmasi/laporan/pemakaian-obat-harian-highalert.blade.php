...
@section('header')
  <h1>Farmasi <small>LAPORAN HIGH ALERT</small></h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
        <form action="{{ url('farmasi/laporan/pemakaian-obat-harian-highalert') }}" class="form-horizontal" role="form" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="user" class="form-control select2" style="width: 100%">
                  ...
                  @foreach (Modules\Registrasi\Entities\Folio::where('jenis', 'ORJ')->groupBy('user_id')->get() as $d)
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <select name="obat" class="form-control select2" style="width: 100%">
                  <option value="">[--Semua--]</option>
                  @foreach (\App\Masterobat::whereNotNull('high_alert')->get() as $d)
              ...
              <div class='table-responsive'>
                  ...
                  @if (isset($data) && !empty($data))
                    @foreach ($data as $no => $d)
                      @php
                        ...
                        $pasien = \Modules\Pasien\Entities\Pasien::select('nama', 'no_rm', 'kelamin', 'alamat')->where('id', $d->pasien_id)->first();
                ...
                <tfoot>
                  <tr>
                    ...
                    <th class="text-right">{{ isset($data) && !empty($data) ? number_format($data->sum('hargajualtotal')) : NULL }}</th>
                  </tr>
                </tfoot>
              </table>
            </div>
