...
.table-hover>tbody>tr:hover {
  ...
  @endforeach
    <tr style="line-height:0.75;">
      @if( isset($folio->jasa_racik) )
      <td colspan="2"><i>Terbilang: {{ terbilang($total+$folio->jasa_racik+$uang_racik) }} rupiah</i></td>
      @else
      <td colspan="2"><i>Terbilang: {{ terbilang($total+0+$uang_racik) }} rupiah</i></td>
      @endif
    ...
    <tr style="line-height:0.75;">
      ...
      @else
      <th style="text-align: right">{{ number_format($total+0+$uang_racik) }}</th>
      @endif
    </tr>
  </table>
