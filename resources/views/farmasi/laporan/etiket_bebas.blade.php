  ...
  <div class="ticket">
      ...
      <table> 
        <tr>
          ...
          <td style="text-align: left">
            ...
            <span style="font-size:8px;font-family:Arial"><b>Apoteker : Adiyah, S.Farm.,MMRS</b></span><br>
      ...
      <table style="text-align: left;">
        <tbody>
          ...
          <tr>
            <th style="font-size:10px;font-family:Arial">{{ \Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->no_rm }}</th> <td style="font-size:10px;font-family:Arial"><b></b></td>
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"></td>
          </tr>
          <tr>
        ...
        <table style="text-align: left">
          <tbody>
            <tr>
              ...
              <td style="font-size:10px;"><b>{{ strtoupper($d->etiket) }}</b></td> 
              @else
              <th style="font-size:10px;"></th> <td style="font-size:9px;"></td> 
              @endif
            </tr>
            <tr>
              <td style="font-size:10px;"><b>{{ substr(strtoupper($d->masterobat->nama),0,20) }} / {{ strtoupper($d->informasi1) }} </b></td>
              @if( \App\LogistikBatch::where('id', $d->logistik_batch_id)->first() )
                <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"></b><b>{{ strtoupper($d->jumlah) }}.0 </b></b></td>
              @else
                <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial">  </td>
              @endif
            </tr>
            <tr>
              @if (\App\masterCaraMinum::where('id',$d->cara_minum_id)->first())
              <td style="font-size:10px;"><b>{{ strtoupper(\App\masterCaraMinum::where('id',$d->cara_minum_id)->first()->nama) }}</b></td>
              @else
              <th style="font-size:10px;"></th> <td style="font-size:9px;"></td> 
              @endif
            </tr>
