@extends('master')
@section('header')
  <h1>Lihat Elektronik Klaim BPJS Kesehatan Rawat Jalan / IGD</h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'inacbg/lihat-eklaim-irj-igd', 'class' => 'form-horizontal']) !!}
        <div class="row">
          <div class="col-sm-6">
            ...
            <tbody>
              ...
              @endphp
                <tr>
                  ...
                  <td>{{ $d->no_kartu }}</td>
                  <td>{{ date("d-m-Y", strtotime($d->tgl_regis)) }}</td>
                  <td>{{ date("d-m-Y", strtotime($d->tgl_regis)) }}</td>
                  ...
                  <td>
                    <a href="{{ url('/inacbg/hapus-eklaim-irj-igd/'.$d->id) }}" class="btn btn-md btn-danger btn-flat"><i class="fa fa-trash"></i></a>
                  </td>
                  <td class="text-center">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        @if( cekResume($d->registrasi_id) )
                        <li><a class="btn btn-md"  target="_blank" href="{{ url('/cetak-resume-medis/pdf/'.$d->registrasi_id) }}">Resume Medis</a></li>
                        @endif
                  ...
                  <td>
                    @if ($d->no_sep <> null)
                    <a href="{{ url('cetak-e-claim/'.$d->no_sep) }}" class="btn btn-md btn-danger btn-flat"><i class="fa fa-print"></i></a>                    @endif
                  </td>
                </tr>
              @endforeach
            </tbody>
