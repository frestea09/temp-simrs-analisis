...
<body onload="print()">
  ...
  <table border=0 style="width: 100%;"> 
    ...
    <tr>
      <th colspan="2" style="text-align: center"><br> KUITANSI RETURN DEPOSIT RAWAT INAP</th>
    </tr>
  ...
  <table class="table table-condensed" style="width: 100%">
    ...
    <tr>
      ...
      <td style="text-align: right; width: 10%"><i><b> Total Deposit </b></i></td>
