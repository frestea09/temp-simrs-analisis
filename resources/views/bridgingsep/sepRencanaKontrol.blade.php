@extends('master')
@section('header')
  <h1>SEP Rencana Kontrol<small></small></h1>
@endsection
        ...
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="tga" class="col-sm-3 control-label">Tgl.Awal</label>
              <div class="col-sm-9">
                <input type="text" name="tga" value="{{ date('d-m-Y') }}" class="form-control datepicker">
              </div>
            </div>
            <div class="form-group">
              <label for="tgb" class="col-sm-3 control-label">Tgl.Akhir</label>
              <div class="col-sm-9">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function tampilkanHistoriSEP() {
      $('.respon').html('');
      $.ajax({
        url: '/bridgingsep/sep-rencana-kontrol',
        type: 'POST',
        dataType: 'json',
