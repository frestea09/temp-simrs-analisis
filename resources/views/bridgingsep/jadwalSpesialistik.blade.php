@extends('master')
@section('header')
  <h1>Jadwal Spesialistik<small></small></h1>
@endsection
      ...
      <div class="row">
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">Nomor</label>
              <div class="col-sm-9">
            ...
            <table class="table table-hover table-bordered">
              <thead class="bg-primary">
                <tr>
                  ...
                  <th class="text-center" style="vertical-align: middle;">Kode Poli</th>
                  <th class="text-center" style="vertical-align: middle;">Nama Poli</th>
                  <th class="text-center" style="vertical-align: middle;">Kapasitas</th>
                  <th class="text-center" style="vertical-align: middle;">Jml.Rencana Kontrol & Rujukan </th>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function tampilkanHistoriSEP() {
      $('.respon').html('');
      $.ajax({
        url: '/bridgingsep/jadwal-spesialistik',
        type: 'POST',
        dataType: 'json',
