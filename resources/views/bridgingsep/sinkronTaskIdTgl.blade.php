        ...
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">Dari Tgl</label>
              <div class="col-sm-9">
                  <input type="date" name="tga" value="{{date('Y-m-d')}}" class="form-control" style="width: 100%">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">Sampai</label>
              <div class="col-sm-9">
                  <input type="date" name="tgb" value="{{date('Y-m-d')}}" class="form-control" style="width: 100%">
                  {{-- <small for=""><i>Jika jenis kontrol = SPRI, maka diisi nomor kartu; jika jenis kontrol = Rencana Kontrol, maka diisi nomor SEP</i></small> --}}
              </div>
            </div>
            <div class="form-group">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function tampilkanHistoriSEP() {
      $('.respon').html('');
      $.ajax({
        url: '/bridgingsep/sinkron-taskid-tgl',
        type: 'POST',
        dataType: 'json',
