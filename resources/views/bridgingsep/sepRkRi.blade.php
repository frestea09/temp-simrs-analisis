@extends('master')
@section('header')
  <h1>SEP Rencana Kontrol/SPRI<small></small></h1>
@endsection
        ...
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">Nomor Surat Kontrol Peserta</label>
              <div class="col-sm-9">
                  <input type="text" name="nomor" value="{{$no_spri}}" class="form-control" style="width: 100%">
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function deleteSurat() { 
      $.ajax({
        url: '/bridgingsep/hapus-surat-kontrol',
        type: 'POST',
        dataType: 'json',
