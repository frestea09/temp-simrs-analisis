@extends('master')
@section('header')
  <h1>Tambah Pasien Antrol<small></small></h1>
@endsection
        ...
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">No. RM</label>
              <div class="col-sm-9">
            ...
            <div class="form-group">
              <div class="col-sm-9 col-sm-offset-3">
                <span class="text-red">*</span> Klik Tombol <b><i>Enter</i></b> Di Keyboard Untuk Sinkron
                <button type="button" class="btn btn-primary btn-flat" onclick="tampilkanHistoriSEP()">SINKRON</button>
              </div>
            </div>
          </form>
        </div>
...
@section('script')
  ...
  <script type="text/javascript">
    ...
    function tampilkanHistoriSEP() {
      $('.respon').html('');
      $.ajax({
        url: '/bridgingsep/tambah-pasien-antrol',
        type: 'POST',
        dataType: 'json',
      ...
      .done(function(res) {
        ...
        // }
        if (data.code == '200') {
         return alert('Sukses Input pasien');
        }else{
