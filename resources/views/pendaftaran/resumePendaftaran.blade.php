        ...
        <div class="container">
            <div class="row setup-content" id="step-4">
                <div class="col-xs-12 col-md-6 col-md-offset-3">
                    ...
                    <a href="{{ url('pendaftaran/cetak_pendaftaran') }}" class="btn btn-success pull-right"><i class="fa fa-print"></i> Cetak</a>
                    <a href="{{ url('pendaftaran') }}" class="btn btn-primary pull-right"><i class="fa fa-arrow-left"></i> Kembali</a>
                </div>
            </div>
        </div>
    </body>
