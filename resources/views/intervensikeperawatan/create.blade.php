@extends('master')
@section('header')
  <h1>Buat Intervensi Keperawatan</h1>
@endsection
...
@section('content')
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          Tambah Intervensi Keperawatan &nbsp;
        </h3>
      </div>
      <div class="box-body">
        {!! Form::open(['method' => 'POST', 'route' => 'master-intervensi.store', 'class' => 'form-horizontal']) !!}
        ...
        <div class="form-group{{ $errors->has('nama_intervensi') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
                {!! Form::text('nama_intervensi', null, ['class' => 'form-control']) !!}
