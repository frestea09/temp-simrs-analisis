    ...
    <div class="col-md-12">
      <div class="col-md-6">
        <div class="box-loket">
              ...
              {!! Form::open(['method' => 'POST', 'url' => 'antrianfarmasi/savetouch']) !!}
              {!! Form::hidden('tanggal', date('Y-m-d')) !!}
              {!! Form::hidden('kelompok', 'U') !!}
              {!! Form::submit("UMUM", ['class' => 'btnTouch']) !!}
              {!! Form::close() !!}
      ...
      <div class="col-md-6">
        <div class="box-loket">
              ...
              {!! Form::open(['method' => 'POST', 'url' => 'antrianfarmasi/savetouch']) !!}
              {!! Form::hidden('kelompok', 'K') !!}
              {!! Form::hidden('tanggal', date('Y-m-d')) !!}
              {!! Form::submit("KRONIS", ['class' => 'btnTouch']) !!}
              {!! Form::close() !!}
        </div>
      </div>
    </div>
     ...
     <div class="col-md-12">
      <div class="col-md-6">
        <div class="box-loket">
              ...
              {!! Form::open(['method' => 'POST', 'url' => 'antrianfarmasi/savetouch']) !!}
              {!! Form::hidden('tanggal', date('Y-m-d')) !!}
              {!! Form::hidden('kelompok', 'N') !!}
              <button type="submit" class="btnTouch">NON KRONIS</button>
      ...
      <div class="col-md-6">
        <div class="box-loket">
              ...
              {!! Form::open(['method' => 'POST', 'url' => 'antrianfarmasi/savetouch']) !!}
              {!! Form::hidden('tanggal', date('Y-m-d')) !!}
              {!! Form::hidden('kelompok', 'R') !!}
              <button type="submit" class="btnTouch">RACIKAN</button>
              {{-- {!! Form::submit("", ['class' => 'btnTouch']) !!} --}}
              {!! Form::close() !!}
     ...
     {{-- <div class="col-md-6">
        <div class="box-loket">
              ...
              {!! Form::submit("PENYAKIT DALAM & JANTUNG", ['class' => 'btnTouch']) !!}
              {!! Form::close() !!}
