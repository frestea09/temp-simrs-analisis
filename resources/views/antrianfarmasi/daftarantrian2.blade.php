...
@section('header')
    <h1>Farmasi - Daftar Antrian Kronis </h1>
@endsection
...
@section('content')
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    @if ($d->status <= 2 || $d->finished_at == null)
                                                        <a href="{{ route('antrianfarmasi.panggilkembali2', $d->id) }}"
                                                ...
                                                @if ($d->registrasi_id != null)
                                                    ...
                                                    <td>
                                                        @if ($d->finished_at == null)
                                                            <a target="_blank"
                                                                href="{{ url('penjualan/form-penjualan-baru/' . @$d->registrasi->pasien->id . '/' . $d->registrasi->id) }}"
                                                ...
                                                @else
                                                    <td style="text-overflow: ellipsis">
                                                        <button class="btn btn-warning btn-flat btn-sm"
                                                            onclick="openModal({{ $d->id }})">Input Pasien</button>
                                                    </td>
                                                    <td>-</td>
                                                    <td>-</td>
                                                @endif
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#daftarantrian').load("{{ route('antrianfarmasi.daftarpanggil2') }}");
