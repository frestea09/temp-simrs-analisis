...
.table-hover>tbody>tr:hover {
  ...
  @foreach ($detail as $d)
    <tr style="line-height:0.75;">
      ...
      <td>{{ !empty($d->masterobat_id) ? baca_batches($d->masterobat_id) :'' }}</td>
  ...
  @endforeach
  <tr style="line-height:0.75;">
    <th style="text-align: right" colspan="6">Total Uang Racik</th>
    <th style="text-align: right">{{ number_format($uang_racik) }}</th>
  </tr>
  <tr style="line-height:0.75;">
    <th style="text-align: right" colspan="6">Total Harga</th>
    <th style="text-align: right">{{ number_format($total_harga_jual) }}</th>
  </tr>
    <tr style="line-height:0.75;">
      <th style="text-align: right" colspan="6">Total Tagihan</th>
      <th style="text-align: right">{{ number_format($totalharga_dan_uang_racik) }}</th>
    </tr>
  </table>
  </body>
</html>
