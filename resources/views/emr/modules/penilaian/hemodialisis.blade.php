...
@section('header')
    <h1>Penilaian Status Lokalis Hemodialisis</h1>
@endsection
            ...
            <form class="form-horizontal">
               ...
               @else --}}
                    <canvas id="canvas" width="600" height="400"
                        style="background-image: url('/images/hemo3.jpg')"></canvas>
                    {{-- @endif --}}
                </div>
                <div class="text-center" style="width: 100%; display:flex; justify-content:center; gap: 10px; margin-top: 10px">
        ...
        <script>
            function saveDrawing(event) {
                ...
                img.onload = function() {
                    ...
                    $.ajax({
                        url: "/emr-soap/penilaian/hemodialisis/" + unit + "/" + regId,
                        type: "POST",
                        data: formData,
                        headers: {
                        ...
                        success: function(data) {
                            ...
                            // window.location.href = "/emr-soap/pemeriksaan/hemodialisis/"+unit+"/"+regId+"?poli="+poli+"&dpjp="+dpjp;
