        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
                ...
                <div id="canvas_div" style="overflow-x: auto;">
                    <canvas id="canvas" width="1300" height="1300"
                        style="background-image: url('/images/prostodonti.png')">
                    </canvas>
                </div>
                ...
                <div class="col-md-12" style="margin: 20px 0px;">
                    ...
                    <table style="width: 100%; height: 150px;">
                        <tr>
                            <td>
                                RA :
                                <textarea name="fisik[keterangan][1]" type="{{$unit == "igd" ? "number" : "text"}}" class="form-control" id="keteranganRA" placeholder="Keterangan RA" rows="5" style="width: 80%;">{{ @$ketGambar['keterangan'][0][1] ? @$ketGambar['keterangan'][0][1] : '' }}</textarea>
                            </td>                            
                            <td>
                                RB :
                                <textarea name="fisik[keterangan][2]" type="{{$unit == "igd" ? "number" : "text"}}" class="form-control" id="keteranganRB" placeholder="Keterangan RB" rows="5" style="width: 80%;">{{ @$ketGambar['keterangan'][0][1] ? @$ketGambar['keterangan'][0][1] : '' }}</textarea>
                            </td> 
                        </tr>
                    </table>
                </div>
                ...
                <div class="col-md-12 text-right">
                    <a href="{{url('emr-soap-print-prostodonti/' . $reg->id)}}" target="_blank" class="btn btn-warning">Cetak</a>
        ...
        <script>
            function saveDrawing(event) {
                ...
                img.onload = function() {
                    ...
                    $.ajax({
                        url: "/emr-soap/penilaian/prostodonti/" + unit + "/" + regId,
                        type: "POST",
                        data: formData,
                        headers: {
                ...
                img.src = '/images/prostodonti.png';
            }
        </script>
    @endsection
