        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div id="canvas_div" style="overflow-x: auto;">
               ...
               @else --}}
                <canvas id="canvas" width="700" height="250" style="background-image: url('/images/mata3.PNG')"></canvas>
               {{-- @endif --}}
              </div>
...
function saveDrawing(event) {
    ...
    img.onload = function() {
        ...
        $.ajax({
            url: "/emr-soap/penilaian/mata3/" + unit + "/" + regId,
            type: "POST",
            data: formData,
            headers: {
