        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div id="canvas_div" style="overflow-x: auto;">
               ...
               @else --}}
                <canvas id="canvas" width="600" height="580" style="background-image: url('/images/paru3.png')"></canvas>
               {{-- @endif --}}
              </div>
...
function saveDrawing(event) {
    ...
    img.onload = function() {
        ...
        $.ajax({
            url: "/emr-soap/penilaian/paru/" + unit + "/" + regId,
            type: "POST",
            data: formData,
            headers: {
            ...
            success: function(data) {
                ...
                // window.location.href = "/emr-soap/pemeriksaan/paru/"+unit+"/"+regId+"?poli="+poli+"&dpjp="+dpjp;
