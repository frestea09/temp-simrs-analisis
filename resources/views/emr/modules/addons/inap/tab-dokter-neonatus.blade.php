...
<li class="dropdown">
    ...
    <ul class="dropdown-menu" role="menu">
        <li><a 
            href="{{ url('emr-soap/pemeriksaan/inap/catatan-harian/' . $unit . '/' . $registrasi_id . '?poli=' . $poli . '&dpjp=' . $dpjp) }}">
            Catatan Harian</a>
        </li>
        <li><a 
                href="{{ url('emr-soap/pemeriksaan/inap/lembar-rawat-gabung/' . $unit . '/' . $registrasi_id . '?poli=' . $poli . '&dpjp=' . $dpjp) }}">
                Lembar Rawat Gabung Bayi dengan Ibu</a>
        </li>
