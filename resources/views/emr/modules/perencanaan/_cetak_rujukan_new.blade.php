    ...
    <div class="row">
      <div class="col-sm-12 text-center">
        <hr>
          ...
          {{-- @php
              $spri = \App\SuratInap::where('registrasi_id', $registrasi_id)->first();
          @endphp --}}
          <table border=0 style="width: 100%;">
            <tr>
        ...
        <table border=0 style="width:100%">
            <tr>
                ...
                <td style="width:140px;text-align:center;"></td>
                <td style="width:140px;text-align:center;">Kabupaten Bandung, {{@$cetak->registrasi->created_at->format('d/m/Y') }}</td>
            </tr>
            <tr>
                <td colspan="4" scope="row" style="width:200px;padding-left:20px"></td>
                <td style="width:140px;text-align:center;"></td>
