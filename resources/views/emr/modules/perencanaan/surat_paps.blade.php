...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form method="POST" action="{{ url('emr-soap/perencanaan/surat-paps/' . $unit . '/' . $reg->id) }}"
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        {{-- Anamnesis --}}
                        <div class="col-md-6">
                            <h5><b>Surat Pernyataan Atas Permintaan Sendiri (APS)</b></h5>
                            <table style="width: 100%"
                                ...
                                <tr>
                                    <td style="width:20%;">Nama Saksi</td>
                                    <td style="padding: 5px;">
                                        <input type="text" name="form[saksi]" value="" class="form-control"/>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 50%; font-weight: bold;">Alasan Permintaan</td>
                                    <td>
                                        <textarea name="form[alasan]" id="" rows="3" style="display: inline-block;resize: vertical;"
                                ...
                                <div class="box-body table-responsive" style="max-height: 400px">
                                    <table style="width: 100%"
                                        ...
                                        @foreach ($riwayat as $item)
                                            @php
                                                $paps = json_decode($item->keterangan);
                                            @endphp
                                            <tr>
                                                <td>
                                                    <b>Nama Pemberi Pernyataan :</b> {{ @$paps->nama }}<br />
                                                    <b>Alamat Pemberi Pernyataan :</b> {{ @$paps->alamat }}<br />
                                                    <b>Sebagai/Selaku :</b> {{ @$paps->selaku }}<br />
                                                    <b>Alasan Permintaan :</b> {{ @$paps->alasan }}<br />
                                                    <b>Nama Saksi :</b> {{ @$paps->saksi }}<br />
                                                    ...
                                                    <span class="pull-right" style="font-size: 20px">
                                                        @if (empty(@$paps->paps_uploaded_file))
                                                            <a target="_blank"
                                                                href="{{ url('emr-soap-print-surat-paps/' . $unit . '/' . $reg->id . '/' . $item->id) }}"
                                                                data-toggle="tooltip" title="Cetak Surat"><i
                                                                    class="fa fa-print text-warning"></i></a>&nbsp;&nbsp;</a>
                                                        @else
                                                            <a target="_blank"
                                                                href="{{ url('paps/' . $paps->paps_uploaded_file) }}"
                                                                data-toggle="tooltip" title="Cetak Surat"><i
                                                                    class="fa fa-print text-success"></i></a>&nbsp;&nbsp;</a>
                                                    ...
                                                    <span class="pull-right" style="font-size: 20px">
                                                        <a
                                                        href="#"
                                                        data-toggle="tooltip" title="Upload Surat BerTTD"
                                                        onclick="showUploadFKTP({{$item->id}})"><i
                                                            class="fa fa-upload text-primary"></i></a>&nbsp;&nbsp;</a>
                                                    </span>
                                                    <span class="pull-right" style="font-size: 20px">
                                                        <a target="_blank" 
                                                            href="{{ url('/signaturepad/saksi-paps/'.@$item->id) }}"
                                                            data-toggle="tooltip" title="ttd saksi"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" >Upload APS</h4>
                    </div>
