...
@section('content')
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form method="POST" action="{{ url('emr-soap/pemeriksaan/rehab-medik/' . $unit . '/' . $reg->id) }}"
                        ...
                        @if (@$dataPegawai == '1')
                                        ...
                                        @foreach ($riwayats as $riwayat)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a href="{{ url('cetak-resume-medis-rencana-kontrol-rehab-medik/pdf/' . @$riwayat->registrasi_id . '/' . @$riwayat->id) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <table style="width: 100%"
                                    ...
                                    <div>
                                        ...
                                        {{ @$assesment['tanda_vital']['tekanan_darah1'] ? @$assesment['tanda_vital']['tekanan_darah1'] : '-' }}/{{ @$assesment['tanda_vital']['tekanan_darah2'] ? @$assesment['tanda_vital']['tekanan_darah2'] : '-' }}
                                        MMHG <br>
                                        <strong>Nadi:</strong>
                                        {{ @$assesment['tanda_vital']['nadi'] ? @$assesment['tanda_vital']['nadi'] : '-' }}
                                        X/Menit  <br>
                                        <strong>Suhu:</strong>
                                        {{ @$assesment['tanda_vital']['temp'] ? @$assesment['tanda_vital']['temp'] : '-' }}
                                        oC <br>
                                        <strong>Nafas:</strong>
                                        {{ @$assesment['tanda_vital']['RR'] ? @$assesment['tanda_vital']['RR'] : '-' }}
                                        X/Menit <br>
                                        <strong>Tinggi Badan:</strong>
                                        {{ @$assesment['tanda_vital']['TB'] ? @$assesment['tanda_vital']['TB'] : '-' }}
                                        cm <br>
                                        <strong>Berat Badan:</strong>
                                        {{ @$assesment['tanda_vital']['BB'] ? @$assesment['tanda_vital']['BB'] : '-' }}
                                        Kg <br>
                                    </div>
                                    <tr>
                                        <td style="padding: 5px;">
                                ...
                                <table style="width: 100%"
                                    class="table-striped table-bordered table-hover table-condensed form-box table"
                                    style="font-size:12px;">
                                    <h5><b>4. STATUS FUNGSIONAL</b></h5>
                                    <tr>
                                        <td style="width:20%;">Aktifitas dan mobilisasi</td>
                                        <td style="padding: 5px;">
                                            <div>
                                                <input type="radio" id="funsgional_1" name="fisik[statusFungsional][aktifitas]" value="Mandiri"
                                                {{ @$assesment['statusFungsional']['aktifitas'] == 'Mandiri' ? 'checked' : '' }}>
                                                <label for="funsgional_1" style="font-weight: normal; margin-right: 10px;">Mandiri</label>
                                            </div>
                                            <div>
                                                <input type="radio" id="funsgional_2" name="fisik[statusFungsional][aktifitas]" value="Perlu Bantuan"
                                                {{ @$assesment['statusFungsional']['aktifitas'] == 'Perlu Bantuan' ? 'checked' : '' }}>
                                                <label for="funsgional_2" style="font-weight: normal; margin-right: 10px;">Perlu Bantuan</label>
                                            </div>
                                            <div>
                                                <input type="radio" id="funsgional_3" name="fisik[statusFungsional][aktifitas]" value="Alat Bantu Jalan"
                                                {{ @$assesment['statusFungsional']['aktifitas'] == 'Alat Bantu Jalan' ? 'checked' : '' }}>
                                                <label for="funsgional_3" style="font-weight: normal; margin-right: 10px;">Alat Bantu Jalan</label>
                                            </div>
                                            <input type="text" name="fisik[statusFungsional][keterangan]" placeholder="[Keterangan Tambahan]"
                                                class="form-control" value="{{ @$assesment['statusFungsional']['keterangan'] }}">
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <div class="col-md-6">
                                ...
                                <table style="width: 100%"
                                    ...
                                    <tr>
                                        <td style="width:20%;">Pemeriksaan SSP ( NI – XIII )</td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][SSP]" placeholder="[Pemeriksaan SSP ( NI – XIII )]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['SSP'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" style="text-align: center;font-weight:bold">Pemeriksaan at Regio (a/r)</td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">a/r Head Neck </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][ARHeadNeck]" placeholder="[a/r Head Neck ]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['ARHeadNeck'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">a/r Thoraks </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][ARThoraks]" placeholder="[a/r Thoraks ]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['ARThoraks'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">a/r Abdomen </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][ARAbdomen]" placeholder="[a/r Abdomen ]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['ARAbdomen'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">a/r Back </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][ARBack]" placeholder="[a/r Back ]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['ARBack'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">a/r anggota gerak Look ( decomitas, pola jalan )
                                         </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][anggotaGerakLook]" placeholder="[a/r Look ( decomitas, pola jalan ) ]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['anggotaGerakLook'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;"> Feel ( tanda radang, nyeri tekan,tonus turgor ) </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][feel]" placeholder="[Feel ( tanda radang, nyeri tekan,tonus turgor )]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['feel'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">Movement ( ROM, MMT, Nyeri) Tes Provokasi
                                         </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][movement]" placeholder="[Movement ( ROM, MMT, Nyeri) Tes Provokasi]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['movement'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">Tes Fungsional
                                         </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[lokalisRehabMedik][fungsional]" placeholder="[Tes Fungsional]" class="form-control" value="{{ @$assesment['lokalisRehabMedik']['fungsional'] }}">
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table style="width: 100%"
                                    ...
                                    <tr>
                                        <td style="width:20%;">Impairment</td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[diagnosisRehabMedik][impairment]" placeholder="[Impairment]" class="form-control" value="{{ @$assesment['diagnosisRehabMedik']['impairment'] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">Disability </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[diagnosisRehabMedik][disability]" placeholder="[Disability]" class="form-control" value="{{ @$assesment['diagnosisRehabMedik']['disability '] }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:20%;">Handicap  </td>
                                        <td style="padding: 5px;">
                                            <input type="text" name="fisik[diagnosisRehabMedik][handicap]" placeholder="[Handicap  ]" class="form-control" value="{{ @$assesment['diagnosisRehabMedik']['handicap '] }}">
                                        </td>
                                    </tr>
                                </table>
                        ...
                        @else
                            ...
                            <div class="col-md-6">
                                ...
                                <table style="width: 100%" class="table-striped table-bordered table-hover table-condensed form-box table"
                                    ...
                                    <tr>
                                        <td style="font-weight:bold;">5. Assesmen Nyeri</td>
                                        <td>
                                            <a href="{{ url('/emr-soap/penilaian/fisik/' . $unit . '/' . @$reg->id . '?poli=' . $poli . '&dpjp=' . $dpjp) }}"
                                            title="Status Lokalis" class="btn btn-default btn-sm btn-flat"
                                            target="_blank"><i class="fa fa-pencil"> </i> Isi Lokalis</a>&nbsp;&nbsp;
                            ...
                            <div class="col-md-6">
                                ...
                                <table style="width: 100%" class="table-striped table-bordered table-hover table-condensed form-box table"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea rows="4" name="fisik[fisioterapi][diagnosa_fisioterapi]" style="display:inline-block; resize: vertical;"
                                                placeholder="[Masukkan Diagnosa Fisioterapi]" class="form-control">{{ @$assesment['fisioterapi']['diagnosa_fisioterapi'] }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Program / Rencana Fisioterapi</td>
                                        <td>
                                            <textarea rows="4" name="fisik[fisioterapi][rencana_fisioterapi]" style="display:inline-block; resize: vertical;"
                                                placeholder="[Masukkan Program / Rencana Fisioterapi]" class="form-control">{{ @$assesment['fisioterapi']['rencana_fisioterapi'] }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">Intervensi</td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <table class="table-striped table-bordered table-hover table-condensed form-box table" style="font-size:12px; width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th>No</th>
                                                        <th>Tanggal</th>
                                                        <th>Intervensi</th>
                                                        <th>Area yang diterapi</th>
                                                        <th>Fisioterapis</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi1][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi1']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi1][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi1']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi1][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi1']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi1][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi1']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">2</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi2][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi2']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi2][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi2']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi2][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi2']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi2][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi2']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">3</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi3][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi3']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi3][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi3']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi3][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi3']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi3][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi3']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">4</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi4][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi4']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi4][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi4']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi4][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi4']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi4][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi4']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">5</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi5][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi5']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi5][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi5']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi5][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi5']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi5][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi5']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">6</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi6][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi6']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi6][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi6']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi6][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi6']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi6][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi6']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">7</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi7][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi7']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi7][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi7']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi7][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi7']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi7][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi7']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">8</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi8][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi8']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi8][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi8']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi8][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi8']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi8][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi8']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">9</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi9][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi9']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi9][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi9']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi9][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi9']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi9][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi9']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 5%;">10</td>
                                                        <td style="width: 20%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi10][tanggal]" autocomplete="off" class="form-control date_tanpa_tanggal" value="{{@$assesment['fisioterapi']['intervensi10']['tanggal']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi10][intervensi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi10']['intervensi']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi10][area]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi10']['area']}}">
                                                        </td>
                                                        <td style="width: 25%;">
                                                            <input type="text" name="fisik[fisioterapi][intervensi10][fisioterapi]" autocomplete="off" class="form-control" value="{{@$assesment['fisioterapi']['intervensi10']['fisioterapi']}}">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <tr>
                                        <td>Evaluasi</td>
                                        <td>
                                            <textarea rows="4" name="fisik[fisioterapi][evaluasi]" style="display:inline-block; resize: vertical;"
                                                placeholder="[Masukkan Evaluasi]" class="form-control">{{ @$assesment['fisioterapi']['evaluasi'] }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Saran</td>
                                        <td>
                                            <textarea rows="4" name="fisik[fisioterapi][saran]" style="display:inline-block; resize: vertical;"
                                                placeholder="[Masukkan Saran]" class="form-control">{{ @$assesment['fisioterapi']['saran'] }}</textarea>
                                        </td>
                                    </tr>
                                </table>
