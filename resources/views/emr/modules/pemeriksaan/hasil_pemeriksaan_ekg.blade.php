...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr/upload-hasil/ekg/'.$unit.'/'.$reg->id) }}" class="form-horizontal" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <br>
          <h4 class="text-center"><b>Upload Hasil Pemeriksaan EKG</b></h4>
          <div class="col-md-12">
            <div class="col-md-6">
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Hasil Pemeriksaan EKG</h3>
