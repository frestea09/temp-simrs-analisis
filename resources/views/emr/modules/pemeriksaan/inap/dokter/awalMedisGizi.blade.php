...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_gizi/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis Gizi</b></h4>
          <br>

          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                <tr>
                  <td colspan="2" style="font-weight: bold;">Anamnesis</td>
                </tr>
                <tr>
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                <tr>
                  <td colspan="2" style="font-weight: bold;">Status Lokalis</td>
                </tr>
                <tr>
                  <td>Perubahan BB Selama 6 bulan terakhir</td>
                  <td>
                    <label for="penurunanBB_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][penurunanBB][jawaban]" value="Tidak Ada" id="penurunanBB_1" {{ @$assesment['statusLokalis']['penurunanBB']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="penurunanBB_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][penurunanBB][jawaban]" value="Ada Perubahan, Penurunan / Peningkatan < 5 %" id="penurunanBB_2" {{ @$assesment['statusLokalis']['penurunanBB']['jawaban'] == 'Ada Perubahan, Penurunan / Peningkatan < 5 %' ? 'checked' : '' }}>
                      Ada Perubahan, Penurunan / Peningkatan < 5 % (A)
                    </label>
                    <label for="penurunanBB_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][penurunanBB][jawaban]" value="Ada Perubahan, Penurunan / Peningkatan 5-10 %" id="penurunanBB_3" {{ @$assesment['statusLokalis']['penurunanBB']['jawaban'] == 'Ada Perubahan, Penurunan / Peningkatan 5-10 %' ? 'checked' : '' }}>
                      Ada Perubahan, Penurunan / Peningkatan 5-10 % (B)
                    </label>
                    <label for="penurunanBB_4" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][penurunanBB][jawaban]" value="Ada Perubahan, Penurunan / Peningkatan > 10 %" id="penurunanBB_4" {{ @$assesment['statusLokalis']['penurunanBB']['jawaban'] == 'Ada Perubahan, Penurunan / Peningkatan > 10 %' ? 'checked' : '' }}>
                      Ada Perubahan, Penurunan / Peningkatan > 10 % (B)
                    </label>
                    <label for="penurunanBB_5" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][penurunanBB][jawaban]" value="Tidak Tahu" id="penurunanBB_5" {{ @$assesment['statusLokalis']['penurunanBB']['jawaban'] == 'Tidak Tahu' ? 'checked' : '' }}>
                      Tidak Tahu (Tidak Dinilai)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[statusLokalis][penurunanBB][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['statusLokalis']['penurunanBB']['skor']}}">
                  </td>
                </tr>

                <tr>
                  <td>Perubahan Intake Makan, Perubahan dalam jumlah asupan akhir-akhir ini dibanding dengan kebiasaan</td>
                  <td>
                    <label for="perubahanIntake_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanIntake][jawaban]" value="Asupan cukup dan tida ada perubahan, kalaupun adanya sedikit dan tidak dalam waktu singkat" id="perubahanIntake_1" {{ @$assesment['statusLokalis']['perubahanIntake']['jawaban'] == 'Asupan cukup dan tida ada perubahan, kalaupun adanya sedikit dan tidak dalam waktu singkat' ? 'checked' : '' }}>
                    ...
                    <label for="perubahanIntake_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanIntake][jawaban]" value="Asupan menurun daripada sebelum sakit namun dalam tahap ringan" id="perubahanIntake_2" {{ @$assesment['statusLokalis']['perubahanIntake']['jawaban'] == 'Asupan menurun daripada sebelum sakit namun dalam tahap ringan' ? 'checked' : '' }}>
                      Asupan menurun daripada sebelum sakit namun dalam tahap ringan (B)
                    </label>
                    <label for="perubahanIntake_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanIntake][jawaban]" value="Asupan rendah tapi ada peningkatan" id="perubahanIntake_3" {{ @$assesment['statusLokalis']['perubahanIntake']['jawaban'] == 'Asupan rendah tapi ada peningkatan' ? 'checked' : '' }}>
                      Asupan rendah tapi ada peningkatan (B)
                    </label>
                    <label for="perubahanIntake_4" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanIntake][jawaban]" value="Asupan sangat tidak cukup dan menurun tahap berat daripada sebelumnya" id="perubahanIntake_4" {{ @$assesment['statusLokalis']['perubahanIntake']['jawaban'] == 'Asupan sangat tidak cukup dan menurun tahap berat daripada sebelumnya' ? 'checked' : '' }}>
                      Asupan sangat tidak cukup dan menurun tahap berat daripada sebelumnya (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[statusLokalis][perubahanIntake][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['statusLokalis']['perubahanIntake']['skor']}}">
                  </td>
                </tr>
                <tr>
                  <td>Perubahan Gastrointestinal</td>
                  <td>
                    <label for="perubahanGastro_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanGastro][jawaban]" value="Jika ada beberapa gejala atau tidak ada gejala, sebentar-sebentar" id="perubahanGastro_1" {{ @$assesment['statusLokalis']['perubahanGastro']['jawaban'] == 'Jika ada beberapa gejala atau tidak ada gejala, sebentar-sebentar' ? 'checked' : '' }}>
                      Jika ada beberapa gejala atau tidak ada gejala, sebentar-sebentar (A)
                    </label>
                    <label for="perubahanGastro_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanGastro][jawaban]" value="Jika ada beberapa gejala > 2 Minggu" id="perubahanGastro_2" {{ @$assesment['statusLokalis']['perubahanGastro']['jawaban'] == 'Jika ada beberapa gejala > 2 Minggu' ? 'checked' : '' }}>
                      Jika ada beberapa gejala > 2 Minggu (B)
                    </label>
                    <label for="perubahanGastro_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanGastro][jawaban]" value="Jika > 1 / Semua Gejala / Teratur > 2 Minggu" id="perubahanGastro_3" {{ @$assesment['statusLokalis']['perubahanGastro']['jawaban'] == 'Jika > 1 / Semua Gejala / Teratur > 2 Minggu' ? 'checked' : '' }}>
                      Jika > 1 / Semua Gejala / Teratur > 2 Minggu (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[statusLokalis][perubahanGastro][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['statusLokalis']['perubahanGastro']['skor']}}">
                  </td>
                </tr>
                <tr>
                  <td>Perubahan Kapasitas Fungsional</td>
                  <td>
                    <label for="perubahanKapasitas_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanKapasitas][jawaban]" value="Aktifitas normal, tidak ada kelainan, stamina tetap" id="perubahanKapasitas_1" {{ @$assesment['statusLokalis']['perubahanKapasitas']['jawaban'] == 'Aktifitas normal, tidak ada kelainan, stamina tetap' ? 'checked' : '' }}>
                      Aktifitas normal, tidak ada kelainan, stamina tetap (A)
                    </label>
                    <label for="perubahanKapasitas_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanKapasitas][jawaban]" value="Aktifitas ringan, mengalami sedikit penurunan" id="perubahanKapasitas_2" {{ @$assesment['statusLokalis']['perubahanKapasitas']['jawaban'] == 'Aktifitas ringan, mengalami sedikit penurunan' ? 'checked' : '' }}>
                      Aktifitas ringan, mengalami sedikit penurunan (B)
                    </label>
                    <label for="perubahanKapasitas_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][perubahanKapasitas][jawaban]" value="Tanpa aktifitas, di tempat tidur, penurunan stamina" id="perubahanKapasitas_3" {{ @$assesment['statusLokalis']['perubahanKapasitas']['jawaban'] == 'Tanpa aktifitas, di tempat tidur, penurunan stamina' ? 'checked' : '' }}>
                      Tanpa aktifitas, di tempat tidur, penurunan stamina (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[statusLokalis][perubahanKapasitas][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['statusLokalis']['perubahanKapasitas']['skor']}}">
                  </td>
                </tr>
                <tr>
                  <td>Penyakit dan hubungan dengan kebutuhan gizi</td>
                  <td>
                    <label for="kebutuhanGizi_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][kebutuhanGizi][jawaban]" value="Tidak Ada" id="kebutuhanGizi_1" {{ @$assesment['statusLokalis']['kebutuhanGizi']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="kebutuhanGizi_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][kebutuhanGizi][jawaban]" value="Ada, Rendah" id="kebutuhanGizi_2" {{ @$assesment['statusLokalis']['kebutuhanGizi']['jawaban'] == 'Ada, Rendah' ? 'checked' : '' }}>
                      Ada, Rendah (B)
                    </label>
                    <label for="kebutuhanGizi_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][kebutuhanGizi][jawaban]" value="Ada, Sedang" id="kebutuhanGizi_3" {{ @$assesment['statusLokalis']['kebutuhanGizi']['jawaban'] == 'Ada, Sedang' ? 'checked' : '' }}>
                      Ada, Sedang (B)
                    </label>
                    <label for="kebutuhanGizi_4" style="margin-right: 10px;">
                      <input type="radio" name="fisik[statusLokalis][kebutuhanGizi][jawaban]" value="Tinggi" id="kebutuhanGizi_4" {{ @$assesment['statusLokalis']['kebutuhanGizi']['jawaban'] == 'Tinggi' ? 'checked' : '' }}>
                      Tinggi (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[statusLokalis][kebutuhanGizi][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['statusLokalis']['kebutuhanGizi']['skor']}}">
                  </td>
                </tr>
                ...
                <tr>
                  <td>Kehilangan Lemak Subkutan (Trisep, Bisep)</td>
                  <td>
                    <label for="kehilanganLemakSubkutan_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganLemakSubkutan][jawaban]" value="Tidak Ada" id="kehilanganLemakSubkutan_1" {{ @$assesment['pemeriksaanFisik']['kehilanganLemakSubkutan']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="kehilanganLemakSubkutan_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganLemakSubkutan][jawaban]" value="Salah satu tempat" id="kehilanganLemakSubkutan_2" {{ @$assesment['pemeriksaanFisik']['kehilanganLemakSubkutan']['jawaban'] == 'Salah satu tempat' ? 'checked' : '' }}>
                      Salah satu tempat (B)
                    </label>
                    <label for="kehilanganLemakSubkutan_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganLemakSubkutan][jawaban]" value="Kedua Tempat" id="kehilanganLemakSubkutan_3" {{ @$assesment['pemeriksaanFisik']['kehilanganLemakSubkutan']['jawaban'] == 'Kedua Tempat' ? 'checked' : '' }}>
                      Kedua Tempat (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[pemeriksaanFisik][kehilanganLemakSubkutan][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['pemeriksaanFisik']['kehilanganLemakSubkutan']['skor']}}">
                  </td>
                </tr>                
                <tr>
                  <td>Kehilangan masa otot (Tulang selangka, scapula, belikat, tulang rusuk, betis)</td>
                  <td>
                    <label for="kehilanganMasaOtot_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganMasaOtot][jawaban]" value="Tidak Ada" id="kehilanganMasaOtot_1" {{ @$assesment['pemeriksaanFisik']['kehilanganMasaOtot']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="kehilanganMasaOtot_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganMasaOtot][jawaban]" value="Beberapa Tempat" id="kehilanganMasaOtot_2" {{ @$assesment['pemeriksaanFisik']['kehilanganMasaOtot']['jawaban'] == 'Beberapa Tempat' ? 'checked' : '' }}>
                      Beberapa Tempat (B)
                    </label>
                    <label for="kehilanganMasaOtot_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][kehilanganMasaOtot][jawaban]" value="Semua Tempat" id="kehilanganMasaOtot_3" {{ @$assesment['pemeriksaanFisik']['kehilanganMasaOtot']['jawaban'] == 'Semua Tempat' ? 'checked' : '' }}>
                      Semua Tempat (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[pemeriksaanFisik][kehilanganMasaOtot][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['pemeriksaanFisik']['kehilanganMasaOtot']['skor']}}">
                  </td>
                </tr>                
                <tr>
                  <td>Edema</td>
                  <td>
                    <label for="edema_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][edema][jawaban]" value="Tidak Ada" id="edema_1" {{ @$assesment['pemeriksaanFisik']['edema']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="edema_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][edema][jawaban]" value="Sedang / tungkai" id="edema_2" {{ @$assesment['pemeriksaanFisik']['edema']['jawaban'] == 'Sedang / tungkai' ? 'checked' : '' }}>
                      Sedang / tungkai (B)
                    </label>
                    <label for="edema_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][edema][jawaban]" value="Berat / anaraksa" id="edema_3" {{ @$assesment['pemeriksaanFisik']['edema']['jawaban'] == 'Berat / anaraksa' ? 'checked' : '' }}>
                      Berat / anaraksa (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[pemeriksaanFisik][edema][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['pemeriksaanFisik']['edema']['skor']}}">
                  </td>
                </tr>      
                ...
                <tr>
                  ...
                  <td>
                    <label for="asites_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][asites][jawaban]" value="Tidak Ada" id="asites_1" {{ @$assesment['pemeriksaanFisik']['asites']['jawaban'] == 'Tidak Ada' ? 'checked' : '' }}>
                      Tidak Ada (A)
                    </label>
                    <label for="asites_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][asites][jawaban]" value="Sedang" id="asites_2" {{ @$assesment['pemeriksaanFisik']['asites']['jawaban'] == 'Sedang' ? 'checked' : '' }}>
                      Sedang (B)
                    </label>
                    <label for="asites_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[pemeriksaanFisik][asites][jawaban]" value="Berat" id="asites_3" {{ @$assesment['pemeriksaanFisik']['asites']['jawaban'] == 'Berat' ? 'checked' : '' }}>
                      Berat (C)
                    </label>
                    <br>
                    <input type="text" onblur="hitungSkorSGA()" placeholder="Skor" name="fisik[pemeriksaanFisik][asites][skor]" class="form-control skorRiwayatMedis" value="{{@$assesment['pemeriksaanFisik']['asites']['skor']}}">
                  </td>
                </tr>   
                <tr>
                  <td>Keseluruhan Skor SGA</td>
                  <td>
                    <input id="totalSkorSGA" readonly type="text" name="fisik[totalSkorSGA]" class="form-control" value="{{@$assesment['totalSkorSGA']}}">
                  </td>
                </tr>        
                ...
                <tr>
                  ...
                  <td>
                    <label for="hasilSkrining_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[hasilSkrining]" value="Gizi Baik" id="hasilSkrining_1" {{ @$assesment['hasilSkrining'] == 'Gizi Baik' ? 'checked' : '' }}>
                      Gizi Baik
                    </label>
                    <label for="hasilSkrining_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[hasilSkrining]" value="Beresiko Malnutrisi / Malnutrisi Sedang" id="hasilSkrining_2" {{ @$assesment['hasilSkrining'] == 'Beresiko Malnutrisi / Malnutrisi Sedang' ? 'checked' : '' }}>
                      Beresiko Malnutrisi / Malnutrisi Sedang
                    </label>
                    <label for="hasilSkrining_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[hasilSkrining]" value="Malnutrisi Berat" id="hasilSkrining_3" {{ @$assesment['hasilSkrining'] == 'Malnutrisi Berat' ? 'checked' : '' }}>
                      Malnutrisi Berat
                    </label>
                  </td>
                </tr>
                ...
                <tr>
                  <td>Tindak Lanjut Skrining</td>
                  <td>
                    <label for="tindakLanjutSkrining_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[tindakLanjutSkrining]" value="Monitoring Umum" id="tindakLanjutSkrining_1" {{ @$assesment['tindakLanjutSkrining'] == 'Monitoring Umum' ? 'checked' : '' }}>
                      Monitoring Umum
                    </label>
                    <label for="tindakLanjutSkrining_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[tindakLanjutSkrining]" value="Konseling" id="tindakLanjutSkrining_2" {{ @$assesment['tindakLanjutSkrining'] == 'Konseling' ? 'checked' : '' }}>
                      Konseling
                    </label>
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2" style="font-weight: bold;">Konseling dan Edukasi Gizi</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Materi</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[konselingEdukasiGizi][materi]" style="display:inline-block; resize: vertical;" placeholder="" class="form-control" >{{@$assesment['konselingEdukasiGizi']['materi']}}</textarea>
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Leaflet yang diberikan</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[konselingEdukasiGizi][leaflet]" style="display:inline-block; resize: vertical;" placeholder="" class="form-control" >{{@$assesment['konselingEdukasiGizi']['leaflet']}}</textarea>
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Data Penting Terkait</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[konselingEdukasiGizi][dataPenting]" style="display:inline-block; resize: vertical;" placeholder="" class="form-control" >{{@$assesment['konselingEdukasiGizi']['dataPenting']}}</textarea>
                  </td>
                </tr>
          ...
          <div class="col-md-12">
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      <t style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_gizi/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          </a>
  ...
  <script type="text/javascript">
    ...
    function hitungSkorSGA(){
      var arr = document.getElementsByClassName('skorRiwayatMedis');
      var tot=0;
      for(var i=0;i<arr.length;i++){
          if(parseInt(arr[i].value))
              tot += parseInt(arr[i].value);
      }
      document.getElementById('totalSkorSGA').value = tot;
    }
  </script>
