...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr/upload-hasil/usg/'.$unit.'/'.$reg->id) }}" class="form-horizontal" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <br>
          <h4 class="text-center"><b>Upload Hasil Pemeriksaan USG</b></h4>
          <div class="col-md-12">
            <div class="col-md-6">
                ...
                <a href="{{ url('emr/cetak/usg/'.$unit.'/'.$registrasi_id) }}" target="_blank" class="btn btn-md btn-flat btn-danger">CETAK</a>
            </div>
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Hasil Pemeriksaan USG</h3>
