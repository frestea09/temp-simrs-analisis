...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ url('emr-soap/pemeriksaan/fisikCommon/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
          ...
          <div class="col-md-6">
            ...
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box"
              ...
              @if (@$reg->poli_id == '35')
                ...
                <tr>
                  <td style="width:20%;">B. Riwayat Penyakit Dahulu</td>
                  <td style="padding: 5px;">
                    <input type="text" name="fisik[riwayat_penyakit_dahulu]" class="form-control" id="" value="{{ @$assesment['riwayat_penyakit_dahulu'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width:20%;">C. Riwayat Penyakit Keluarga</td>
                  <td style="padding: 5px;">
...
<textarea rows="5" required name="fisik[pemeriksaan_fisik]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan Pemeriksaan Fisik]" class="form-control">
@if (!empty($assesment['pemeriksaan_fisik']))
{{ $assesment['pemeriksaan_fisik'] }}
@else
{{"Tekanan darah : " . (@$assesment['tanda_vital']['tekanan_darah'] ?? "")}}
{{"Nadi : " . (@$assesment['tanda_vital']['nadi'] ?? "")}}
{{"RR : " . (@$assesment['tanda_vital']['RR'] ?? "")}}
{{"Suhu : " . (@$assesment['tanda_vital']['temp'] ?? "")}}
{{"Berat Badan : " . (@$assesment['tanda_vital']['BB'] ?? "")}}
{{"Tinggi Badan : " . (@$assesment['tanda_vital']['TB'] ?? "")}}
@endif
</textarea>
            ...
            @if ($reg->poli_id == 44)
              <tr>
                  <td style="padding: 5px;">
                    ...
                    <textarea rows="3" name="fisik[catatan_dokter]" style="display:inline-block; resize: vertical;" placeholder="Catatan Dokter" class="form-control" >{{ @$assesment['catatan_dokter'] }}</textarea>
                  </td>
              </tr>
            @endif
              ...
              <div class="col-md-6">
                ...
                <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;"> 
                  ...
                  <tr>
                    ...
                    <td>
                      {{-- <input type="radio" id="riwayat_imunisasi1" name="fisik[keperawatanAnak][riwayat_imunisasi][pilihan]" value="BCG" {{@$assesment['keperawatanAnak']['riwayat_imunisasi']['pilihan'] == 'BCG' ? 'checked' : ''}}>
                      <label for="riwayat_imunisasi1" style="font-weight: normal; margin-right: 10px;">BCG</label>
                      <input type="radio" id="riwayat_imunisasi2" name="fisik[keperawatanAnak][riwayat_imunisasi][pilihan]" value="DPT" {{@$assesment['keperawatanAnak']['riwayat_imunisasi']['pilihan'] == 'DPT' ? 'checked' : ''}}>
                      <label for="riwayat_imunisasi2" style="font-weight: normal; margin-right: 10px;">DPT</label>
                      <input type="radio" id="riwayat_imunisasi3" name="fisik[keperawatanAnak][riwayat_imunisasi][pilihan]" value="Polio" {{@$assesment['keperawatanAnak']['riwayat_imunisasi']['pilihan'] == 'Polio' ? 'checked' : ''}}>
                      <label for="riwayat_imunisasi3" style="font-weight: normal; margin-right: 10px;">Polio</label>
                      <input type="radio" id="riwayat_imunisasi4" name="fisik[keperawatanAnak][riwayat_imunisasi][pilihan]" value="Campak" {{@$assesment['keperawatanAnak']['riwayat_imunisasi']['pilihan'] == 'Campak' ? 'checked' : ''}}>
                      <label for="riwayat_imunisasi4" style="font-weight: normal; margin-right: 10px;">Campak</label>
                      <input type="radio" id="riwayat_imunisasi5" name="fisik[keperawatanAnak][riwayat_imunisasi][pilihan]" value="Hepatitis B" {{@$assesment['keperawatanAnak']['riwayat_imunisasi']['pilihan'] == 'Hepatitis B' ? 'checked' : ''}}>
                      <label for="riwayat_imunisasi5" style="font-weight: normal; margin-right: 10px;">Hepatitis B</label> --}}
              ...
              <div class="col-md-6">
                ...
                <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;"> 
                  ...
                  <tr>
                    <td style="padding: 5px;">
                      <label class="form-check-label" style="font-weight: normal;">Berat Badan (kg)</label><br/>
                      <input type="text" name="fisik[tanda_vital][BB]" style="display:inline-block; width: 100px;" class="form-control bmi-input" id="" value="{{@$assesment['tanda_vital']['BB']}}">
                    </td>
                    <td style="padding: 5px;">
                      <label class="form-check-label" style="font-weight: normal;">Tinggi Badan (Cm)</label><br/>
                      <input type="text" name="fisik[tanda_vital][TB]" style="display:inline-block; width: 100px;" class="form-control bmi-input" id="" value="{{@$assesment['tanda_vital']['TB']}}">
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 5px;">
                      <label class="form-check-label" style="font-weight: normal;">Lingkar Perut (cm)</label><br/>
                      <input type="text" name="fisik[tanda_vital][lingkar_perut]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{ @$assesment['tanda_vital']['lingkar_perut'] }}">
                    </td>
                    <td style="padding: 5px;">
                  ...
                  <tr>
                    <td colspan="2" style="padding: 5px;">
                      ...
                      <input type="text" name="fisik[tanda_vital][BMI]" style="display:inline-block; width: 100%;" class="form-control" id="bmiScore" readonly value="{{ @$assesment['tanda_vital']['BMI'] ?? 0 }}">
                    </td>
                  </tr>
                  <script>
