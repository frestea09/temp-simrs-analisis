@extends('master')
@section('header')
<h1>Mapping Gigi & Mulut (RL 3.3)</h1>
@endsection
          ...
          <tr>
            ...
            <td>
              <div class="btn-group">
                ...
                <a href="{{ url('rekap-laporan/gigi-mulut/mapping/'.$item->id) }}" class="btn btn-primary btn-flat btn-sm"><i
                    class="fa fa-map"></i> </a>
...
<script>
  ...
  function detailMapping(id, name = '') {
        ...
        $('#tableDetailMapping').DataTable({
          ...
          processing  : true,
          serverSide  : true,
          ajax: '/rekap-laporan/mapping-detail/rl33/'+id,
          columns: [
    ...
    function hapusMapping(mastermapping_id, tarif_id) {
      if (confirm('Yakin akan dihapus') == true) {
        $.ajax({
          url: '/rekap-laporan/hapus-mapping/rl33/'+tarif_id,
          type: 'GET',
          dataType: 'json',
        })
        .done(function(data) {
