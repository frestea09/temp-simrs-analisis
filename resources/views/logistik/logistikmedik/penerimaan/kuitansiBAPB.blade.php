  ...
  <body>
	<table style="width: 100%; margin-left: 10px;">
  	...
  	<div class="row">
		...
		<br>
		<p style="width: 100%">
			Pada hari ini {{ $pemeriksa->created_at }}, dasar Keputusan Bupati Kuningan Nomor : {{ $pegawai->sk }}, tgl. 01 Januari 2018, yang bertanda tangan dibawah ini :
		</p>
		...
		<p style="width: 100%">
			...
			sesuai dengan isi BERITA ACARA PEMERIKSAAN BARANG, Nomor : {{ $pemeriksa->no_bapb }}  tanggal:  dengan nama barang terlampir dalam BAPB	
		</p>
		<br>
		<p style="width: 100%">
		...
		<table style="width: 100%">
			<tbody>
				<tr>
					...
					<th class="text-center">Kuningan, {{ $pemeriksa->created_at }}</th>
				</tr>
				<tr>
