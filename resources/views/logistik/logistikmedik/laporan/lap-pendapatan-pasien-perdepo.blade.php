...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      <form action="{{ url('logistikmedik/laporan/pendapatan-pasien-perdepo') }}" class="form-horizontal" role="form" method="POST">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-sm-12">
            ...
            <div class="form-group">
              <label for="periode" class="col-sm-3 control-label">Gedung</label>
              <div class="col-sm-4 {{ $errors->has('tgl_akhir') ? 'has-error' :'' }}">
                <select class="form-control select2" name="gudang">
                  @foreach (\App\Logistik\LogistikGudang::all('id','nama') as $d)
    ...
    <div class="box-header with-border">
      <h4 class="box-title">
        Pendapatan Obat Pasien Umum per Depo
      </h4>
    </div>
    <div class="box-body">
        <div class="row">
