        ...
        <form method="POST" action="{{ url('logistikmedik/export') }}" class="form-horizontal" id="filterGudang">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group">
                <label for="periode" class="col-sm-3 control-label"> Rawat Jalan</label>
                <div class="col-sm-9 {{ $errors->has('gudang') ? 'has-error' :'' }}">
                  <select name="apotikutama" class="form-control select2" style="width: 100%">
                    <option value="">[--Pilih--]</option>
                    @foreach (\App\Logistik\LogistikGudang::whereIn('id',['2'])->get() as $d)
                    @if (isset($_POST['apotikutama']) && $_POST['apotikutama'] == $d->id)
              ...
              <div class="form-group">
               ...
               {{-- {!! Form::text(null, ($bcgudang) ? $bcgudang->nama : null, ['class' => 'form-control', 'readonly' => true]) !!} --}}
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type="submit" name="cetak" class="btn btn-warning btn-flat fa-file-pdf" value="CETAK">
              ...
              <table class="table table-hover table-bordered table-condensed">
                <thead>
                  <tr>
                    ...
                    <th width="120px" class="text-center">Sisa Stok</th>
                ...
                @if (isset($opnames) && !empty($opnames))
                    @foreach ($opnames as $no => $d)
                      ...
                      <tr>
                        ...
                        <td>{{ $d->masuk }}</td>
                        <td>{{ $d->keluar }}</td>
                        <td>{{ number_format($d->hargaitem) }}</td>
...
@section('script')
  <script>
    ...
    function tampilkan(){
      ...
      //var per = $("select[name='periode']").val(), gdg = {{ $gudang }};
      var per = $("select[name='periode']").val(), gdg = {{ ($bcgudang) ? $bcgudang->id : null }};
