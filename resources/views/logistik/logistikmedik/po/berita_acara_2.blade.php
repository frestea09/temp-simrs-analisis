	...
	<div class="row">
		...
		<div class="row">
			<div class="col-sm-12 "> 
             ...
             {{ $po->tanggal }}, Maka Dengan Ini Kami Mengatakan Pesanan Barang / Jasa Dengan Perincian Sebagai Berikut :
            </div>
			<br/>
			<div class="col-sm-12">
						...
						<tbody>
							...
							@endforeach
								 ...
								 <tr>
									...
									<td colspan="3" class="text-right">
										@php
											$ppnAwal = $sum * $po->jml_ppn / 100;
											$ppnAkhir = $ppnAwal + $sum;
										@endphp
										Rp. {{ number_format($po->ppn) }}
									</td>
								 </tr>
								 <tr>
									<td colspan="5" class="text-right">
