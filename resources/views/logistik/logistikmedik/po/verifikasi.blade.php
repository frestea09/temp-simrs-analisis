...
<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="row">
          <form action="{{ url('logistikmedik/verifikasi-cari-po') }}" class="form-horizontal" role="form" method="POST">
            {{ csrf_field() }}
                ...
                @foreach ($po as $d)
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                          <a href="{{ url('logistikmedik/list-po/'.$no_po->id) }}" class="btn btn-sm btn-flat btn-warning" title="Klik untuk Lakukan Verifikasi"> <i class="fa fa-icon fa-book"></i></a>
                    </td>
                    <td class="text-center">
                    ...
                    {{-- <td class="text-center">
                        @if (\App\Logistik\LogistikSpk::where('no_po', $d->no_po)->count() > 0)
                          <i class="fa fa-check-square-o text-green"></i> &nbsp;&nbsp;
                        @else
                          <i class="fa fa-circle-thin text-red"></i>
                        @endif
                        <a class="btn btn-default btn-flat btn-sm" onclick="spk({{ $no_po->id }})">SPK</a>
                    </td> --}}
                  </tr>
                @endforeach
              </form>
