...
@section('header')
  <h1>
    <small>Kategori Obat</small> Non Generik
  ...
  <div class="box box-primary">
    <div class="box-body">
        <div class="table-responsive">
          <table class="table table-hover table-bordered table-condensed" id="obatNonGenerik">
            <thead>
              <tr>
                <th>No</th>
                <th>Nama Obat</th>
            ...
            <table class="table table-hover table-bordered table-condensed" id="dataMasterObat">
              <thead>
                <tr>
                  ...
                  <th>Nama Obat</th>
                  <th>Kode</th>
                  <th><button disabled class="btn btn-default btn-flat btn-sm"><i class="fa fa-plus"></i></button></th>
                </tr>
              </thead>
              <tbody>
                <tr>
...
<script type="text/javascript">
  var table;
  table = $('#obatNonGenerik').DataTable({
        "language": {
  ...
  var masterobat;
    masterobat = $('#dataMasterObat').DataTable({
        ...
        serverSide: true,
        ordering: false,
        ajax: '/data-master-obat/non_generik',
        columns: [
            {data: 'DT_RowIndex', orderable: false, searchable: false},
            {data: 'nama', orderable: false},
            {data: 'kode', orderable: false},
  ...
  function masterObat() {
    $('#dataObat').modal('show')
    $('.modal-title').text('Tambahkan Obat Non Generik')
    $('input[name="kategoriobat"]').val('non_generik');
  }
