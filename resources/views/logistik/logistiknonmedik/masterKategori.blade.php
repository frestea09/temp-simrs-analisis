@extends('master')
@section('header')
  <h1>Logistik Non Medik - Master Kategori</h1>
@endsection
...
@section('script')
  <script type="text/javascript">
    ...
    function edit(id){
      ...
      $.get('/logistiknonmedik/master-kategori/'+id+'/edit', function(resp){
          $('input[name="nama"]').val(resp.kategori.nama)
          $('input[name="kode"]').val(resp.kategori.kode)
      })
    }
    ...
    function save(){
        ...
        if(id == ''){
            var url = '{{ route('master-kategori.store') }}'
        } else {
            var url = '/logistiknonmedik/master-kategori/'+id
        }
