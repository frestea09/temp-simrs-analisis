@extends('master')
@section('header')
  <h1>Logistik Non Medik - Master Barang per Gudang</h1>
@endsection
              ...
              <div class="modal-body">
                  <form method="POST" class="form-horizontal" id="form">
                      ...
                      <div class="box-body">
                          ...
                          <div class="form-group">
                          <label for="kode" class="col-sm-4 control-label">Gudang</label>
                              <div class="col-sm-7 kodeGroup">
                                   <select name="gudang_id" class="form-control select2" id="gudang_id" style="width:100%"></select>
                              </div>
                          </div>
                          <div class="form-group">
...
@section('script')
  <script type="text/javascript">
    ...
    function tambah(){
      $('#Modal').modal('show')
      $('.modal-title').text('Tambah Barang Per Gudang')
      $('input[name="id"]').val('')
    ...
    function edit(id){
      $('#Modal').modal('show')
      $('.modal-title').text('Edit Barang Per Gudang')
      $('input[name="id"]').val(id)
      $('input[name="_method"]').val('PATCH')
      $.get('/logistiknonmedik/barang-pergudang/'+id+'/edit', function(resp){
          ...
          $('input[name="gudang_id"]').val(resp.barang.gudang_id)
      })
    }
    ...
    function save(){
        ...
        if(id == ''){
            var url = '{{ route('barang-pergudang.store') }}'
        } else {
            var url = '/logistiknonmedik/barang-pergudang/'+id
        }
    ...
    processing: true,
    serverSide: true,
    ajax: '{{ route('barang-pergudang.index') }}',
    columns: [
