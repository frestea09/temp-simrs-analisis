...
<div class="row">
  <div class="col-md-6">
      ...
      <div class="form-group{{ $errors->has('rujukan') ? ' has-error' : '' }}">
          {!! Form::label('cara_masuk', 'Cr Masuk', ['class' => 'col-sm-3 control-label']) !!}
          <div class="col-sm-9">
            <select name="cara_masuk"  class="form-control select2">
                <option value="Datang Sendiri" >Datang Sendiri</option>
                <option value="Rujukan Luar" >Rujukan Luar</option>
                <option value="Petugas Kesehatan" >Petugas Kesehatan Lain</option>
                <option value="KLL / Kasus Polisi" >KLL / Kasus Polisi</option>
            </select>
          </div>
      </div>
        <div class="form-group{{ $errors->has('rujukan') ? ' has-error' : '' }}">
    ...
    <div class="form-group{{ $errors->has('triage') ? ' has-error' : '' }}">
      ...
      <div class="col-sm-9">
        @if (@$unit == 'igd')
        <select class="form-control select2" id="triage" name="triage" required>
        @else
