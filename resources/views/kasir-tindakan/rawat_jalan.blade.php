        ...
        @foreach ($today as $key => $d)
          {{-- @if (total_tagihan($d->id) > 0) --}}
            <tr>
              ...
              @php
                $racik   = 0;
                $tagihan = total_tagihan_tindakan($d->id);
              @endphp
              ...
              <td class="text-center">@if ($tagihan == '0') Lunas @else Belum Lunas @endif</td>
              <td>
                @if ($d->lunas == 'Y' && (number_format($tagihan+$racik) == '0'))
      ...
      @isset($byRM)
        @foreach ($byRM as $key => $d)
          <tr>
            ...
            <td>{{ number_format(total_tagihan_tindakan($d->id)) }}</td>
            <td>
