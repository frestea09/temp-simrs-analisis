...
@section('header')
  <h1>Produk Hukum
    <a href="{{ url('hrd/administrasi/produk-hukum/create') }}" class="btn btn-default btn-flad btn-md">TAMBAH</a>
  </h1>
@endsection
...
@section('content')
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'hrd/administrasi/produk-hukum/byTanggal', 'class'=>'form-hosizontal']) !!}
     <div class="row">
       <div class="col-md-6">
                ...
                @foreach ($data as $key=>$item)
                  <tr>
                    ...
                    <td style="width:100px;">
                      ...
                      <a href="{{ url('hrd/administrasi/produk-hukum/create/'.$item->id) }}" class="btn btn-info btn-flat btn-xs"><i class="fa fa-edit"></i></a>  
                      <a onclick="return confirm('Yakin akan menghapus dokumen?')" href="{{ url('hrd/administrasi/produk-hukum/delete/'.$item->id) }}" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i></a>  
                    </td>
