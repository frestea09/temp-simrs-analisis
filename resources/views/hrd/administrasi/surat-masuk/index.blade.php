...
@section('header')
  <h1>Surat
    <a href="{{ url('hrd/administrasi/surat-masuk/create') }}" class="btn btn-default btn-flad btn-md">TAMBAH</a>
  </h1>
@endsection
...
@section('content')
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'hrd/administrasi/surat-masuk/byTanggal', 'class'=>'form-hosizontal']) !!}
     <div class="row">
       <div class="col-md-6">
                ...
                @foreach ($data as $key=>$item)
                  <tr>
                    ...
                    <td style="width:100px;">
                      ...
                      <a href="{{ url('hrd/administrasi/surat-masuk/create/'.$item->id) }}" class="btn btn-info btn-flat btn-xs"><i class="fa fa-edit"></i></a>  
                      <a onclick="return confirm('Yakin akan menghapus dokumen?')" href="{{ url('hrd/administrasi/surat-masuk/delete/'.$item->id) }}" class="btn btn-danger btn-flat btn-xs"><i class="fa fa-trash"></i></a>  
                    </td>
