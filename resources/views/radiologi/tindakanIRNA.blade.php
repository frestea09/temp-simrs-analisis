        ...
        <tbody>
          ...
          <tr>
           ...
           @endif
            ...
            <td class="text-center">
                    <a href="{{ url('radiologi/entry-tindakan-irna/'. $d->id.'/'.$d->pasien_id) }}" target="_blank"
            ...
            <td class="text-center">
              ...
              0)
              <a href="{{ url('radiologi/cetakRincianRad/irna/'.$d->id) }}" target="_blank"
