...
@section('header')
  <h1>Billing System Radiologi - Rawat Jalan </h1>
@endsection
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/folder.png') }}">
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        {!! Form::open(['method' => 'POST', 'url' => 'radiologi/tindakan-irj', 'class'=>'form-hosizontal']) !!}
        <div class="row">
          <div class="col-md-6">
          ...
          <table class='table table-striped table-bordered table-hover table-condensed' id='data'>
            ...
            <tbody>
              @foreach ($registrasi as $key => $d)
                  @php
                    // $folioRad = Modules\Registrasi\Entities\Folio::where('registrasi_id', $d->id)->where('poli_tipe', 'R')->count();
                  @endphp
