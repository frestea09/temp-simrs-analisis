@extends('master')
@section('header')
  <h1>Import File Pegawai <small></small></h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-8">
          {!! Form::open(['method' => 'POST', 'route' => 'import-pegawai', 'class' => 'form-horizontal','files'=>true]) !!}
            <div class="form-group">
                {!! Form::label('inputname', 'Download Template', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-9">
                  <a href="{{ route('template-pegawai') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cloud-download"></i> DOWNLOAD </a>
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('kategori', 'Kategori', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-9">
                  <select name="kategori" class="form-control chosen-select">
                    <option value=""></option>
                    @foreach (App\Kategoripegawai::all() as $d)
