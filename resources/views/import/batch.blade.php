@extends('master')
@section('header')
  <h1>Import File Batch <small></small></h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="row">
        <div class="col-md-8">
          {!! Form::open(['method' => 'POST', 'route' => 'import-batch', 'class' => 'form-horizontal','files'=>true]) !!}
            ...
            <div class="form-group{{ $errors->has('excel') ? ' has-error' : '' }}">
              <small>Template ada di folder public/template-import/template_logistikbatch.xls</small>
