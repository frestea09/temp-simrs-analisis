<html>
<head>
    <title>Signature Pad E-Resume</title>
        ...
        <div class="col-md-12 text-center">
            ...
            <form method="POST" id="signature-form">
                ...
                <div class="col-md-12 d-flex flex-column align-items-center">
                    ...
                    <br>
                    <label class="" for="">Tanda Tangan Sebagai ({{@$registrasi->pasien->nama}}):</label>
                    ...
                    <input type="text" name="nama" placeholder="Nama Penanggung Jawab" style="width: 360px; text-align:center;"><br>
...
<script type="text/javascript">
    ...
    $('#save').click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/signaturepad/e-resume/' + registrasi_id,
            data: dataPost,
            beforeSend: function (){
