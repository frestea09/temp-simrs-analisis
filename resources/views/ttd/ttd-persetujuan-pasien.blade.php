<html>
<head>
    <title>Signature Pad Surat Persetujuan Pasien</title>
        ...
        <div class="col-md-12 text-center">
            ...
            <form method="POST" id="signature-form">
                ...
                <div class="col-md-12 d-flex flex-column align-items-center">
                    ...
                    <br>
                    <label class="" for="">Tanda Tangan Sebagai ({{@$data->pasien->nama}}):</label>
                    <div class="col-4 p-0" style="border: 2px solid black; height: 400px;">
                        <canvas id="sig" ></canvas>
                    </div>
                    <br/>
                    <input type="hidden" name="registrasi_id" value="{{@$data->registrasi->id}}">
                    <input type="hidden" name="emr_perencanaan_id" value="{{@$data->id}}">
            ...
            <div id="ttd-sukses-msg" style="display: none;">
                ...
                <span class="text-danger">Halaman akan ditutup dalam <i>3 Detik</i></span>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $('#save').click(function(e) {
        ...
        let emr_perencanaan_id = $('input[name="emr_perencanaan_id"]').val();
        let dataPost = {
            signed: signaturePad.toDataURL(),
            _token: $('input[name="_token"]').val(),
            registrasi_id: registrasi_id,
            emr_perencanaan_id: emr_perencanaan_id,
        }

        $.ajax({
            type: 'POST',
            url: '/signaturepad/persetujuan-pasien/' + emr_perencanaan_id,
            data: dataPost,
            beforeSend: function (){
