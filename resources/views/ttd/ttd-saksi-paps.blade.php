<html>
<head>
    <title>Signature Pad Saksi Surat Pernyataan Atas Permintaan Sendiri</title>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12 text-center">
            <h4 class="text-center text-primary" style="font-weight: bold;">
                ...
                SAKSI SURAT PERNYATAAN ATAS PERMINTAAN SENDIRI
            </h4>
            ...
            <form method="POST" id="signature-form">
                ...
                <div class="col-md-12 d-flex flex-column align-items-center">
                    ...
                    <br>
                    <label class="" for="">Tanda Tangan Sebagai ({{@$ket->saksi}}):</label>
                    ...
                    <input type="hidden" name="riwayat_id" value="{{@$paps->id}}">
...
<script type="text/javascript">
    ...
    $('#save').click(function(e) {
        ...
        let riwayat_id = $('input[name="riwayat_id"]').val();
        let dataPost = {
        ...
        $.ajax({
            type: 'POST',
            url: '/signaturepad/saksi-paps/' + riwayat_id,
            data: dataPost,
            beforeSend: function (){
