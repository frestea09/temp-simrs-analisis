<html>
<head>
    <title>Signature Pad Surat Pulang Paksa</title>
        ...
        <div class="col-md-12 text-center">
            ...
            <form method="POST" id="signature-form">
                ...
                <div class="col-md-12 d-flex flex-column align-items-center">
                    ...
                    <embed src="{{"data:application/pdf;base64, $pdfBase64"}}" width="100%" height="500px" />
                    <br>
                    <label class="" for="">Tanda Tangan Sebagai ({{@$registrasi->pasien->nama_keluarga}}):</label>
...
<script type="text/javascript">
    ...
    $('#save').click(function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '/signaturepad/surat-pulang-paksa/' + registrasi_id,
            data: dataPost,
            beforeSend: function (){
