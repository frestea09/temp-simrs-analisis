...
@section('content')
    <div class="box box-primary">
        <div class="box-header with-border">
            <h3 class="box-title">Idrg Rincian Biaya</h3>
        ...
        <div class="box-body">
            <form class="form-horizontal" action="{{ url('simpan-idrg-biaya') }}"  method="post">
                ...
                <div class="bg-success">
                    <div class="form-group {{ $errors->has('idrg_biaya_id') ? ' has-error' : '' }}">
                        <label for="master" class="col-md-2 control-label">Kelompok Tarif</label>
                        <div class="col-md-3">
            ...
            <div class="col-sm-12 text-center">
                <button class="btn btn-success" onclick="checkAll()">Checklist Semua</button>
            </div>
        </div>
    </div>
@endsection
