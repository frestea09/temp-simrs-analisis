<div class="row">
  <div class="col-md-6">
    <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
          ...
          @else
            {!! Form::select('status', $status, 1, ['class' => 'chosen-select']) !!}
          @endif
  ...
  <div class="col-md-6">
    <div class="form-group{{ $errors->has('tipe_layanan') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::select('tipe_layanan', $tipelayanan, null, ['class' => 'chosen-select']) !!}
    ...
    <div class="form-group{{ $errors->has('poli_id') ? ' has-error' : '' }}">
      ...
      <div class="col-sm-9">
        <select class="chosen-select" name="poli_id" required>
          <option value=""></option>
