<div class="col-sm-6">
    ...
    <div class="form-group{{ $errors->has('kategori_pegawai') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-8">
            {!! Form::select('kelompok_pegawai', [NULL => ' ', '1'=>'Pegawai Tetap','2'=>'Fungsional', '3'=>'Dokter', '4'=>'Perawat', '5'=>'BHL', '6'=>'Nutrisionis', '7'=>'Dokter Anestesi', '8'=>'Penata Anestesi', '9'=>'Apotek'], null, ['class' => 'form-control select2']) !!}
