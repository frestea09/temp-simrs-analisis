...
<body>
                ...
                <div class="col-md-12">
                    <div class="col-sm-12">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="H_antrian" class="nomor_antrian">
                                    {{ @$antrianH->kelompok . @$antrianH->nomor }}</div> --}}
                                {{-- <div id="H_nama" class="nama_pasien">
                                    {{ @$antrianH->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_hematologi_dan_onkologi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianH->register_antrian->nomorantrian) )
                                            <div id="13_antrian" class="nomor_antrian">
                                                {{ @$antrianH->kelompok . @$antrianH->nomor }}
                                            </div>
                                        @else
                                            <div id="13_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianH->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="13_antrian" class="nomor_antrian">
                                            {{ @$antrianH->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="13_nama" class="nama_pasien">
                                            {{ @$antrianH->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="MCU_antrian" class="nomor_antrian">
                                    {{ @$antrianMCU->kelompok . @$antrianMCU->nomor }}</div> --}}
                                {{-- <div id="MCU_nama" class="nama_pasien">
                                    {{ @$antrianMCU->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_mcu">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianMCU->register_antrian->nomorantrian) )
                                            <div id="35_antrian" class="nomor_antrian">
                                                {{ @$antrianMCU->kelompok . @$antrianMCU->nomor }}
                                            </div>
                                        @else
                                            <div id="35_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianMCU->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="35_antrian" class="nomor_antrian">
                                            {{ @$antrianMCU->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="35_nama" class="nama_pasien">
                                            {{ @$antrianMCU->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="KK_antrian" class="nomor_antrian">
                                    {{ @$antrianKK->kelompok . @$antrianKK->nomor }}</div> --}}
                                {{-- <div id="KK_nama" class="nama_pasien">
                                    {{ @$antrianKK->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-3" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-3">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_kulit_dan_kelamin">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianKK->register_antrian->nomorantrian) )
                                            <div id="17_antrian" class="nomor_antrian">
                                                {{ @$antrianKK->kelompok . @$antrianKK->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="17_antrian" class="nomor_antrian">
                                            {{ @$antrianKK->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="17_nama" class="nama_pasien">
                                            {{ @$antrianKK->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv6/belum-dipanggil',
                success: function (data) {
                // HEMATOLOGI & ONKOLOGI
                let poli_h = data[0];
                poli_h.sort((a, b) => {
                    ...
                    poli_h.forEach(h => {
                        if (h != null) {
                            // if (bacaNomorAntrianBPJS(h.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(h.nomorantrian)}</td>
                            //                 <td class="text-center">${h?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                            html += `<tr>
                                        <td class="nomor">${h.nomorantrian}</td>
                                        <td class="text-center">${h?.nama ?? ''}</td>
                                    </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_hematologi_dan_onkologi').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_hematologi_dan_onkologi').html('');
                    }
                    html = null;
                    ...
                    poli_mcu.forEach(mcu => {
                        if (mcu != null) {
                            // if (bacaNomorAntrianBPJS(mcu.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(mcu.nomorantrian)}</td>
                            //                 <td class="text-center">${mcu?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${mcu.nomorantrian}</td>
                                            <td class="text-center">${mcu?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_mcu').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_mcu').html('');
                    }
                    html = null;
                    ...
                    poli_kk.forEach(kk => {
                        if (kk != null) {
                            // if (bacaNomorAntrianBPJS(kk.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(kk.nomorantrian)}</td>
                            //                 <td class="text-center">${kk?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${kk.nomorantrian}</td>
                                            <td class="text-center">${kk?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_kulit_dan_kelamin').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_kulit_dan_kelamin').html('');
                    }
                    html = null;
                }
            });
