...
<body>
                        ...
                        <div class="blockloket">
                            ...
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianOrto->register_antrian->nomorantrian) )
                                            <div id="18_antrian" class="nomor_antrian">
                                                {{ @$antrianOrto->kelompok . @$antrianOrto->nomor }}
                                            </div>
                                        @else
                                            <div id="18_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianOrto->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="18_antrian" class="nomor_antrian">
                                            {{ @$antrianOrto->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="18_nama" class="nama_pasien">
                                            {{ @$antrianOrto->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2"">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_bedahAnak">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        ...
                                        @else
                                            <div id="28_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianBA->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="28_antrian" class="nomor_antrian">
    ...
    <script type="text/javascript">
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv10/belum-dipanggil',
                success: function (data) {
                    // Orthopedi
                    let poli_orto = data[0];
                    ...
                    let html;
                    poli_orto.forEach(orto => {
                        if (true) {
                                html += `<tr>
                                            <td class="nomor">${orto.nomorantrian}</td>
                                            <td class="text-center">${orto.nama ?? ''}</td>
                                        </tr>`
                        }
                    })
                    ...
                    poli_ba.forEach(ba => {
                        if (true) {
                                html += `<tr>
                                            <td class="nomor">${ba.nomorantrian}</td>
                                            <td class="text-center">${ba.nama ?? ''}</td>
                                        </tr>` 
                        }
                    })
                    $('#antrian_belum_dipanggil_bedahAnak').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_bedahAnak').html('');
                    }
                    html = null;
                }
            });
