...
<body>
                ...
                <div class="col-md-12">
                    <div class="col-sm-12">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="D_antrian" class="nomor_antrian">
                                    {{ @$antrianD->kelompok . @$antrianD->nomor }}</div> --}}
                                {{-- <div id="D_nama" class="nama_pasien">
                                    {{ @$antrianD->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_penyakit_dalam">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianD->register_antrian->nomorantrian) )
                                            <div id="2_antrian" class="nomor_antrian">
                                                {{ @$antrianD->kelompok . @$antrianD->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="2_antrian" class="nomor_antrian">
                                            {{ @$antrianD->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="2_nama" class="nama_pasien">
                                            {{ @$antrianD->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="PR_antrian" class="nomor_antrian">
                                    {{ @$antrianPR->kelompok . @$antrianPR->nomor }}</div> --}}
                                {{-- <div id="PR_nama" class="nama_pasien">
                                    {{ @$antrianPR->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_paru">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianPR->register_antrian->nomorantrian) )
                                            <div id="41_antrian" class="nomor_antrian">
                                                {{ @$antrianPR->kelompok . @$antrianPR->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="41_antrian" class="nomor_antrian">
                                            {{ @$antrianPR->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="41_nama" class="nama_pasien">
                                            {{ @$antrianPR->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="J_antrian" class="nomor_antrian">
                                    {{ @$antrianJ->kelompok . @$antrianJ->nomor }}</div> --}}
                                {{-- <div id="J_nama" class="nama_pasien">
                                    {{ @$antrianJ->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-3" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-3">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_jantung">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianJ->register_antrian->nomorantrian) )
                                            <div id="14_antrian" class="nomor_antrian">
                                                {{ @$antrianJ->kelompok . @$antrianJ->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="14_antrian" class="nomor_antrian">
                                            {{ @$antrianJ->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="14_nama" class="nama_pasien">
                                            {{ @$antrianJ->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    antrianDipanggil.forEach(antrian => {
                        if(antrian != null){
                            if (baca_nomorantrian_bpjs(antrian.register_antrian.nomorantrian)) {
                                ...
                                audios.push(
                                    ...
                                    ...baca_nomorantrian_bpjs(antrian.register_antrian.nomorantrian).substr(0, 3).split('').map(char => new Audio('/audio/' + char + ".mp3")),
                                    // new Audio('/audio/' + antrian.regDummy.nomorantrian.substr(11) + '.mp3'),
                                    new Audio('/audio/' + baca_nomorantrian_bpjs(antrian.register_antrian.nomorantrian).substr(3) + '.mp3'),
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv3/belum-dipanggil',
                success: function (data) {
                    // Penyakit Dalam
                    console.log(data);
                    let poli_penyakit_dalam =  Object.values(data[1]);
                    poli_penyakit_dalam.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    let html;
                    poli_penyakit_dalam.forEach(penyakit_dalam => {
                        if (penyakit_dalam != null) {
                            
                            // if (baca_nomorantrian_bpjs(penyakit_dalam.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${baca_nomorantrian_bpjs(penyakit_dalam.nomorantrian)}</td>
                            //                 <td class="text-center">${penyakit_dalam?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${penyakit_dalam.nomorantrian}</td>
                                            <td class="text-center">${penyakit_dalam?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_penyakit_dalam').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_penyakit_dalam').html('');
                    }
                    html = null;

                    // Paru
                    let paru = Object.values(data[0]);
                    paru.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    ...
                    paru.forEach(p => {
                        if (p != null) {
                            // if (baca_nomorantrian_bpjs(p.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${baca_nomorantrian_bpjs(p.nomorantrian)}</td>
                            //                 <td class="text-center">${p?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${p.nomorantrian}</td>
                                            <td class="text-center">${p?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_paru').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_paru').html('');
                    }
                    html = null;

                    // Jantung
                    let jantung = Object.values(data[2]);
                    jantung.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    ...
                    jantung.forEach(j => {
                        if (j != null) {
                            // if (baca_nomorantrian_bpjs(j.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${baca_nomorantrian_bpjs(j.nomorantrian)}</td>
                            //                 <td class="text-center">${j?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${j.nomorantrian}</td>
                                            <td class="text-center">${j?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_jantung').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_jantung').html('');
                    }
                    html = null;
                }
            });
