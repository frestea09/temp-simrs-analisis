...
<body>
                ...
                <div class="col-md-12">
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="AN_antrian" class="nomor_antrian">
                                    {{ @$antrianAN->kelompok . @$antrianAN->nomor }}</div> --}}
                                {{-- <div id="AN_nama" class="nama_pasien">
                                    {{ @$antrianAN->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_anestesi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianAN->register_antrian->nomorantrian) )
                                            <div id="9_antrian" class="nomor_antrian">
                                                {{ @$antrianAN->kelompok . @$antrianAN->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="9_antrian" class="nomor_antrian">
                                            {{ @$antrianAN->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="9_nama" class="nama_pasien">
                                            {{ @$antrianAN->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="B_antrian" class="nomor_antrian">
                                    {{ @$antrianB->kelompok . @$antrianB->nomor }}</div> --}}
                                {{-- <div id="B_nama" class="nama_pasien">
                                    {{ @$antrianB->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_bedah">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianB->register_antrian->nomorantrian) )
                                            <div id="5_antrian" class="nomor_antrian">
                                                {{ @$antrianB->kelompok . @$antrianB->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="5_antrian" class="nomor_antrian">
                                            {{ @$antrianB->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="5_nama" class="nama_pasien">
                                            {{ @$antrianB->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-12">
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="O_antrian" class="nomor_antrian">
                                    {{ @$antrianO->kelompok . @$antrianO->nomor }}</div> --}}
                                {{-- <div id="O_nama" class="nama_pasien">
                                    {{ @$antrianO->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-3" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-3">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_orthopedi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianO->register_antrian->nomorantrian) )
                                            <div id="18_antrian" class="nomor_antrian">
                                                {{ @$antrianO->kelompok . @$antrianO->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="18_antrian" class="nomor_antrian">
                                            {{ @$antrianO->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="18_nama" class="nama_pasien">
                                            {{ @$antrianO->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="SR_antrian" class="nomor_antrian">
                                    {{ @$antrianSR->kelompok . @$antrianSR->nomor }}</div> --}}
                                {{-- <div id="SR_nama" class="nama_pasien">
                                    {{ @$antrianSR->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-4" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-4">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_saraf">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianSR->register_antrian->nomorantrian) )
                                            <div id="21_antrian" class="nomor_antrian">
                                                {{ @$antrianSR->kelompok . @$antrianSR->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="21_antrian" class="nomor_antrian">
                                            {{ @$antrianSR->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="21_nama" class="nama_pasien">
                                            {{ @$antrianSR->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script async type="text/javascript">
        ...
        async function ajaxAntrian() {
            $.ajax({
                url: "/antrian_poliklinik/tv4",
                method: "POST",
                dataType: "json",
                data: {
                ...
                success: function(data) {
                    ...
                    antrianDipanggil.forEach(antrian => {
                        if(antrian != null){
                            console.log($('#' + antrian.poli_id + '_antrian'),  $('#' + antrian.poli_id + '_nama'))

                            if (bacaNomorAntrianBPJS(antrian.register_antrian.nomorantrian)) {
                                $('#' + antrian.poli_id + '_antrian').text(antrian.register_antrian.nomorantrian_jkn);
                                $('#' + antrian.poli_id + '_nama').text(antrian.register_antrian?.pasien?.nama ?? '');
                                // 2X play
                                audios.push(
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv4/belum-dipanggil',
                success: function (data) {
                     // Anestesi
                     let poli_anestesi = data[0];
                     poli_anestesi.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    let html;
                    poli_anestesi.forEach(anestesi => {
                        if (anestesi != null) {
                            // if (bacaNomorAntrianBPJS(anestesi.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(anestesi.nomorantrian)}</td>
                            //                 <td class="text-center">${anestesi?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${anestesi.nomorantrian}</td>
                                            <td class="text-center">${anestesi?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_anestesi').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_anestesi').html('');
                    }
                    html = null;

                    // Bedah
                    let poli_bedah = data[1];
                    poli_bedah.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    poli_bedah.forEach(bedah => {
                        if (bedah != null) {
                            // if (bacaNomorAntrianBPJS(bedah.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(bedah.nomorantrian)}</td>
                            //                 <td class="text-center">${bedah?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${bedah.nomorantrian}</td>
                                            <td class="text-center">${bedah?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_bedah').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_bedah').html('');
                    }
                    html = null;

                    // Orthopedi
                    let poli_orthopedi = data[2];
                    poli_orthopedi.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    poli_orthopedi.forEach(orthopedi => {
                        if (orthopedi != null) {
                            // if (bacaNomorAntrianBPJS(orthopedi.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(orthopedi.nomorantrian)}</td>
                            //                 <td class="text-center">${orthopedi?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${orthopedi.nomorantrian}</td>
                                            <td class="text-center">${orthopedi?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_orthopedi').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_orthopedi').html('');
                    }
                    html = null;

                    // Saraf
                    let poli_saraf = data[3];
                    poli_saraf.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    poli_saraf.forEach(saraf => {
                        if (saraf != null) {
                            // if (bacaNomorAntrianBPJS(saraf.nomorantrian)) {
                            //     html += `<tr>
                            //                 <td class="nomor">${bacaNomorAntrianBPJS(saraf.nomorantrian)}</td>
                            //                 <td class="text-center">${saraf?.nama ?? ''}</td>
                            //             </tr>`
                            // } else {
                                html += `<tr>
                                            <td class="nomor">${saraf.nomorantrian}</td>
                                            <td class="text-center">${saraf?.nama ?? ''}</td>
                                        </tr>`
                            // }
                        }
                    })
                    $('#antrian_belum_dipanggil_saraf').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_saraf').html('');
                    }
                    html = null;
                }
            });
