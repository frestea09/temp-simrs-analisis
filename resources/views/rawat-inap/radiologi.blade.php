@extends('master')
@section('header')
  <h1>Rawat Inap - Radiologi <small></small></h1>
@endsection
...
<div class="box box-primary">
  <div class="box-header with-border">
    <h3 class="box-title">Data Tindakan Radaiologi Rawat Inap</h3>
    <div class="box-tools pull-right">
      <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-7">
        ...
        <div class="form-group{{ $errors->has('perawat') ? ' has-error' : '' }}">
          {!! Form::label('perawat', 'Radiografer', ['class' => 'col-sm-3 control-label']) !!}
          <div class="col-sm-9">
...
<div class="box box-primary">
    ...
    <div class="box-body">
      @include('tinymce')
      {!! Form::open(['method' => 'POST', 'url' => 'rawat-inap/simpan-radiologi', 'class' => 'form-horizontal']) !!}
        {!! Form::hidden('registrasi_id', $reg->id) !!}
