...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
		...
		{!! Form::close() !!} --}}
    {!! Form::open(['method' => 'POST', 'url' => 'radiologi-gigi/cari-pasien', 'class'=>'form-horizontal']) !!}
      <div class="row">
        <div class="col-md-4">
          ...
          @isset($radiologi)
            @foreach ($radiologi as $d)
                ...
                <tr>
                  ...
                  @endif --}}
                  @if (\App\RadiologiEkspertise::where('registrasi_id', $reg->id)->first() == null)
                  <td class="blink_me"> <b>Baru</b> </td>
                  @else
                    <td><b style="color:red">Selesai</b></td>
                  @endif
                ...
                <td>
                  ...
                  @if (cek_jenis_reg(@$reg->status_reg) == 'Rawat Inap')
                    <a href="{{ url('radiologi-gigi/entry-tindakan-irna/'. @$d->id.'/'.
