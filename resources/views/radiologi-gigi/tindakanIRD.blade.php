  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/folder.png') }}">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        {!! Form::open(['method' => 'POST', 'url' => 'radiologi-gigi/tindakan-ird', 'class'=>'form-hosizontal']) !!}
        <div class="row">
          <div class="col-md-4">
          ...
          <table class='table table-striped table-bordered table-hover table-condensed' id='data'>
            ...
            <tbody>
              @foreach ($registrasi as $key => $d)
                  ...
                  {{-- <td class="text-center">
                    <a href="{{ url('radiologi-gigi/entry-expertise-igd/'. $d->id.'/'.$d->pasien_id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                  </td> --}}
                  {{-- <td class="text-center">
