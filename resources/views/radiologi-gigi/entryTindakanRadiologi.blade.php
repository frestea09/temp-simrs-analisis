              ...
              <div class="col-md-5">
                ...
                <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                        ...
                        @if (substr($jenis->status_reg,0,1) == 'G')
                          <a href="{{ url('radiologi-gigi/cetakRincianRad/ird/'.$reg_id) }}" class="btn btn-primary btn-flat pull-right">SELESAI</a>
                        @else
                          <a href="{{ url('radiologi-gigi/cetakRincianRad/irj/'.$reg_id) }}" class="btn btn-primary btn-flat pull-right">SELESAI</a>
                        @endif
                    </div>
                </div>
              </div>
