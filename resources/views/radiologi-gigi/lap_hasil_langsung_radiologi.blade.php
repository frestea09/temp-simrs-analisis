<html>
  <head>
    <meta charset="utf-8">
    <title>Cetak Hasil Radiologi Gigi</title>
    <!-- Bootstrap 3.3.7 -->
  ...
  <body>
    ...
    <div class="row">
      <div class="col-sm-12 text-center">
          ...
          <h5>SMF GIGI DAN MULUT</h5>
          <h6>{{ configrs()->alamat }} Telp. {{ configrs()->tlp }}</h6>
          <hr>
          <h5>HASIL PEMERIKSAAN RADIOLOGI GIGI</h5>
        <br>
      </div>
        ...
        <div class="text-left" style="padding: 5px; float:left;">
          <u>Tanggal Pemeriksaan : {{  date('d M Y H:i:s')   }}</u><br>
