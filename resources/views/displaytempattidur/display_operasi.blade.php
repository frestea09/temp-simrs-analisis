            ...
            <div class="col-md-12" style="padding-left:120px; padding-right:120px">
                <div id="displayArea1">
                    <h4 class="text-center text-primary" style="font-weight: bold;">
                        INFORMASI OPERASI <br>{{ config('app.nama') }} <br>
                        ...
                        {{-- <div class="row">
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-aqua">
                                    <div class="inner">
                                        <h3>{{ Modules\Bed\Entities\Bed::where('nama','not like','%VIRTUAL%')->count() }}</h3>
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-red">
                                    <div class="inner">
                                        <h3>{{ Modules\Bed\Entities\Bed::where('nama','not like','%VIRTUAL%')->where('reserved', 'Y')->count() }}</h3>
                                        <p>Jumlah Terisi</p>
                                        <div class="icon" style="margin-top: 10px;">
                                            <i class="fa fa-bed"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-green">
                                    <div class="inner">
                                        <h3>{{ Modules\Bed\Entities\Bed::where('nama','not like','%VIRTUAL%')->where('reserved', 'N')->count() }}</h3>
                                        <p>Jumlah Tersedia</p>
                                        <div class="icon" style="margin-top: 10px;">
                                            <i class="fa fa-bed"></i>
                                        </div>
                            ...
                            <div class="col-lg-3 col-xs-6">
                                ...
                                <div class="small-box bg-blue">
                                    <div class="inner">
                                        <h3>
                                            {{ ceil((((Modules\Bed\Entities\Bed::where('kelas_id','!=','9')->where('nama','not like','%VIRTUAL%')->where('reserved', 'Y')->count()) / (Modules\Bed\Entities\Bed::where('kelas_id','!=','9')->where('nama','not like','%VIRTUAL%')->count())) * 100/100) * 100) }}
                                            %
                                        </h3>
                        ...
                        <div class=''>
                            <table class='table table-bordered table-condensed'>
                                ...
                                <tbody>
                                    ...
                                    @endphp
                                    {{-- @for ($i = 0; $i < 30; $i++) --}}
                                    @foreach ($data['jadwal_operasi'] as $d)
                                    @php
