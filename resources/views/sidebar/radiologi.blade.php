...
<li><a href="{{ url('radiologi/terbilling') }}"><img src="{{ asset('menu/sidebar/lab.svg') }}" width="24"> <span>
            Ter-billing</span></a></li>
<li><a href="{{ url('/radiologi/antrian-rad') }}"><img src="{{ asset('menu/sidebar/pengguna.svg') }}" width="24"> <span> 
        Daftar Antrian </span></a></li>
<li><a href="{{ url('/radiologi/display/antrian') }}" target="_blank"><i class="fa fa-desktop"></i> <span>Display Antrian</span></a></li>
<li><a href="{{ url('radiologi/billing') }}"><img src="{{ asset('menu/sidebar/penatajasa.svg') }}" width="24"> <span>
            Radiografer</span></a></li>
<li><a href="{{ url('radiologi/hasil-radiologi') }}"><img src="{{ asset('menu/sidebar/lab.svg') }}" width="24"> <span>
            Hasil Radiologi</span></a></li>
<li><a href="{{ url('radiologi/cari-pasien') }}"><img src="{{ asset('menu/sidebar/pasien.svg') }}" width="24"></i>
...
<li><a href="{{ url('radiologi/laporan') }}"><img src="{{ asset('menu/sidebar/laporan.svg') }}" width="24"> <span>
            Laporan</span></a></li>
