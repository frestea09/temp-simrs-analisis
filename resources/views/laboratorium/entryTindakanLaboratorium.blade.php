          ...
          <div class="widget-user-header bg-aqua-active">
            <div class="row">
              <div class="col-md-2">
                ...
                <h5 class="widget-user-desc">Asal</h5>
              </div>
              <div class="col-md-7">
                ...
                <h5 class="widget-user-desc">: {{ baca_carabayar($jenis->bayar) }} </h5>
                <h5 class="widget-user-desc">: {{ baca_poli($jenis->poli_id) }}</h5>
              </div>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                  <div class="col-md-9 col-md-offset-3">
                      ...
                      @endif
                      @if(substr($jenis->status_reg,0,1) == 'G')
                        <a href="{{ url('laboratorium/cetakRincianLab/irg/'.$reg_id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                      ...
                      @else
                        <a href="{{ url('laboratorium/cetakRincianLab/irj/'.$reg_id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                        <div class="btn-group" style="min-width: 0px !important">
                          <button type="button" class="btn btn-success btn-sm"><i class="fa fa-print"></i></button>
                          <button type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                              <span class="caret"></span>
          ...
          <tbody>
            @foreach ($folio as $key => $d)
              <tr>
                ...
                <td>{{ baca_pegawai($d->analis_lab) }}</td>
                <td>{{ $d->user->name }}</td>
