@extends('master')
@section('header')
  <h1>Laporan 10 Besar Diagnosa IRJ </h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'frontoffice/laporan/diagnosa-irj', 'class'=>'form-horizontal']) !!}
      <div class="row">
        {{-- <div class="col-md-2">
      ...
      {{-- ================================================================================================== --}}
      @if (count($icd10) > 0)
        <h5><b>10 Diagnosa Yang Sering Digunakan</b></h5>
