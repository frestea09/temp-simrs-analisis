@extends('master')
@section('header')
  <h1>Vedika Elektronik Klaim BPJS Kesehatan Rawat Jalan / IGD</h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'frontoffice/laporan/rekammedis-pasien/irj-igd', 'class' => 'form-horizontal']) !!}
        <div class="row">
          <div class="col-sm-6">
            ...
            <tbody>
              ...
              @endphp
                <tr>
                  ...
                  <td class="text-center">
                    <div class="btn-group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-right" role="menu">
                        ...
                        <li><a class="btn btn-md"  target="_blank" href="{{ url('/spri/cetak/'.@@$d->registrasi_id) }}"> SPRI</a></li>
                  ...
                  <td>
                    <a href="{{ url('frontoffice/cetak-e-sep/'.@$d->id) }}" class="btn btn-md btn-success btn-flat"><i class="fa fa-print"></i></a>
                  </td>
                </tr>
              @endforeach
            </tbody>
