    ...
    <table>
        ...
        <tr>
          ...
          <td colspan="5" style="">
            <ul>
              ...
              <li>TB : {{@$asessment['tanda_vital']['suhu'] }} cm</li>
                ...
                <ol start="5">
                    <li>
                        ...
                        <ul>
                            ...
                            <li>TFU : {{ @$asessment['pemeriksaanFisik']['abdomen']['tfu'] }} cm</li>
        ...
        <tr>
            ...
            <td colspan="5">
                ...
                @elseif(@$asessment['rencanaPemulangan']['aps']['dipilih'])
                    {{@$asessment['rencanaPemulangan']['aps']['dipilih']}} - {{@$asessment['rencanaPemulangan']['aps']['waktu']}}
                @else
