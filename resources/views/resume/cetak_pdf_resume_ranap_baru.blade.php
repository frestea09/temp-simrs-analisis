...
<html>
  ...
  <body>
    ...
    <table style="border: none !important; width:100%;font-size:12px;"> 
      ...
      <table style="border: 1px solid black; width:100%; border-collapse: collapse; font-size:12px;"> 
        <tr>
            <td colspan="3" style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black;">
              <div><b>INDIKASI RAWAT INAP :</b></div>
              <p style="margin: 0; padding: 0;">{{@$content['indikasi_rawat_inap']}}</p>
            </td>
        </tr>
        <tr>
            <td colspan="3" style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black;">
              <div><b>RINGKASAN RIWAYAT PENYAKIT :</b></div>
              <p style="margin: 0; padding: 0;">{!! nl2br(e(@$content['ringkasan_riwayat_penyakit'])) !!}</p>
            </td>
        </tr>
        <tr>
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
             <div style="text-align: center;"><b>PEMERIKSAAN FISIK :</b></div>
              <p style="margin: 0; padding: 0;">{!! nl2br(e(@$content['pemeriksaan_fisik'])) !!}</p>
            </td>
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
             <div style="text-align: center;"><b>PEMERIKSAAN PENUNJANG :</b></div>
              <p style="margin: 0; padding: 0;">{!! nl2br(e(@$content['pemeriksaan_penunjang'])) !!}</p>
            </td>
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
              <div style="text-align: center;"><b>TERAPI / PENGOBATAN SELAMA DI RUMAH SAKIT :</b></div>
      ...
      <table style="border: 1px solid black; width:100%; border-collapse: collapse; font-size:12px;"> 
                ...
                <p style="margin: 0; padding: 0;">
                  @if (@$icd10Secondary_jkn)
                        @foreach (@$icd10Secondary_jkn as $icd)
                            - {{$icd->icd10.' '.baca_icd10(@$icd->icd10)}}
                        @endforeach
                  @endif
            </td>
        </tr>
        <tr>
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
              <div><b>TINDAKAN / PROSEDUR / OPERASI :</b></div>
                <p style="margin: 0; padding: 0;">
            ...
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
              <div><b>ICD IX : {{@$content['icdix_tindakan']}}</b></div>
                @if (count($icd9) > 0)
                  <ul>
        ...
        <tr>
            <td colspan="2" style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
              <div><b>INSTRUKSI PERAWAT LANJUTAN / EDUKASI :</b></div>
              <p style="margin: 0; padding: 0;">{{@$content['edukasi']}}</p>
            </td>
        </tr>
        <tr>
            <td style="padding: .3rem 0 0 .3rem; width: 20%; border: 1px solid black; vertical-align: top;">
                <div><p>Cara Pulang : </p></div>
                <div style="display: inline-block;">
                  <div style="vertical-align: middle; display: inline-block">
                      <input class="form-check-input"
                        style="vertical-align: middle;"
