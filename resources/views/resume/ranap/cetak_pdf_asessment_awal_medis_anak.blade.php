...
<body>
    ...
    <table>
        ...
        <tr>
          ...
          <td colspan="5">
            {{@$asessment['status_gizi']}}
          </td>
        </tr>
        <tr>
          <td >
              <b>Kepala dan Leher</b>
          </td>
          <td colspan="5">
            {{@$asessment['kepala_dan_leher']}}
          </td>
        </tr>
        <tr>
          <td >
              <b>Dada dan Punggung</b>
          </td>
          <td colspan="5">
        ...
        <tr>
            <td style="vertical-align: top;">
                <b>Rekonsiliasi obat dan data obat yang digunakan saat masuk rumah sakit</b>
            </td>
            <td colspan="5">
                  {{@$asessment['rekonsiliasi_obat']}}
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top;">
                <b>Riwayat pekerjaan, Sosial ekonomi, Kejiwaan dan kebiasaan</b>
            </td>
            <td colspan="5">
                  {{@$asessment['riwayat_pekerjaan']}}
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top;">
            ...
            <td colspan="5">
              ...
              <div>
                <input class="form-check-input"
                    ...
                    {{ @$asessment['prognosa']['ad_functionam'] == 'Ad Bonam' ? 'checked' : '' }}
              ...
              <div>
                  <input class="form-check-input"
                      name="fisik[prognosa][ad_functionam]"
                      {{ @$asessment['prognosa']['ad_functionam'] == 'Ad Malam' ? 'checked' : '' }}
              ...
              <div>
                  <input class="form-check-input"
                      name="fisik[prognosa][ad_functionam]"
                      {{ @$asessment['prognosa']['ad_functionam'] == 'Dubia ad Bonam' ? 'checked' : '' }}
              ...
              <div>
                  <input class="form-check-input"
                      name="fisik[prognosa][ad_functionam]"
                      {{ @$asessment['prognosa']['ad_functionam'] == 'Dubia ad Malam' ? 'checked' : '' }}
              ...
              <b>Ad Vitam</b>
                <div>
                    <input class="form-check-input"
                        ...
                        {{ @$asessment['prognosa']['ad_vitam'] == 'Ad Bonam' ? 'checked' : '' }}
                        type="radio" value="Ad Bonam">
                    <label class="form-check-label">Ad Bonam</label>
                </div>
                <div>
                    <input class="form-check-input"
                        name="fisik[prognosa][ad_vitam]"
                        {{ @$asessment['prognosa']['ad_vitam'] == 'Ad Malam' ? 'checked' : '' }}
                        type="radio" value="Ad Malam">
                    <label class="form-check-label">Ad Malam</label>
                </div>
                <div>
                    <input class="form-check-input"
                        name="fisik[prognosa][ad_vitam]"
                        {{ @$asessment['prognosa']['ad_vitam'] == 'Dubia ad Bonam' ? 'checked' : '' }}
                        type="radio" value="Dubia ad Bonam">
                    <label class="form-check-label">Dubia ad Bonam</label>
                </div>
                <div>
                    <input class="form-check-input"
                        name="fisik[prognosa][ad_vitam]"
                        {{ @$asessment['prognosa']['ad_vitam'] == 'Dubia ad Malam' ? 'checked' : '' }}
                        type="radio" value="Dubia ad Malam">
                    <label class="form-check-label">Dubia ad Malam</label>
                </div>
                <b>Catatan</b> <br>
                {{@$asessment['prognosa']['prognosa']}}
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top;">
