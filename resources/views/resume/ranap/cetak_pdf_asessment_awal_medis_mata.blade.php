                ...
                <table style="font-size:12px; width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box"> 
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                            {{ @$asessment['pemeriksaanVisus']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['pemeriksaanVisus']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td>2. Pemeriksaan keseimbangan posisi bola mata</td>
                        <td>
                            {{ @$asessment['keseimbanganBolaMata']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['keseimbanganBolaMata']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                            {{ @$asessment['gerakBolaMata']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['gerakBolaMata']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                            {{ @$asessment['tekananIntraocular']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['tekananIntraocular']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>
                            {{ @$asessment['segmenAnterior']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['segmenAnterior']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                            {{ @$asessment['palpebra']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['palpebra']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-left: 20px;">
                        ...
                        <td>
                            {{ @$asessment['konjungtiva']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['konjungtiva']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-left: 20px;">
                      ...
                      <tr>
                        ...
                        <td>
                            {{ @$asessment['bilikMataDepan']['od'] }}
                        </td>
                        <td>
                            {{ @$asessment['bilikMataDepan']['os'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="padding-left: 20px;">
                ...
                <table style="font-size:12px; width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box"> 
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {{ @$asessment['lapangPandang']['od'] }}
                            </td>
                            <td>
                                {{ @$asessment['lapangPandang']['os'] }}
                            </td>
                          </tr>
                          <tr>
                            <td>
                            ...
                            <td>
                                {{ @$asessment['funduskopi']['od'] }}
                            </td>
                            <td>
                                {{ @$asessment['funduskopi']['os'] }}
                            </td>
                          </tr>
                          <tr>
                            <td colspan="3">
                                {{ @$asessment['lokalis2']['keterangan'] }}
                            </td>
                          </tr>
                          <tr>
                            <td colspan="3">
                                {{ @$asessment['lokalis3']['keterangan'] }}
                            </td>
                          </tr>
                    </tbody>
                  </table>
