    ...
    <table>
        ...
        <tr>
            ...
            <td colspan="5">
                <table style="font-size:12px; width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">Auricula Dextra – Sinistra</td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Cae tenang</td>
                        <td>
                            {{@$asessment['status_generalis']['auricula']['cae-tenang1']}}
                            /
                            {{@$asessment['status_generalis']['auricula']['cae-tenang2']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Sekret</td>
                        <td>
                            {{@$asessment['status_generalis']['auricula']['sekret']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Membran Tympani</td>
                        <td>
                            {{@$asessment['status_generalis']['auricula']['membran_tympani']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Intak</td>
                        <td>
                            {{@$asessment['status_generalis']['auricula']['intak']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Reflek Cahaya</td>
                        <td>
                            {{@$asessment['status_generalis']['auricula']['reflek_cahaya']}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">Cavum Nasi (CN)</td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Secret</td>
                        <td>
                            {{@$asessment['status_generalis']['cavum_nasi']['secret']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Concha Inferior</td>
                        <td>
                            {{@$asessment['status_generalis']['cavum_nasi']['concha_inferior']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Eutrofil</td>
                        <td>
                            {{@$asessment['status_generalis']['cavum_nasi']['eutrofil']}}
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <table style="font-size:12px; width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">Nasofaring / Orofaring</td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Tonsil</td>
                        <td>
                            {{@$asessment['status_generalis']['nasofaring_orofaring']['tonsil']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Detritus</td>
                        <td>
                            {{@$asessment['status_generalis']['nasofaring_orofaring']['detritus']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Faring</td>
                        <td>
                            {{@$asessment['status_generalis']['nasofaring_orofaring']['faring']}}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input class="form-check-input"
                                    ...
                                    {{ @$asessment['status_generalis']['maksilofasial_simetris'] == 'Simetris' ? 'checked' : '' }}
                            ...
                            <div>
                                <input class="form-check-input"
                                    name="fisik[status_generalis][maksilofasial_simetris]"
                                    {{ @$asessment['status_generalis']['maksilofasial_simetris'] == 'Tidak Simetris' ? 'checked' : '' }}
                    ...
                    <tr>
                        ...
                        <td>
                            {{@$asessment['status_generalis']['maksilofasial']['parese_nerveus1']}}
                            /
                            {{@$asessment['status_generalis']['maksilofasial']['parese_nerveus2']}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">Leher</td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input class="form-check-input"
                                    ...
                                    {{ @$asessment['status_generalis']['leher']['kgb'] == 'Teraba' ? 'checked' : '' }}
                            ...
                            <div>
                                <input class="form-check-input"
                                    name="fisik[status_generalis][leher][kgb]"
                                    {{ @$asessment['status_generalis']['leher']['kgb'] == 'Tidak Teraba' ? 'checked' : '' }}
                    ...
                    <tr>
                        ...
                        <td>
                            {{@$asessment['status_generalis']['leher']['membesar']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Genitalia</td>
                        <td>
                            {{@$asessment['status_generalis']['genitalia']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Ekstremitas</td>
                        <td>
                            {{@$asessment['status_generalis']['ekstremitas']}}
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 50%; font-weight: 500;">Kulit</td>
                        <td>
                            {{@$asessment['status_generalis']['kulit']}}
                        </td>
                    </tr>
                </table>
            </td>
