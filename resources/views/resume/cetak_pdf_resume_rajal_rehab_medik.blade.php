    ...
    <table>
        <tr>
            ...
            <th colspan="5" style="font-size: 18pt;">
                <b>ASESMEN AWAL POLIKLINIK Rehabilitasi Medik</b>
            </th>
        </tr>
        <tr>
            <td colspan="6">
        ...
        <tr>
            ...
            <td colspan="5">
                ...
                4. Kesadaran:  {{ @json_decode(@$soap->fisik, true)['tanda_vital']['kesadaran'] ? @json_decode(@$soap->fisik, true)['tanda_vital']['kesadaran'] : '-' }}
                <br /><br />
        ...
        <tr>
            <td colspan="6">
                ...
                <br>
                {{@json_decode(@$soap->fisik, true)['statusFungsional']['aktifitas']}}
                <br>
                <strong>Keterangan: </strong> <br>
                {{@json_decode(@$soap->fisik, true)['statusFungsional']['keterangan']}}
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="6">
                <style>
                    #tableLokalis, #tableLokalis th, #tableLokalis td {
                        border: 1px solid black;
                        padding: 5px
                    }
                </style>
                <table  style="width: 100%;" id="tableLokalis">
                    <tr>
                        <td style="width:20%;">Pemeriksaan SSP ( NI – XIII )</td>
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['SSP'] }}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['ARHeadNeck'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%;">a/r Thoraks </td>
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['ARThoraks'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%;">a/r Abdomen </td>
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['ARAbdomen'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%;">a/r Back </td>
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['ARBack'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['anggotaGerakLook'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="width:20%;"> Feel ( tanda radang, nyeri tekan,tonus turgor ) </td>
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['feel'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['movement'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 5px;">
                            <span>{{ @json_decode(@$soap->fisik, true)['lokalisRehabMedik']['fungsional'] }}</span>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            <td colspan="6" style="vertical-align: top;">
                ...
                <br>
                {{ @json_decode(@$soap->fisik, true)['diagnosisRehabMedik']['impairment'] }}
                <br>
                <strong>Disability: </strong>
                <br>
                {{ @json_decode(@$soap->fisik, true)['diagnosisRehabMedik']['disability'] }}
                <br>
                <strong>Handicap: </strong>
                <br>
                {{ @json_decode(@$soap->fisik, true)['diagnosisRehabMedik']['handicap'] }}
            </td>
        </tr>
        <tr>
            <td colspan="6" style="vertical-align: top;">
