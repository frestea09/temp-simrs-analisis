...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {{-- {!! Form::open(['method' => 'POST', 'url' => 'copy-resep/'.strtolower($unit), 'class'=>'form-horizontal']) !!}
        <div class="row">
               ...
               @foreach ($data as $key => $d)
                 ...
                 @endphp
                   <tr>
                     ...
                     <td>
                      <a href="{{ url('copy-resep/formpenjualan/'.$d->pasien_id).'/'.$d->registrasi_id }}" class="btn btn-success btn-flat btn-sm"><i class="fa fa-check"></i></a>
                     </td>
                     <td>
                       @if ($penjualan->first())
                       <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-right" role="menu" style="">
                            @foreach ($penjualan as $p)
                                    <li><a href="{{ url('copy-resep/cetak-detail/'.$p->id) }}" class="btn btn-flat btn-sm" target="_blank">{{ $p->no_resep }}</a></li>
                            @endforeach
                          </ul>
                      </div>
                      @endif
                      ...
                      <td>
                       @foreach ($penjualan as $d)
                          ...
                          @endphp
                          @if ($detail > 0)
                          <a href="{{ url('copy-resep/cetak-fakturkronis/'.$d->id) }}" class="btn btn-danger btn-flat btn-sm" target="_blank"> <i class="fa fa-file-pdf-o"></i> </a>
                          @endif
                       @endforeach
                     </td> 
                     <td>
