...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      {!! Form::open(['method' => 'POST', 'url' => 'penjualan/irna', 'class'=>'form-horizontal']) !!}
        <div class="row">
          <div class="col-md-6">
               ...
               @foreach ($data as $key => $r)
                  ...
                  @endphp
                   <tr>
                     ...
                     @endrole
                     <td>
                       {{-- <a href="{{ url('penjualan/formpenjualan/'.$r->pasien_id).'/'.$r->registrasi_id }}" class="btn btn-success btn-sm btn-flat"><i class="fa fa-check"></i></a> --}}
                     </td>
                      <td>
                       @if ($penjualan->first())
                       <div class="btn-group">
