          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('no_sediaan') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                   <input type="text" class="form-control" name="no_sediaan">
            ...
            <div class="col-md-6">
                  ...
                  <div class="col-sm-9">
                      <select class="form-control select2" style="width: 100%" name="poli_id">
                        {{-- @foreach ($opt_poli as $key => $d) --}}
                            ...
                            {{-- @endif --}}
                        {{-- @endforeach --}}
                        <option value="43" selected>Laboratorium Patologi Anotomi</option>
                      </select>
              ...
              <div class="form-group{{ $errors->has('ket_klinis') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" name="ket_klinis">
              ...
              <div class="form-group">
                  <div class="col-md-9 col-md-offset-3">
                      ...
                      @if (substr($jenis->status_reg,0,1) == 'G')
                        <a href="{{ url('laboratoriumCommon/tindakan-ird') }}" class="btn btn-primary btn-flat">SELESAI</a>
                      @else
                        <a href="{{ url('laboratoriumCommon/tindakan-irj') }}" class="btn btn-primary btn-flat">SELESAI</a>
                      @endif
                      @if(substr($jenis->status_reg,0,1) == 'G')
                        <a href="{{ url('laboratoriumCommon/cetakRincianLab/irg/'.$reg_id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                      @else
                        <a href="{{ url('laboratoriumCommon/cetakRincianLab/irj/'.$reg_id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                      @endif
                  </div>
              </div>
            </div>
          ...
          <tbody>
            @foreach ($folio as $key => $d)
              <tr>
                ...
                <td>
                    @if ($d->jenis == 'TA')
                    Laboratorium Patalogi Anatomi RJ
                    @elseif($d->jenis == 'TG')
                    Laboratorium Patalogi Anatomi RD
                    @elseif($d->jenis == 'TI')
                    Laboratorium Patalogi Anatomi RANAP
                    @endif
                </td>
