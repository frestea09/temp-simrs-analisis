@extends('master')
@section('header')
  <h1>Form Pembuatan SEP Pasien IGD<small></small></h1>
@endsection
      ...
      {!! Form::open(['method' => 'POST', 'url' => 'simpan-no-sep', 'class' => 'form-horizontal', 'id'=>'formSEP']) !!}
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-8">
                      ...
                      <small class="text-danger">Nama Sesuai Nomor Kartu BPJS</small>
              ...
              <div class="form-group{{ $errors->has('tgl_rujukan') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-8">
                      {!! Form::text('tgl_rujukan', null, ['class' => 'form-control tanggalSEP','autocomplete'=>'off']) !!}
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                <label for="poliTujuan" class="col-sm-4 control-label">Dokter Konsul </label>
                <div class="col-sm-8">
    ...
    function cariNoKartu() {
      ...
      .done(function(res) {
        ...
        if (data[0].metaData.code == 200) {
          ...
          $('input[name="no_rujukan"]').val(data[1].noKunjungan)
          $('input[name="nik"]').val(data[1].peserta.nik)
          $('input[name="niks"]').val(data[1].peserta.nik)
          $('input[name="tgl_rujukan"]').val(data[1].tglKunjungan)
