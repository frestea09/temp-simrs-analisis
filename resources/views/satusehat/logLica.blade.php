...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            {!! Form::open(['method' => 'GET', 'url' => 'log-lica', 'class' => 'form-horizontal']) !!}
            <div class="row">
                <div class="col-md-3">
                    ...
                    <tbody>
                        @foreach ($logs as $key => $log)
                            <tr>
                                ...
                                <td>{{ @$log->registrasi->pasien->nama }}({{ @$log->registrasi->pasien->no_rm }})</td>
                                {{-- <td>
                                ...
                                <td>
                                    <a target="_blank" href="/lica-json?id={{$log->id}}">
