...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <!-- <a href="{{route('mastermapping_confrl37.index')}}" class="btn btn-default btn-flat">
            <i class="fa fa-plus"></i> List Mapping CONF.RL37
        </a> -->
    </div>
    <div class="box-body">
        <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class='table-responsive'>
                                <table id='table_conf_rl37' class='table table-striped table-bordered table-hover table-condensed'>
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Kegiatan</th>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        var table = $('#viewMapping').DataTable({
            ...
            ajax: {
                url: '{{ route("data-mastermapping_confrl37") }}',
                data: {
                    jenis: 'laporan'
                }
            },
    ...
    function editForm(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $('input[name="id"]').val(data.id_conf_rl37)
    ...
    function saveForm() {
        ...
        if (id == '') {
            url = '{{ route("mastermapping_confrl37.store") }}';
            type = 'POST';
        } else {
    ...
    function detailconfrl37(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                $('.modal-title').text('Conf.RL37  ' + data.kegiatan)
            }
        });


        $('#table_conf_rl37').DataTable({
            'language': {
    ...
    function hapusMapping(conf_rl37_id, tarif_id) {
        if (confirm('Yakin akan dihapus') == true) {
            $.ajax({
                    url: '/hapus-conf-rl37/' + tarif_id,
                    type: 'GET',
                    dataType: 'json',
                })
                .done(function(data) {
                    detailconfrl37(conf_rl37_id)
                });
