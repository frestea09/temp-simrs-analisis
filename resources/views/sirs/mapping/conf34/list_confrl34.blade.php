@extends('master')
@section('header')
<h1>Master Mapping CONF.RL34</h1>
@endsection
...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <!-- <a href="{{route('table_conf_rl34')}}" class="btn btn-default btn-flat">
            <i class="fa fa-plus"></i> Rekap Laporan Mapping CONF.RL34 
        </a> -->
    </div>
    <div class="box-body">
        <div >
...
<script type="text/javascript">
    $(document).ready(function(e) {
        var table = $('#viewMapping').DataTable({
            processing: true,
            serverSide: true,
            ajax: '{{ route("data-mastermapping_confrl34") }}',
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex',
                    orderable: false
