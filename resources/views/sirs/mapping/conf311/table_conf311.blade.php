@extends('master')
@section('header')
<h1>Table Mapping CONF.RL311</h1>
@endsection
...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <!-- <a href="{{route('mastermapping_confrl311.index')}}" class="btn btn-default btn-flat">
            <i class="fa fa-plus"></i> List Mapping CONF.RL311 
        </a>         -->
    </div>
    <div class="box-body">
        <div>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        var table = $('#viewMapping').DataTable({
            ...
            ajax: {
                url: '{{ route("data-mastermapping_confrl311") }}',
                data: {
                    jenis: 'laporan'
                }
            },
