...
class ArusKasController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (isset($post['excel'])) {
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'AKTIVITAS OPERASIONAL';
            ...
            $piutang = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 2)
                ->where('akun_code_5', 0)
            ...
            foreach ($piutang as $class) {
                ...
                if ($post['level'] >= 4) {
                    ...
                    $aktiva_sub_3 = AkunCOA::where('akun_code_1', $class['akun_code_1'])
                        ...
                        ->where('akun_code_9', 0)
                        ->get()->toArray();
                    foreach ($aktiva_sub_3 as $sub_class) {
                        ...
                        if ($getPerhitungan4['anggaran'] != 0 || $getPerhitungan4['realisasi'] != 0 || $getPerhitungan4['realisasi_sebelum'] != 0) {
                            ...
                            if ($post['level'] >= 5) {
                                ...
                                $aktiva_sub_4 = AkunCOA::where('akun_code_1', $sub_class['akun_code_1'])
                    ...
                    $sumPiutang['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumPiutang['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumPiutang['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }
            ...
            $persediaan = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 3)
                ->where('akun_code_5', 0)
            ...
            foreach ($persediaan as $class) {
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumPersediaan['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumPersediaan['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumPersediaan['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }
            ...
            $biayadimuka = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 4)
                ->where('akun_code_5', 0)
            ...
            foreach ($biayadimuka as $class) {
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumBiayaDimuka['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumBiayaDimuka['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumBiayaDimuka['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }
            ...
            $uangmuka = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 5)
                ->where('akun_code_5', 0)
            ...
            foreach ($uangmuka as $class) {
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumUangMuka['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumUangMuka['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumUangMuka['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }

            $sumAktivaLancarLainnya = [
                'anggaran'              => 0,
                'realisasi'             => 0,
                'realisasi_sebelum'     => 0
            ];

            $aktivalancarlainnya = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 9)
                ->where('akun_code_5', 0)
                ...
                ->where('akun_code_9', 0)
                ->get()->toArray();
            foreach ($aktivalancarlainnya as $class) {
                $code = implode('', [$class['akun_code_1'], $class['akun_code_2'], $class['akun_code_3'], $class['akun_code_4'], $class['akun_code_5']]);
                $getPerhitungan3   = Helper::getPerhitungan($data['tha'], 3, $code);
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumAktivaLancarLainnya['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumAktivaLancarLainnya['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumAktivaLancarLainnya['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }
            ...
            $bebanpenyusutan = AkunCOA::where('akun_code_1', 5)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 2)
                ->where('akun_code_4', 5)
                ->where('akun_code_5', 0)
                ...
                ->where('akun_code_9', 0)
                ->get()->toArray();
            foreach ($bebanpenyusutan as $class) {
                $code = implode('', [$class['akun_code_1'], $class['akun_code_2'], $class['akun_code_3'], $class['akun_code_4'], $class['akun_code_5']]);
                $getPerhitungan3   = Helper::getPerhitungan($data['tha'], 3, $code);
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumBebanPenyusutan['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumBebanPenyusutan['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumBebanPenyusutan['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }

            $sumLiabilitasJangkaPendek = [
                'anggaran'              => 0,
                'realisasi'             => 0,
                'realisasi_sebelum'     => 0
            ];

            $aktiva_sub_1 = AkunCOA::where('akun_code_1', 2)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 0)
                ->where('akun_code_5', 0)
                ...
                ->where('akun_code_9', 0)
                ->get()->toArray();
            foreach ($aktiva_sub_1 as $aktiva_sub) {
                $code = implode('', [$aktiva_sub['akun_code_1'], $aktiva_sub['akun_code_2'], $aktiva_sub['akun_code_3']]);
                $getPerhitungan2   = Helper::getPerhitungan($data['tha'], 2, $code);

                $data['data'][$i]['code']               = $aktiva_sub['code'];
                $data['data'][$i]['nama']               = '&emsp;&emsp;' . $aktiva_sub['nama'];
                if ($post['level'] >= 3) {
                    $data['data'][$i]['tag']                = 'b0';
                    $data['data'][$i]['anggaran']           = '';
                    $data['data'][$i]['realisasi']          = '';
                    ...
                    $aktiva_sub_2 = AkunCOA::where('akun_code_1', $aktiva_sub['akun_code_1'])
                        ->where('akun_code_2', $aktiva_sub['akun_code_2'])
                        ->where('akun_code_3', $aktiva_sub['akun_code_3'])
                        ->where('akun_code_4', '!=', 0)
                        ->where('akun_code_5', 0)
                        ->where('akun_code_6', 0)
                        ->where('akun_code_7', 0)
                    ...
                    foreach ($aktiva_sub_2 as $class) {
                        ...
                        if (end($aktiva_sub_2) == $class) {
                            $data['data'][$i]['code']               = '';
                            $data['data'][$i]['nama']               = 'JUMLAH ' . $aktiva_sub['nama'];
                    ...
                    $sumLiabilitasJangkaPendek['anggaran']          = $getPerhitungan2['anggaran'];
                    $sumLiabilitasJangkaPendek['realisasi']         = $getPerhitungan2['realisasi'];
                    $sumLiabilitasJangkaPendek['realisasi_sebelum'] = $getPerhitungan2['realisasi_sebelum'];
                }
            }
            $data['data'][$i]['total']              = '';
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'JUMLAH AKTIVITAS OPERASIONAL';
            $data['data'][$i]['realisasi']          = $sumPiutang['realisasi'] + $sumPersediaan['realisasi'] + $sumBiayaDimuka['realisasi'] + $sumUangMuka['realisasi'] + $sumAktivaLancarLainnya['realisasi'] + $sumBebanPenyusutan['realisasi'] + $sumLiabilitasJangkaPendek['realisasi'];
            $data['data'][$i]['realisasi_sebelum']  = $sumPiutang['realisasi_sebelum'] + $sumPersediaan['realisasi_sebelum'] + $sumBiayaDimuka['realisasi_sebelum'] + $sumUangMuka['realisasi_sebelum'] + $sumAktivaLancarLainnya['realisasi_sebelum'] + $sumBebanPenyusutan['realisasi_sebelum'] + $sumLiabilitasJangkaPendek['realisasi_sebelum'];
            $i++;
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'AKTIVITAS INVESTASI';
            $data['data'][$i]['anggaran']           = '';
            $data['data'][$i]['realisasi']          = '';
            $data['data'][$i]['percent']            = '';
            $data['data'][$i]['realisasi_sebelum']  = '';
            ...
            $aktiva_sub_1 = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 2)
                ->where('akun_code_4', 0)
                ->where('akun_code_5', 0)
            ...
            foreach ($aktiva_sub_1 as $aktiva_sub) {
                ...
                if ($post['level'] >= 3) {
                    ...
                    $sumInvestasi['anggaran']          = $getPerhitungan2['anggaran'];
                    $sumInvestasi['realisasi']         = $getPerhitungan2['realisasi'];
                    $sumInvestasi['realisasi_sebelum'] = $getPerhitungan2['realisasi_sebelum'];
                }
            }
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'JUMLAH AKTIVITAS INVESTASI';
            $data['data'][$i]['realisasi']          = $sumInvestasi['realisasi'];
            $data['data'][$i]['realisasi_sebelum']  = $sumInvestasi['realisasi_sebelum'];
            $i++;
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'AKTIVITAS PENDANAAN';
            $data['data'][$i]['anggaran']           = '';
            $data['data'][$i]['realisasi']          = '';
            $data['data'][$i]['percent']            = '';
            $data['data'][$i]['realisasi_sebelum']  = '';
            ...
            foreach ($aktiva_sub_1 as $aktiva_sub) {
                ...
                if ($post['level'] >= 3) {
                    ...
                    $sumLiabilitasJangkaPanjang['anggaran']          = $getPerhitungan2['anggaran'];
                    $sumLiabilitasJangkaPanjang['realisasi']         = $getPerhitungan2['realisasi'];
                    $sumLiabilitasJangkaPanjang['realisasi_sebelum'] = $getPerhitungan2['realisasi_sebelum'];
                }
            }
            ...
            $ekuitass = AkunCOA::where('akun_code_1', 3)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 0)
                ->where('akun_code_4', 0)
                ->where('akun_code_5', 0)
            ...
            foreach ($ekuitass as $ekuitas) {
                $code = implode('', [$ekuitas['akun_code_1'], $ekuitas['akun_code_2']]);
                $getPerhitungan1   = Helper::getPerhitungan($data['tha'], 1, $code);

                $data['data'][$i]['code']               = $ekuitas['code'];
                $data['data'][$i]['nama']               = $ekuitas['nama'];
                if ($post['level'] >= 2) {
                    $data['data'][$i]['tag']                = 'b0';
                    $data['data'][$i]['anggaran']           = '';
                    $data['data'][$i]['realisasi']          = '';
                    ...
                    $ekuitas_sub_1 = AkunCOA::where('akun_code_1', $ekuitas['akun_code_1'])
                        ->where('akun_code_2', $ekuitas['akun_code_2'])
                        ->where('akun_code_3', '!=', 0)
                        ->where('akun_code_4', 0)
                        ->where('akun_code_5', 0)
                        ->where('akun_code_6', 0)
                        ...
                        ->where('akun_code_9', 0)
                        ->get()->toArray();
                    foreach ($ekuitas_sub_1 as $ekuitas_sub) {
                        $code = implode('', [$ekuitas_sub['akun_code_1'], $ekuitas_sub['akun_code_2'], $ekuitas_sub['akun_code_3']]);
                        $getPerhitungan2   = Helper::getPerhitungan($data['tha'], 2, $code);

                        $data['data'][$i]['code']               = $ekuitas_sub['code'];
                        $data['data'][$i]['nama']               = '&emsp;&emsp;' . $ekuitas_sub['nama'];
                        if ($post['level'] >= 3) {
                            $data['data'][$i]['tag']                = 'b0';
                            $data['data'][$i]['anggaran']           = '';
                            $data['data'][$i]['realisasi']          = '';
                            ...
                            $ekuitas_sub_2 = AkunCOA::where('akun_code_1', $ekuitas_sub['akun_code_1'])
                                ->where('akun_code_2', $ekuitas_sub['akun_code_2'])
                                ->where('akun_code_3', $ekuitas_sub['akun_code_3'])
                                ->where('akun_code_4', '!=', 0)
                                ->where('akun_code_5', 0)
                                ->where('akun_code_6', 0)
                                ->where('akun_code_7', 0)
                                ...
                                ->where('akun_code_9', 0)
                                ->get()->toArray();
                            foreach ($ekuitas_sub_2 as $class) {
                                $code = implode('', [$class['akun_code_1'], $class['akun_code_2'], $class['akun_code_3'], $class['akun_code_4'], $class['akun_code_5']]);
                                $getPerhitungan3   = Helper::getPerhitungan($data['tha'], 3, $code);
                                ...
                                if ($post['level'] >= 4) {
                                    ...
                                    $ekuitas_sub_3 = AkunCOA::where('akun_code_1', $class['akun_code_1'])
                                        ->where('akun_code_2', $class['akun_code_2'])
                                        ->where('akun_code_3', $class['akun_code_3'])
                                        ->where('akun_code_4', $class['akun_code_4'])
                                        ->where('akun_code_5', $class['akun_code_5'])
                                        ...
                                        ->where('akun_code_9', 0)
                                        ->get()->toArray();
                                    foreach ($ekuitas_sub_3 as $sub_class) {
                                        $code = implode('', [$sub_class['akun_code_1'], $sub_class['akun_code_2'], $sub_class['akun_code_3'], $sub_class['akun_code_4'], $sub_class['akun_code_5'], $sub_class['akun_code_6'], $sub_class['akun_code_7']]);
                                        $getPerhitungan4   = Helper::getPerhitungan($data['tha'], 4, $code);
                                        ...
                                        if ($getPerhitungan4['anggaran'] != 0 || $getPerhitungan4['realisasi'] != 0 || $getPerhitungan4['realisasi_sebelum'] != 0) {
                                            ...
                                            if ($post['level'] >= 5) {
                                                ...
                                                $ekuitas_sub_4 = AkunCOA::where('akun_code_1', $sub_class['akun_code_1'])
                                                    ->where('akun_code_2', $sub_class['akun_code_2'])
                                                    ->where('akun_code_3', $sub_class['akun_code_3'])
                                                    ->where('akun_code_4', $sub_class['akun_code_4'])
                                                    ->where('akun_code_5', $sub_class['akun_code_5'])
                                            ...
                                            if (end($ekuitas_sub_3) == $sub_class) {
                                                $data['data'][$i]['code']               = '';
                                                $data['data'][$i]['nama']               = 'JUMLAH ' . $class['nama'];
                                                $data['data'][$i]['anggaran']           = $getPerhitungan3['anggaran'];
                                                $data['data'][$i]['realisasi']          = $getPerhitungan3['realisasi'];
                                ...
                                if (end($ekuitas_sub_2) == $class) {
                                    $data['data'][$i]['code']               = '';
                                    $data['data'][$i]['nama']               = 'JUMLAH ' . $ekuitas_sub['nama'];
                                    $data['data'][$i]['anggaran']           = $getPerhitungan2['anggaran'];
                                    $data['data'][$i]['realisasi']          = $getPerhitungan2['realisasi'];
                                    $data['data'][$i]['percent']            = ($getPerhitungan2['anggaran'] == 0) ? 0 : ($getPerhitungan2['realisasi'] / $getPerhitungan2['anggaran']) * 100;
                                    $data['data'][$i]['realisasi_sebelum']  = $getPerhitungan2['realisasi_sebelum'];
                        ...
                        if (end($ekuitas_sub_1) == $ekuitas_sub) {
                            $data['data'][$i]['code']               = '';
                            $data['data'][$i]['nama']               = 'JUMLAH ' . $ekuitas['nama'];
                            ...
                            $sumEkuitas['anggaran']          = $sumEkuitas['anggaran'] + $getPerhitungan1['anggaran'];
                            $sumEkuitas['realisasi']         = $sumEkuitas['realisasi'] + $getPerhitungan1['realisasi'];
                            $sumEkuitas['realisasi_sebelum'] = $sumEkuitas['realisasi_sebelum'] + $getPerhitungan1['realisasi_sebelum'];
                        }
                    }
                } else {
                    $data['data'][$i]['anggaran']           = $getPerhitungan1['anggaran'];
                    ...
                    $sumEkuitas['anggaran']          = $getPerhitungan1['anggaran'];
                    $sumEkuitas['realisasi']         = $getPerhitungan1['realisasi'];
                    $sumEkuitas['realisasi_sebelum'] = $getPerhitungan1['realisasi_sebelum'];
                }
            }
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'JUMLAH AKTIVITAS PENDANAAN';
            $data['data'][$i]['realisasi']          = $sumLiabilitasJangkaPanjang['realisasi'] + $sumEkuitas['realisasi'];
            $data['data'][$i]['realisasi_sebelum']  = $sumLiabilitasJangkaPanjang['realisasi_sebelum'] + $sumEkuitas['realisasi_sebelum'];
            $i++;
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'JUMLAH KENAIKAN/PENURUNAN KAS PERIODE INI';
            $data['data'][$i]['realisasi']          = $sumPiutang['realisasi'] + $sumPersediaan['realisasi'] + $sumBiayaDimuka['realisasi'] + $sumUangMuka['realisasi'] + $sumAktivaLancarLainnya['realisasi'] + $sumBebanPenyusutan['realisasi'] + $sumLiabilitasJangkaPendek['realisasi'] + $sumInvestasi['realisasi'] + $sumLiabilitasJangkaPanjang['realisasi'] + $sumEkuitas['realisasi'];
            $data['data'][$i]['realisasi_sebelum']  = $sumPiutang['realisasi_sebelum'] + $sumPersediaan['realisasi_sebelum'] + $sumBiayaDimuka['realisasi_sebelum'] + $sumUangMuka['realisasi_sebelum'] + $sumAktivaLancarLainnya['realisasi_sebelum'] + $sumBebanPenyusutan['realisasi_sebelum'] + $sumLiabilitasJangkaPendek['realisasi_sebelum'] + $sumInvestasi['realisasi_sebelum'] + $sumLiabilitasJangkaPanjang['realisasi_sebelum'] + $sumEkuitas['realisasi_sebelum'];
            $i++;
            ...
            $saldo_kas = AkunCOA::where('akun_code_1', 1)
                ->where('akun_code_2', 0)
                ->where('akun_code_3', 1)
                ->where('akun_code_4', 1)
                ->where('akun_code_5', 0)
            ...
            foreach ($saldo_kas as $class) {
                ...
                if ($post['level'] >= 4) {
                    ...
                    $sumSaldoKas['anggaran']          = $getPerhitungan3['anggaran'];
                    $sumSaldoKas['realisasi']         = $getPerhitungan3['realisasi'];
                    $sumSaldoKas['realisasi_sebelum'] = $getPerhitungan3['realisasi_sebelum'];
                }
            }
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'SALDO KAS AWAL PERIODE';
            $data['data'][$i]['realisasi']          = $sumSaldoKas['realisasi_sebelum'] + ($sumPiutang['realisasi_sebelum'] + $sumPersediaan['realisasi_sebelum'] + $sumBiayaDimuka['realisasi_sebelum'] + $sumUangMuka['realisasi_sebelum'] + $sumAktivaLancarLainnya['realisasi_sebelum'] + $sumBebanPenyusutan['realisasi_sebelum'] + $sumLiabilitasJangkaPendek['realisasi_sebelum'] + $sumInvestasi['realisasi_sebelum'] + $sumLiabilitasJangkaPanjang['realisasi_sebelum'] + $sumEkuitas['realisasi_sebelum']);
            $data['data'][$i]['realisasi_sebelum']  = '';
            $i++;
            ...
            $data['data'][$i]['tag']                = 'b';
            $data['data'][$i]['code']               = '';
            $data['data'][$i]['nama']               = 'SALDO KAS AKHIR PERIODE';
            $data['data'][$i]['realisasi']          = $sumSaldoKas['realisasi'] + ($sumPiutang['realisasi'] + $sumPersediaan['realisasi'] + $sumBiayaDimuka['realisasi'] + $sumUangMuka['realisasi'] + $sumAktivaLancarLainnya['realisasi'] + $sumBebanPenyusutan['realisasi'] + $sumLiabilitasJangkaPendek['realisasi'] + $sumInvestasi['realisasi'] + $sumLiabilitasJangkaPanjang['realisasi'] + $sumEkuitas['realisasi']);
            $data['data'][$i]['realisasi_sebelum']  = '';
            $i++;
