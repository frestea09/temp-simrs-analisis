...
@section('content')
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          @if (isset($is_edit) && $is_edit == 1) Ubah Jurnal Umum {{$data['code']}} @else Tambah Jurnal Umum @endif  &nbsp;

        </h3>
      </div>
      <div class="box-body">
          @if (isset($is_edit) && $is_edit == 1)
            {!! Form::model($data, ['route' => ['journal_umum.update', $data['id']], 'class' => 'form-horizontal', 'method' => 'PUT']) !!}
          @else
            {!! Form::open(['method' => 'POST', 'route' => 'journal_umum.store', 'class' => 'form-horizontal']) !!}
          @endif
            <div class="col-sm-6">
