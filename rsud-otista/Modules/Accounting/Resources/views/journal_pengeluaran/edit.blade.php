...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <div class="col-sm-12">
            ...
            <div class='table-responsive'>
                <table class='table table-condensed table-bordered'>
                    ...
                    <tbody>
                        {!! Form::model($journal, ['route' => ['journal_pengeluaran.update', $journal['id']], 'class' => 'form-horizontal', 'method' => 'PUT']) !!}
        ...
        <div class="btn-group pull-right">
            <a href="{{ route('journal_pengeluaran.index') }}" class="btn btn-warning btn-flat">Batal</a>
