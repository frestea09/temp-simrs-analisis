...
@section('header')
  <h1>Detail Jurnal Penerimaan</h1>
@endsection
      ...
      <div class="box-body">
        <div class="col-sm-6">
            ...
            <div class="form-group">
                {!! Form::label('keterangan', 'Keterangan', ['class' => 'col-sm-4 control-label']) !!}
                <div class="col-sm-8">
                    : &nbsp;@if ($verifikasi == 0) <label class="control-label">Belum Verifikasi</label> @else <label class="control-label">Sudah Verifikasi</label> @endif
                </div>
            </div>
        </div>
        <div class="col-sm-12">
