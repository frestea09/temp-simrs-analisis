...
{
    protected $fillable = ['id_tindakan','jenis_akreditasi','lica_id','kodeloinc','visite','nama', 'kode', 'jenis', 'kelas_id', 'kategoriheader_id', 'kategoritarif_id', 'keterangan', 'tahuntarif_id','kelompoktarif_id','kelompok','jasa_rs','jasa_pelayanan','total','carabayar','mastermapping_id','mapping_biaya_id','mapping_pemeriksaan','rl33_id','rl36_id', 'akutansi_akun_coa_id', 'is_aktif'];
