<div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-9">
        {!! Form::text('nama', null, ['class' => 'form-control', 'required' => 'required','readonly'=>true]) !!}
...
<div class="form-group{{ $errors->has('jenis_id') ? ' has-error' : '' }}">
    {!! Form::label('jenis_id', 'Jenis Obat', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-9">
        {!! Form::select('jenis_id', $jenis, null, ['class' => 'form-control select2', 'required' => 'required' ]) !!}
        <small class="text-danger">{{ $errors->first('jenis_id') }}</small>
    </div>
</div>
<div class="form-group{{ $errors->has('satuanjual_id') ? ' has-error' : '' }}">
    {!! Form::label('satuanjual_id', 'Satuan Jual', ['class' => 'col-sm-3 control-label']) !!}
    <div class="col-sm-9">
        {!! Form::select('satuanjual_id', $satuanjual, null, ['class' => 'form-control select2', 'required' => 'required' ]) !!}
...
<div class="form-group{{ $errors->has('satuanbeli_id') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-9">
        {!! Form::select('satuanbeli_id', $satuanbeli, null, ['class' => 'form-control select2', 'required' => 'required' ]) !!}
...
<div class="form-group{{ $errors->has('hargabeli') ? ' has-error' : '' }}">
  ...
  <div class="col-sm-9">
    {!! Form::text('hargabeli', $batch->hargabeli, ['class' => 'form-control', 'required' => 'required']) !!}
...
<div class="form-group{{ $errors->has('hargajual') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-9">
        {!! Form::text('hargajual', $batch->hargajual_umum, ['class' => 'form-control', 'required' => 'required']) !!}
        <small class="text-success">Contoh format inputan 29000.23   -> inputan desimal menggunakan titik dan tidak boleh ada (,) koma</small>
...
<div class="form-group{{ $errors->has('hargajual_jkn') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-9">
        {!! Form::text('hargajual_jkn', $batch->hargajual_jkn, ['class' => 'form-control']) !!}
        <small class="text-success">Contoh format inputan 29000.23   -> inputan desimal menggunakan titik dan tidak boleh ada (,) koma</small>
...
<div class="form-group{{ $errors->has('hargajual_kesda') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-9">
        {!! Form::text('hargajual_kesda', $batch->hargajual_dinas, ['class' => 'form-control']) !!}
        <small class="text-success">Contoh format inputan 29000.23   -> inputan desimal menggunakan titik dan tidak boleh ada (,) koma</small>
