  ...
  <body>
    ...
    <table style="width:100%; margin-bottom: -10px;">
            <tbody>
              <tr>
                <th style="width:20%">
                  <img src="{{ public_path('images/'.configrs()->logo) }}" class="img img-responsive text-left" style="width:85px;">
                </th>
                <th class="text-left">
      ...
      <table style="width:100%">
          ...
          @else  --}}
            <h5 style="text-align: center;">Rincian Biaya Perawatan / Pemeriksaan</h5>
          {{--  @endif  --}}
