...
<html>
  ...
  <body onload="window.print()">
      ...
      <div class="table-responsive">
        <table class="table table-bordered" style="width: 100%">
          ...
          <tfoot>
            ...
            <tr>
              <th colspan="3" class="text-right">Jumlah Biaya Perawatan </th>
              <td class="text-right"><b>{{ number_format($jml_irj+$jml_obat+$uangracik) }}</b></td>
            </tr>
          </tfoot>
        </table>
      </div>
    ...
    @endif
      ...
      @if ($bayar->bayar <> 1)
        <tr>
          <th colspan="2"><i>"{{ terbilang($jml_irj+$jml+$uang_racik) }} Rupiah"</i></th>
        </tr>
      @endif
