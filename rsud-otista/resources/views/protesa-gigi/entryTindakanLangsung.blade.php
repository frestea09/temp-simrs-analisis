...
@section('header')
  <h1>
      Entry Tindakan Langsung - Protesa Gigi
  </h1>
@endsection
    ...
    <div class="box box-primary">
      <div class="box-body">
        ...
        <div class="box box-info">
          <div class="box-body">
            {!! Form::open(['method' => 'POST', 'url' => 'protesa-gigi/save-tindakan-langsung', 'class' => 'form-horizontal']) !!}
              ...
              <div class="col-md-5">
                ...
                <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      ...
                      <a href="{{ url('protesa-gigi/pasien-langsung') }}" class="btn btn-primary btn-flat">SELESAI</a>
                    @if($cek > 0)
                      <a href="{{ url('protesa-gigi/cetak-tindakan/TA/'.$reg->id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                    @endif
                    </div>
                </div>
              </div>
