  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
        <div class="col-md-2 col-sm-3 col-xs-6 text-center iconModule">
          <a href="{{ url('protesa-gigi/laporan-pengunjung') }}" ><img src="{{ asset('menu/fixed/laporan.png') }}" width="50px" heigth="50px"  class="img-responsive" alt=""/>
          <h5>Laporan</h5>
        </div>
      {{--  <div class="col-md-2 col-sm-3 col-xs-6 text-center iconModule">
