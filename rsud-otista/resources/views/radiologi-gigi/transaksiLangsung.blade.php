@extends('master')
@section('header')
  <h1>Radiologi Gigi - Transaksi Langsung <small></small></h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
		{!! Form::open(['method' => 'POST', 'url' => 'radiologi-gigi/searchpasien', 'class' => 'form-search']) !!}
		...
		{!! Form::close() !!}
		<form action="{{ url('radiologi-gigi/simpan-transaksi-langsung') }}" method="POST" id="formRadiologiLangsung" class="form-horizontal">
		...
		<hr>
		{!! Form::open(['method' => 'POST', 'url' => 'radiologi-gigi/transaksi-langsung', 'class'=>'form-hosizontal']) !!}
		<div class="row">
			<div class="col-md-6">
					...
					<tbody>
						@foreach ($data as $d)
							<tr>
								...
								<td>
									<a href="{{ url('/radiologi-gigi/entry-transaksi-langsung/'.$d->registrasi_id) }}" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-database"></i></a>
								</td>
								<td>
									<a href="{{ url('radiologi-gigi/cetakRadLangsung/'.$d->registrasi_id) }}" target="_blank" class="btn btn-flat btn-sm btn-warning"><i class="fa fa-print"></i></a>
								</td>
								<td>
								...
								<td class="text-center">
									<a class="btn btn-success btn-xs" target="_blank" href="{{url('/radiologi-gigi/create-ekspertise/'.$d->registrasi_id)}}">Proses</a>
...
<script src="{{ asset('vendor/unisharp/laravel-ckeditor/adapters/jquery.js') }}"></script>
  ...
  <script type="text/javascript">
    ...
    function tekspertise(registrasi_id) {
      ...
      $.ajax({
        url: '/radiologi-gigi/ekspertise-langsung/'+registrasi_id,
        type: 'GET',
        dataType: 'json',
      })
      .done(function(data) {
