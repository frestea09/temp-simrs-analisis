  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('/radiologi-gigi/laporan-kunjungan') }}" ><img src="{{ asset('menu/fixed/laporankunjungan.png') }}" width="50px" heigth="50px" class="img-responsive" alt=""/>
        </a>
      ...
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('radiologi-gigi/laporan-kinerja') }}" ><img src="{{ asset('menu/fixed/laporankinerja.png') }}" width="50px" heigth="50px" class="img-responsive" alt=""/>
        </a>
