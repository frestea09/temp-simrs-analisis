...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            {!! Form::open(['method' => 'POST', 'url' => '/frontoffice/antrian-realtime-bytgl', 'class' => 'form-hosizontal']) !!}
            <div class="row">
                <div class="col-md-3">
                    ...
                    <div class="input-group{{ $errors->has('filter_poli') ? ' has-error' : '' }}">
                        ...
                        <select name="filter_poli" id="" class="form-control select2" onchange="this.form.submit()">
                            ...
                            @foreach ($poli as $value)
                                <option value="{{$value->poli_id}}" {{@$filter_poli == $value->poli_id ? 'selected' : ''}}>{{baca_poli($value->poli_id)}}</option>
                            @endforeach
                        </select>
            ...
            @include('frontoffice.view_ajax_antrianRealtime')
