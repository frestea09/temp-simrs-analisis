@extends('master')
@section('header')
  <h1>Laporan 10 Besar Diagnosa IRNA </h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'frontoffice/laporan/diagnosa-irna', 'class'=>'form-horizontal']) !!}
      <div class="row">
        {{-- <div class="col-md-2">
        ...
        <div class="col-md-4">
          ...
          <div class="input-group">
            <span class="input-group-btn">
              <button class="btn btn-default openICD10" id="" type="button">Ruangan</button>
            </span>
              {!! Form::select('kamar_id', $kamars,null, ['class' => 'form-control select2','placeholder'=>'Semua']) !!}
          </div>
        </div>
          ...
          <table class='table table-striped table-bordered table-hover table-condensed' id="data">
            ...
            <tbody>
              ...
              @php
                ...
                $icd9 = App\PerawatanIcd9::where('registrasi_id', $d['idReg'])->first();
                // $ranap = App\Rawatinap::where('registrasi_id', $reg->id)->first();
                $pasien = Modules\Registrasi\Entities\Registrasi::where('pasien_id',$d['idPasien'])->count();
              ...
              @endphp
                ...
                <tr>
                  ...
                  <td>{{ $d['tglMasuk'] }}</td>
                  <td>{{ $d['tglKeluar'] }}</td>
                  <td>{{ $d['diagnosaAwal'] }}</td>
                  {{-- <td>{{ @baca_diagnosa(@$d->diagnosa_akhir) }}</td> --}}
