...
@section('content')
    <div class="box box-primary">
            ...
            <div class='table-responsive'>
                <table class='table table-bordered table-hover table-condensed'>
                    <tbody>
                        ...
                        <tr>
                            <th>Nama </th> <td>{{ @$reg->pasien->nama }}</td> <th>Cara Bayar</th> <td>{{ baca_carabayar(@$reg->bayar) }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>{{ \Carbon\Carbon::parse(@$reg->created_at )->format('d-m-Y H:i:s')}}</td>
                        </tr>
                        <tr>
        ...
        @else
            {!! Form::open(['method' => 'POST', 'url' => 'frontoffice/simpan_diagnosa_rawatinap', 'class' => 'form-horizontal']) !!}
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-condensed">
                                                ...
                                                @foreach ($perawatanicd10 as $key => $d)
                                                    <tr>
                                                        <td>{{ $d->icd10 }}</td>
                                                        @if (Modules\Icd10\Entities\Icd10::where('nomor', $d->icd10)->first())
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-condensed">
                                                ...
                                                @foreach ($perawatanicd9 as $key => $d)
                                                    <tr>
                                                        <td>{{ !empty($d->icd9) ? $d->icd9 :'' }}</td>
                                                        @if (Modules\Icd9\Entities\Icd9::where('nomor', $d->icd9)->first())
