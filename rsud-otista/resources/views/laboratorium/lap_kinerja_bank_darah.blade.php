...
@section('header')
  <h1>Laporan Kinerja Bank Darah</h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    <div class="box-body">
       <div class="row">
        <form action="{{ url('laboratorium/laporan-kinerja-bank-darah') }}" method="POST" class="form-horizontal">
          {{ csrf_field() }}
            <div class="col-sm-6">
              ...
              <table id="data" class="table table-hover table-bordered table-condensed">
                <thead class="bg-primary">
                  <tr>
                    ...
                    <th style="vertical-align: middle;" class="text-center">Asal Pasien</th>
                  ...
                  @if (isset($data) && !empty($data))
                    @foreach ($data as $d)
                      ...
                      <tr>
                        ...
                        <td class="text-center">{{ $d->total / $d->tarif->total }}</td>
                ...
                <tfoot>
                  <tr>
                    <th colspan="6" class="text-right">Total Tarif</th>
                    <th class="text-right">{{ isset($total) ? number_format($total) : NULL }}</th>
                  </tr>
                  <tr>
                    <th colspan="6" class="text-right">Total Pemeriksaan</th>
