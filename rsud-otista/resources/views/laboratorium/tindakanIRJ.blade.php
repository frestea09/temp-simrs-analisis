...
@section('content')
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        {!! Form::open(['method' => 'POST', 'url' => 'laboratorium/tindakan-irj', 'class'=>'form-hosizontal']) !!}
        <div class="row">
          {{-- <div class="col-md-3">
          ...
          <table class='table table-striped table-bordered table-hover table-condensed' id='data'>
            <thead>
              <tr>
                ...
                {{-- @endif --}}
                <th class="text-center" style="vertical-align: middle;">Cetak/Sesi (LIS)</th>
                <th class="text-center" style="vertical-align: middle;">Upload Hasil</th>
            ...
            <tbody>
              @foreach ($registrasi as $key => $d)
                  ...
                  <td>{{ @$d->no_sep }}</td>
                  {{-- <td>
                    <a href="{{ url('/laboratorium/entry-tindakan-irj/'. $d->id.'/'.$d->pasien_id) }}" onclick="return confirm('APAKAH YAKIN AKAN DILAKUKAN TINDAKAN LAB? KARENA AKAN MENAMBAH KUNJUNGAN LAB.')" class="btn btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                  </td> --}}
                  <td>
                    @if (count(@$d->folioLab) > 0)
                      <a href="{{ url('laboratorium/cetakRincianLab/irj/'.$d->id) }}" target="_blank" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-print"></i></a>
                    @endif
                  </td>
                  {{-- @if (Auth::user()->id ==1) --}}
                  <td>
                  ...
                  <td>
                    <a href="{{ url('/emr/upload-hasil/lain/jalan/'.$d->id) }}" class="btn btn-sm btn-warning btn-flat" target="_blank"><i class="fa fa-upload"></i></a>
                  </td>
                  <td>
