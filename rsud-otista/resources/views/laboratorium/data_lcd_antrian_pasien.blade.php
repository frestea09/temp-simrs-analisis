...
<div class="row">
  <div class="text-center col-md-12" style="margin: 3rem 0; height: 100%;">
    ...
    @if (!empty($antrian))
      <h2 class="text-bold" style="font-size: 300pt;" id="nomor_antrian">{{@$antrian->nomor}}</h2>
      <h4 class="text-bold" style="font-size: 48pt;" id="nama_pasien">{{ @$antrian->pasien->nama }}</h4>
      <h4 class="text-bold" style="font-size: 48pt;" id="no_rm">{{ @$antrian->pasien->no_rm }}</h4>
      <h4 class="text-bold" style="font-size: 48pt;" id="poli">{{ baca_poli(@$antrian->registrasi->poli_id) }}</h4>
    @endif
  </div>
</div>
{{-- <div class="row">
