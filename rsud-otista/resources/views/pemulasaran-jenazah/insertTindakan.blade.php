    ...
    <div class="box box-primary">
      <div class="box-body">
        ...
        <div class="box box-info">
          <div class="box-body">
            {!! Form::open(['method' => 'POST', 'url' => 'pemulasaran-jenazah/save-tindakan', 'class' => 'form-horizontal']) !!}
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      ...
                      @if($j == 'TI')
                        <a href="{{ url('pemulasaran-jenazah/tindakan-ranap') }}" class="btn btn-primary btn-flat">SELESAI</a>
                      @elseif($j == 'TA')
                        <a href="{{ url('pemulasaran-jenazah/tindakan-rajal') }}" class="btn btn-primary btn-flat">SELESAI</a>
                      @else
                        <a href="{{ url('pemulasaran-jenazah/tindakan-darurat') }}" class="btn btn-primary btn-flat">SELESAI</a>
                      @endif
                        <a href="{{ url('pemulasaran-jenazah/cetak-tindakan/'.$j.'/'.$reg->id) }}" target="_blank" class="btn btn-warning btn-flat">CETAK</a>
                    </div>
                </div>
              </div>
            </div>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    @if ($d->lunas == 'Y')
                      <i class="fa fa-check"></i>
                    @else
                        <a href="{{ url('pemulasaran-jenazah/hapus-tindakan/'.$d->id.'/'.$d->fol_id) }}" onclick="return confirm('Yakin akan di hapus?')" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-trash-o"></i></a>
                    @endif
                  </td>
                </tr>
              @endforeach
  ...
  <script type="text/javascript">
    ...
    function lunas(){
      ...
      if(confirm('Yakin akan di lunaskan?')){
        $.post('/pemulasaran-jenazah/lunas-tindakan', data, function(resp){
          if(resp.sukses == true){
            location.reload()
          }
        })
    ...
    function belumLunas(){
      ...
      if(confirm('Yakin belum lunas?')){
        $.post('/pemulasaran-jenazah/belum-lunas-tindakan', data, function(resp){
          if(resp.sukses == true){
            location.reload()
          }
        })
