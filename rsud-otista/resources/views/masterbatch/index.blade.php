...
@section('script')
  <script type="text/javascript">
    ...
    function edit($id){
        ...
        $('.modal-title').text('Edit Master Batch');
    ...
    table = $('.tabeldata').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '{{ route('masterobat-batches.index') }}',
      columns: [
          {data: 'DT_RowIndex', searchable: false, orderable: false},
          {data: 'nama_obat', searchable: false},
          {data: 'nomorbatch', searchable: false},
          {data: 'satuan_beli'},
          {data: 'satuan_jual'},
