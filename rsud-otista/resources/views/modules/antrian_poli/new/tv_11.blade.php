...
<body>
                ...
                <div class="col-md-12">
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="T_antrian" class="nomor_antrian">
                                    {{ @$antrianT->kelompok . @$antrianT->nomor }}</div> --}}
                                {{-- <div id="T_nama" class="nama_pasien">
                                    {{ @$antrianT->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_tht">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianT->register_antrian->nomorantrian) )
                                            <div id="22_antrian" class="nomor_antrian">
                                                {{ @$antrianT->kelompok . @$antrianT->nomor }}
                                            </div>
                                        @else
                                            <div id="22_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianT->register_antrian->nomorantrian) }}
                                            </div>
                                            @endif --}}
                                        <div id="22_antrian" class="nomor_antrian">
                                            {{ @$antrianT->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="22_nama" class="nama_pasien">
                                            {{ @$antrianT->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="M_antrian" class="nomor_antrian">
                                    {{ @$antrianM->kelompok . @$antrianM->nomor }}</div>
                                <div id="M_nama" class="nama_pasien">
                                    {{ @$antrianM->register_antrian->pasien->nama }}</div>
                            </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem;  margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_urologi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianM->register_antrian->nomorantrian) )
                                            <div id="44_antrian" class="nomor_antrian">
                                                {{ @$antrianM->kelompok . @$antrianM->nomor }}
                                            </div>
                                        @else
                                            <div id="44_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianM->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="44_antrian" class="nomor_antrian">
                                            {{ @$antrianM->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="44_nama" class="nama_pasien">
                                            {{ @$antrianM->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-3" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-3">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_gizi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        @if( !baca_nomorantrian_bpjs(@$antrianGZ->register_antrian->nomorantrian) )
                                            <div id="12_antrian" class="nomor_antrian">
                                                {{ @$antrianGZ->kelompok . @$antrianGZ->nomor }}
                                            </div>
                                        @else
                                            <div id="12_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianGZ->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif
                                        <div id="12_nama" class="nama_pasien">
                                            {{ @$antrianGZ->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-4" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-4">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_psikiatri">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        @if( !baca_nomorantrian_bpjs(@$antrianP->register_antrian->nomorantrian) )
                                            <div id="19_antrian" class="nomor_antrian">
                                                {{ @$antrianP->kelompok . @$antrianP->nomor }}
                                            </div>
                                        @else
                                            <div id="19_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianP->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif
                                        <div id="19_nama" class="nama_pasien">
                                            {{ @$antrianP->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv11/belum-dipanggil',
                success: function (data) {
                  // Urologi
                  let poli_urologi = data[0];

                    // urutkan berdasarkan angka di akhir nomorantrian
                    poli_urologi.sort((a, b) => {
                    ...
                    poli_urologi.forEach(urologi => {
                        if (urologi != null) {
                            html += `
                                <tr>
                                    <td class="nomor">${urologi.nomorantrian}</td>
                                    <td class="text-center">${urologi?.nama ?? ''}</td>
                                </tr>`;
                        }
                    });
                    $('#antrian_belum_dipanggil_urologi').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_urologi').html('');
                    }
                    html = null;

                    // THT
                    let poli_tht = data[1];
                    // Urutkan berdasarkan angka di akhir nomorantrian (misal: "WWN-THT10" -> 10)
                    poli_tht.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    // poli_tht.forEach(tht => {
                    //     if (tht != null) { 
                    //             html += `<tr>
                    //                         <td class="nomor">${tht.nomorantrian}</td>
                    //                         <td class="text-center">${tht?.nama ?? ''}</td>
                    //                     </tr>` 
                    //     }
                    // })
                    poli_tht.forEach(tht => {
                    ...
                    $('#antrian_belum_dipanggil_tht').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_tht').html('');
                    }
                    html = null;

                    // GIZI
                    // let poli_gizi = data[2];
                    // poli_gizi.forEach(gizi => {
                    //     if (gizi != null) {
                    //         if (bacaNomorAntrianBPJS(gizi.nomorantrian)) {
                    //             html += `<tr>
                    //                         <td class="nomor">${bacaNomorAntrianBPJS(gizi.nomorantrian)}</td>
                    //                         <td class="text-center">${gizi?.nama ?? ''}</td>
                    //                     </tr>`
                    //         } else {
                    //             html += `<tr>
                    //                         <td class="nomor">${gizi.kelompok_antrian ?? '-'}${gizi.nomor_antrian ?? '-'}</td>
                    //                         <td class="text-center">${gizi?.nama ?? ''}</td>
                    //                     </tr>`
                    //         }
                    //     }
                    // })
                    // $('#antrian_belum_dipanggil_gizi').html(html);
                    // if (html == undefined) {
                    //     $('#antrian_belum_dipanggil_gizi').html('');
                    // }
                    // html = null;

                    // PSIKIATRI
                    // let poli_psikiatri = data[3];
                    // poli_psikiatri.forEach(psikiatri => {
                    //     if (psikiatri != null) {
                    //         if (bacaNomorAntrianBPJS(psikiatri.nomorantrian)) {
                    //             html += `<tr>
                    //                         <td class="nomor">${bacaNomorAntrianBPJS(psikiatri.nomorantrian)}</td>
                    //                         <td class="text-center">${psikiatri?.nama ?? ''}</td>
                    //                     </tr>`
                    //         } else {
                    //             html += `<tr>
                    //                         <td class="nomor">${psikiatri.kelompok_antrian ?? '-'}${psikiatri.nomor_antrian ?? '-'}</td>
                    //                         <td class="text-center">${psikiatri?.nama ?? ''}</td>
                    //                     </tr>`
                    //         }
                    //     }
                    // })
                    // $('#antrian_belum_dipanggil_psikiatri').html(html);
                    // if (html == undefined) {
                    //     $('#antrian_belum_dipanggil_psikiatri').html('');
                    // }
                    // html = null;
                }
            });
        ...
        function bacaNomorAntrianBPJS(nomorAntrian) {
            if (nomorAntrian === null || nomorAntrian.length <= 11) {
                return false;
            }

            const antrian = nomorAntrian.substring(11);
