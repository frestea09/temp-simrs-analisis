...
<body>
                ...
                <div class="col-md-12">
                    <div class="col-sm-12">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="G_antrian" class="nomor_antrian">
                                    {{ @$antrianG->kelompok . @$antrianG->nomor }}</div> --}}
                                {{-- <div id="G_nama" class="nama_pasien">
                                    {{ @$antrianG->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_gigi_dan_mulut">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianG->register_antrian->nomorantrian) )
                                            <div id="3_antrian" class="nomor_antrian">
                                                {{ @$antrianG->kelompok . @$antrianG->nomor }}
                                            </div>
                                        @else
                                            <div id="3_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianG->register_antrian->nomorantrian) }}
                                            </div>
                                        @endif --}}
                                        <div id="3_antrian" class="nomor_antrian">
                                            {{ @$antrianG->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="3_nama" class="nama_pasien">
                                            {{ @$antrianG->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="GE_antrian" class="nomor_antrian">
                                    {{ @$antrianGE->kelompok . @$antrianGE->nomor }}</div> --}}
                                {{-- <div id="GE_nama" class="nama_pasien">
                                    {{ @$antrianGE->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1 container-box-2" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-2"">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_endodonsi">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianGE->register_antrian->nomorantrian) )
                                            <div id="34_antrian" class="nomor_antrian">
                                                {{ @$antrianGE->kelompok . @$antrianGE->nomor }}
                                            </div>
                                        @else
                                        @endif --}}
                                        <div id="34_antrian" class="nomor_antrian">
                                            {{ @$antrianGE->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="34_nama" class="nama_pasien">
                                            {{ @$antrianGE->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="blockloket">
                            ...
                            {{-- <div class="text-center">
                                <div id="BM_antrian" class="nomor_antrian">
                                    {{ @$antrianBM->kelompok . @$antrianBM->nomor }}</div> --}}
                                {{-- <div id="BM_nama" class="nama_pasien">
                                    {{ @$antrianBM->register_antrian->pasien->nama }}</div> --}}
                            {{-- </div> --}}
                            <div class="d-flex" style="height: 265px; overflow: hidden">
                                <div class="flex-1  container-box-3" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem; margin-top: 5rem;" id="top-point-3">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_bedah_mulut">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianBM->register_antrian->nomorantrian) )
                                            <div id="4_antrian" class="nomor_antrian">
                                                {{ @$antrianBM->kelompok . @$antrianBM->nomor }}
                                            </div>
                                        @else
                                            <div id="4_antrian" class="nomor_antrian">
                                                {{ baca_nomorantrian_bpjs(@$antrianBM->register_antrian->nomorantrian) }}
                                            </div>
                                            @endif --}}
                                        <div id="4_antrian" class="nomor_antrian">
                                            {{ @$antrianBM->register_antrian->nomorantrian_jkn }}
                                        </div>
                                        <div id="4_nama" class="nama_pasien">
                                            {{ @$antrianBM->register_antrian->pasien->nama }}
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv9/belum-dipanggil',
                success: function (data) {
                    // Gigi & Mulut
                    let poli_gigi = data[0];
                    poli_gigi.sort((a, b) => {
                    ...
                    let html;
                    poli_gigi.forEach(gigi => {
                        if (true) {
                            html += `<tr>
                                        <td class="nomor">${gigi.nomorantrian}</td>
                                        <td class="text-center">${gigi.nama ?? ''}</td>
                                    </tr>`
                        }
                    })
                    $('#antrian_belum_dipanggil_gigi_dan_mulut').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_gigi_dan_mulut').html('');
                    }
                    html = null;
                    ...
                    poli_ge.forEach(ge => {
                        if (true) {
                                ...
                                html += `<tr>
                                            <td class="nomor">${ge.nomorantrian}</td>
                                            <td class="text-center">${ge.nama ?? ''}</td>
                                        </tr>` 
                        }
                    })
                    $('#antrian_belum_dipanggil_endodonsi').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_endodensi').html('');
                    }
                    html = null;

                    // Bedah mulut
                    let poli_mulut = data[2];
                    poli_mulut.sort((a, b) => {
                        let numA = parseInt((a?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        let numB = parseInt((b?.nomorantrian || '').match(/\d+$/)?.[0]) || 0;
                        return numA - numB; // ascending
                    });
                    poli_mulut.forEach(mulut => {
                        if (true) {
                             
                            html += `<tr>
                                        <td class="nomor">${mulut.nomorantrian}</td>
                                        <td class="text-center">${mulut.nama ?? ''}</td>
                                    </tr>`
                        }
                    })
                    $('#antrian_belum_dipanggil_bedah_mulut').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_bedah_mulut').html('');
                    }
                    html = null;
                }
            });
