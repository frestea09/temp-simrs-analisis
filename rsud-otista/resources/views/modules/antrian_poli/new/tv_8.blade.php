...
<body>
                                ...
                                <div class="flex-1 container-box-1" style="border-right: black solid 2px; overflow: hidden;">
                                    ...
                                    <div style="padding: 2rem;  margin-top: 5rem;" id="top-point-1">
                                        <table class="table-list-pasien">
                                            <tbody id="antrian_belum_dipanggil_mata">
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-center">
                                        {{-- @if( !baca_nomorantrian_bpjs(@$antrianM->register_antrian->nomorantrian) )
                                            <div id="6_antrian" class="nomor_antrian">
                                        ...
                                        <div id="6_nama" class="nama_pasien">
    ...
    <script type="text/javascript">
        ...
        function ajaxAntrianBP() {
            $.ajax({
                type: 'GET',
                url: '/antrian_poliklinik/tv8/belum-dipanggil',
                success: function (data) {
                  // Mata
                  let poli_mata = data[0];
                    poli_mata.sort((a, b) => {
                    ...
                    let html;
                    poli_mata.forEach(mata => {
                        if (mata != null) {
                           
                                html += `<tr>
                                            <td class="nomor">${mata.nomorantrian}</td>
                                            <td class="text-center">${mata?.nama ?? ''}</td>
                                        </tr>`
                           
                        }
                    })
                    $('#antrian_belum_dipanggil_mata').html(html);
                    if (html == undefined) {
                        $('#antrian_belum_dipanggil_mata').html('');
                    }
                    html = null;
