...
<html>
  ...
  <body>
    <div class="row">
      ...
      <div class="col-md-12">
        <div class="antrianku">
          <marquee>ANTRIAN RAWAT JALAN / POLI KLINIK</marquee>
        </div>
      </div>
    </div>
              ...
              <div class="col-md-4">
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                         @foreach($data['grid']['grid1'] as $key => $item)
                         @if($item['id'] == 20)
                         <tr>
                             <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdmcu{{ $item['id'] }}"> </td>
                             {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                         </tr>
                         @endif
                         @endforeach
                       </table>
                   </div>
                   <div class="loketfoot text-center">
                     @foreach($data['grid']['grid1'] as $key => $item)
                         @if($item['id'] == 24)
                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                         ...
                         @if($item['id'] == 17)
                         <tr>
                             <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdumum{{ $item['id'] }}"> </td>
                             {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                         </tr>
                         @endif
                         @endforeach
                ...
                <div class="blockloket">
                    ...
                    <div class="btn-area text-center">
                      <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                       ...
                       @if($item['id'] == 7)
                       <tr>
                           <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdtht{{ $item['id'] }}"> </td>
                           {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                       </tr>
                       @endif
                       @endforeach
                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                         ...
                         @if($item['id'] == 12)
                         <tr>
                             <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdbedah{{ $item['id'] }}"> </td>
                             {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                         </tr>
                         @endif
                         @endforeach
                ...
                <div class="blockloket">
                    ...
                    <div class="btn-area text-center">
                      <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                       ...
                       @if($item['id'] == 11)
                       <tr>
                           <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdbidan{{ $item['id'] }}"> </td>
                           {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                       </tr>
                       @endif
                       @endforeach
                ...
                <div class="blockloket">
                    ...
                    <div class="btn-area text-center">
                      <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                       ...
                       @if($item['id'] == 8)
                       <tr>
                           <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdgigi{{ $item['id'] }}"> </td>
                           {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                       </tr>
                       @endif
                       @endforeach
        ...
        $.ajax({
          ...
          success: function(res){
            $.each(res.data, function (key, val) {
              $('table').find('#layarlcdmcu'+key).html(val); 
