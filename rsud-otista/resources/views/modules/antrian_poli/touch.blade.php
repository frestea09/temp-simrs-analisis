    ...
    <style type="text/css" media="screen">
      ...
      .btnTouch{
          ...
          /* Permalink - use to edit and share this gradient: http://colorzilla.com/gradient-editor/#bfd255+0,72aa00+0,8eb92a+48,9ecb2d+100 */
            background: #d8770b; /* Old browsers */
      }
...
<div class="container-fluid">
  <div class="row">
        ...
        <div class="box-loket">
          <div class="loketheader text-center">
            @if ($loket2->count() > 0)
              ...
              {!! Form::close() !!}
            @else
              <div style="color: white;">LOKET 2</div>
            @endif
        ...
        <div class="box-loket">
          <div class="loketheader text-center">
            @if ($loket3->count() > 0)
              ...
              {!! Form::hidden('loket', 3) !!}
              {!! Form::hidden('tanggal', date('Y-m-d')) !!}
              {!! Form::submit("LOKET 3 (Apotek)", ['class' => 'btnTouch']) !!}
              {!! Form::close() !!}
            @else
              <div style="color: white;">LOKET 3 (Apotek)</div>
            @endif
    ...
    <div class="col-md-12">
      <div class="jumbotron" style="background-color:#ffbf1e;">
        <h2 style="color:white;">Cara Penggunaaan</h2>
        <p style="color:white;">Bootstrap is the most popular HTML, CSS...</p>
      </div>
