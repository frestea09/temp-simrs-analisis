...
<div class="container-fluid">
    ...
    <div class="contents">
                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                           <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                            ...
                            @if($item['id'] == 1)
                            <tr>
                                <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdanak{{ $item['id'] }}"> </td>
                      ...
                      <div class="loketfoot text-center">
                        {{-- <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                          ...
                          @if($item['id'] == 1)
                          <tr>
                              <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdanak{{ $item['nama'] }}"> </td>
                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                         ...
                         @if($item['id'] == 24)
                         <tr>
                             <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdsyaraf{{ $item['id'] }}"> </td>
                             {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                         </tr>
                         @endif
                         @endforeach
                ...
                <div class="blockloket">
                    ...
                    <div class="btn-area text-center">
                      <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                       ...
                       @if($item['id'] == 23)
                       <tr>
                           <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 80pt" id="layarlcdalam{{ $item['id'] }}"> </td>
                           {{-- <td class="textkutv1" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                       </tr>
                       @endif
                       @endforeach
      ...
      <div class="row">
        <div class="col-md-12" id="suara_antrian"></div>
      </div>
  ...
  var poli_arr = [];
   ...
   // JSON.parse(data_poli).forEach(function(item) {
    ...
    setInterval(function () {
       $('#suara_antrian').load("{{ route('antrian_poli.ajax_suara') }}");
    }, 15000);
        ...
        $.ajax({
          ...
          success: function(res){
            $.each(res.data, function (key, val) {
              $('table').find('#layarlcdanak'+key).html(val); 
              $('table').find('#layarlcdsyaraf'+key).html(val); 
              $('table').find('#layarlcdalam'+key).html(val); 
            });
          }
        });
      }
