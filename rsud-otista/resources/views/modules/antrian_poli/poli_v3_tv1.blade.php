...
<div class="container-fluid">
        ...
        <div class="col-md-12">
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="text-center">
                    <div id="layarlcdanakdiperiksa"></div>
                </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="contain table-responsive">
                    <div id="layarlcdanakantrian"></div>
                </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="text-center">
                    <div id="layarlcdsyarafperiksa"></div>
                </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="contain table-responsive">
                    <div id="layarlcdsyarafantrian"></div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="text-center">
                    <div id="layarlcddalamperiksa"></div>
                </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="contain table-responsive">
                    <div id="layarlcddalamantrian"></div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="text-center">
                    <div id="layarlcdgeriatriperiksa"></div>
                </div>
            </div>
          </div>
          ...
          <div class="col-sm-4">
            <div class="blockloket">
                ...
                <div class="contain table-responsive">
                    <div id="layarlcdgeriatriantrian"></div>
                </div>
              </div>
          </div> 
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      setInterval(function () {
        $('#layarlcdanakdiperiksa').load("{{ route('antrian_poli.datalayarlcdanakdiperiksa') }}");
      },9000); //normal 13000
    });
  </script>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      setInterval(function () {
        $('#layarlcdanakantrian').load("{{ route('antrian_poli.datalayarlcdanakantrian') }}");
      },9000); //normal 13000
    });
  </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcdsyarafperiksa').load("{{ route('antrian_poli.datalayarlcdsyarafperiksa') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcdsyarafantrian').load("{{ route('antrian_poli.datalayarlcdsyarafantrian') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcddalamperiksa').load("{{ route('antrian_poli.datalayarlcddalamperiksa') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcddalamantrian').load("{{ route('antrian_poli.datalayarlcddalamantrian') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcdgeriatri').load("{{ route('antrian_poli.datalayarlcdgeriatri') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcdgeriatriperiksa').load("{{ route('antrian_poli.datalayarlcdgeriatriperiksa') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcdgeriatriantrian').load("{{ route('antrian_poli.datalayarlcdgeriatriantrian') }}");
        },9000); //normal 13000
      });
    </script>
