                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="width:100%">
                            ...
                            <tr>
                                <td class="textkutv1 text-center"  id="layarlcdanak{{ $item['id'] }}"> </td>
                  ...
                  <div class="blockloket">
                      ...
                      <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="width:100%">
                            ...
                            @if($item['id'] == 24)
                            <tr>
                              <td class="textkutv1 text-center" id="layarlcdsyaraf{{ $item['id'] }}"> </td>
                              {{-- <td class="textku" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                            </tr>
                            @endif
                            @endforeach
                ...
                <div class="blockloket">
                    ...
                    <div class="btn-area text-center">
                        <table class="col-md-5 text-center" style="width:100%">
                            ...
                            @if($item['id'] == 23)
                            <tr>
                                <td class="textkutv1 text-center" id="layarlcdalam{{ $item['id'] }}"> </td>
                                {{-- <td class="textku" style="font-size: 40pt">{{ $item['nama'] }}</td> --}}
                            </tr>
                            @endif
                            @endforeach
                    ...
                    <div class="loketfoot text-center">
                      ...
                      {{-- <table class="col-md-5 text-center" style="margin-bottom: 20px;">
                            ...
                            @if($item['id'] == 23)
                            <tr>
                                <td width="500px;height:150px" class="textkutv1 text-center" style="font-size: 30pt" id="layarlcdalam{{ $item['id'] }}"> </td>
                            </tr>
                            @endif
                            @endforeach
                          </table>
