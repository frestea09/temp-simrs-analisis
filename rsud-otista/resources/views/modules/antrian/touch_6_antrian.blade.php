    ...
    <div class="row">
      ...
      <div class="col-md-4">
          <div class="blockloket">
              ...
              <div class="btn-area">
                {!! Form::open(['method' => 'POST', 'url' => 'antrian3/savetouch']) !!}
                    {!! Form::hidden('loket', 'bpjs') !!}
                    {!! Form::hidden('tanggal', date('Y-m-d')) !!}
                    {!! Form::submit("TEKAN DI SINI", ['class' => 'btnTouch']) !!}
                {!! Form::close() !!}
    ...
    <div class="row">
      <div class="col-md-4">
          <div class="blockloket">
              ...
              <div class="btn-area">
                {!! Form::open(['method' => 'POST', 'url' => 'antrian4/savetouch']) !!}
                    {!! Form::hidden('loket', 'bpjs') !!}
                    {!! Form::hidden('tanggal', date('Y-m-d')) !!}
                    {!! Form::submit("TEKAN DI SINI", ['class' => 'btnTouch']) !!}
                {!! Form::close() !!}
      ...
      <div class="col-md-4">
          <div class="blockloket">
              ...
              <div class="btn-area">
                {!! Form::open(['method' => 'POST', 'url' => 'antrian5/savetouch']) !!}
                    {!! Form::hidden('loket', 'bpjs') !!}
                    {!! Form::hidden('tanggal', date('Y-m-d')) !!}
                    {!! Form::submit("TEKAN DI SINI", ['class' => 'btnTouch']) !!}
                {!! Form::close() !!}
      ...
      <div class="col-md-4">
          <div class="blockloket">
              ...
              <div class="btn-area">
                {!! Form::open(['method' => 'POST', 'url' => 'antrian6/savetouch']) !!}
                    {!! Form::hidden('loket', 'bpjs') !!}
                    {!! Form::hidden('tanggal', date('Y-m-d')) !!}
                    {!! Form::submit("TEKAN DI SINI", ['class' => 'btnTouch']) !!}
                {!! Form::close() !!}
