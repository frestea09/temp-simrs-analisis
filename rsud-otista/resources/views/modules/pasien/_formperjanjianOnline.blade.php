<div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group" id="blmTerdata">
        {{-- <div class="form-group has-success"> --}}
        {!! Form::label('no_rm', 'Nomor RM', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-9">
            {!! Form::text('no_rm', @$pasienLama ? @$pasienLama->no_rm : null, ['class' => 'form-control', 'readonly' => 'readonly']) !!}
    ...
    <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::text('nama', @$pasienBaru->nama, ['class' => 'form-control', 'onkeyup'=>'this.value = this.value.toUpperCase()']) !!}
    ...
    <div class="form-group{{ $errors->has('nik') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::text('nik',  @$pasienBaru->nik, ['class' => 'form-control']) !!}
    ...
    <div class="form-group{{ $errors->has('tmplahir') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            <div class="row">
              <div class="col-md-5">
                {!! Form::text('tmplahir', @$pasienBaru->tmplahir, ['class' => 'form-control', 'onkeyup'=>'this.value = this.value.toUpperCase()']) !!}
                <small class="text-danger">{{ $errors->first('tmplahir') }}</small>
              </div>
              <div class="col-md-7">
                {!! Form::text('tgllahir', @$pasienBaru->tgllahir, ['class' => 'form-control', 'id'=>'tgllahir']) !!}
    ...
    <div class="form-group{{ $errors->has('alamat') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-5">
            {!! Form::text('alamat', @$pasienBaru->alamat, ['class' => 'form-control', 'onkeyup'=>'this.value = this.value.toUpperCase()']) !!}
            <small class="text-danger">{{ $errors->first('alamat') }}</small>
        </div>
        <div class="col-sm-2">
            {!! Form::text('rt', @$pasienBaru->rt, ['class' => 'form-control', 'placeholder'=>'RT']) !!}
            <small class="text-danger">{{ $errors->first('rt') }}</small>
        </div>
        <div class="col-sm-2">
            {!! Form::text('rw', @$pasienBaru->rw, ['class' => 'form-control', 'placeholder'=>'RW']) !!}
