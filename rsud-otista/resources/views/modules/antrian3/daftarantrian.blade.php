...
@section('header')
  <h1 style="font-size: 20pt;color:black;font-weight: bold;">Front Office - Daftar Antrian Loket JKN Atas</h1>
@endsection
                            ...
                            <td>
                              @if (cek_registrasi($d->id, 3) < 1)
                                ...
                                <div class="btn-group" style="min-width:0px !important">
                                  <a href="{{ route('antrian3.panggilkembali',$d->id) }}" class="btn btn-info btn-sm btn-flat"><i class="fa fa-microphone"></i></a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#daftarantrian').load("{{ route('antrian3.daftarpanggil') }}");
  ...
  function searchPasien(antrian_id){
    ...
    table = $('#tablePasien').DataTable({
      ...
      serverSide  : true,
      ajax: {
          url: '/pasien/search-pasien/'+antrian_id+'/'+3,
          data: function (d) {
            d.no_rm = $('#no_rm_s').val();
