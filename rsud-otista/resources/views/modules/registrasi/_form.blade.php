...
<div class="row">
  <div class="col-md-6">
    <div class="form-group{{ $errors->has('poli_id') ? ' has-error' : '' }}">
      ...
      <div class="col-sm-9">
       <select class="form-control select2" style="width:100%" name="poli_id" id="poli_id" required>
        ...
        {{--{!! Form::select('poli_id', $poli, null,['class' => 'form-control select2', 'style'=>'width:100%', 'placeholder'=>' ']) !!}--}}
    ...
    <div class="form-group">
      ...
      @endphp
      <label for="poliTujuan" class="col-sm-3 control-label">Jam Praktek<br><a style="cursor: pointer" onclick='javascript:wincal=window.open({{$url}}, width=790,height=400,scrollbars=2)'><i>Lihat jam praktek</i></a></label>
      <div class="col-sm-3">
    ...
    {{-- @if (request()->segment(1) == 'regperjanjian') --}}
      ...
      {{--<div class="form-group{{ $errors->has('visum') ? ' has-error' : '' }}">
        {!! Form::label('visum', 'Visum', ['class' => 'col-sm-3 control-label']) !!}
        <div class="col-sm-9">
            {!! Form::text('visum', null, ['class' => 'form-control', 'onkeyup'=>'this.value = this.value.toUpperCase()']) !!}
            <small class="text-danger">{{ $errors->first('visum') }}</small>
        </div>
    </div>--}}
  ...
  <section class="form-add-dokter">
    ...
    <div class="form-group{{ $errors->has('sebabsakit_id') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-9">
            {!! Form::select('sebabsakit_id', $sebabsakit, 3, ['class' => 'chosen-select']) !!}
    ...
    @if (request()->segment(1) == 'regperjanjian')
      <div class="form-group{{ $errors->has('created_at') ? ' has-error' : '' }}">
          ...
          <div class="col-sm-9">
              {!! Form::text('created_at', date('d-m-Y'), ['class' => 'form-control', 'id'=>'regperjanjian', 'required' => 'required']) !!}
    ...
    <div class="btn-group pull-right">
      ...
      {!! Form::submit("Lanjut ", ['class' => 'btn btn-success btn-flat','id'=>'btnSave', 'onclick'=>'return confirm("Anda yakin data yang di input sudah benar?")']) !!}
    </div>
  </div>
</div>
