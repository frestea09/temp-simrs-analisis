...
@section('header')
  <h1 style="font-size: 20pt;color:black;font-weight: bold;">Front Office - Daftar Antrian Loket 4</h1>
@endsection
                            ...
                            <td>
                              ...
                              @if (cek_registrasi($d->id, 4) < 1)
                                ...
                                <div class="btn-group" style="min-width:0px !important">
                                  <a href="{{ route('antrian4.panggilkembali',$d->id) }}" class="btn btn-info btn-sm btn-flat"><i class="fa fa-microphone"></i></a>
...
<script type="text/javascript">
  $(document).ready(function() {
    setInterval(function () {
      $('#daftarantrian').load("{{ route('antrian4.daftarpanggil') }}");
    },5000);
  });
  ...
  function searchPasien(antrian_id){
    ...
    table = $('#tablePasien').DataTable({
      ...
      processing  : true,
      serverSide  : true,
      ajax: '/pasien/search-pasien/'+antrian_id+'/'+4,
      columns: [
          {data: 'nama'},
          {data: 'no_rm'},
          {data: 'no_rm_lama'},
