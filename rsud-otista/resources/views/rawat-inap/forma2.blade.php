  ...
  <div class="col-md-6">
    <div class='form-group'>
      ...
      <div class="col-md-9">
        ...
        <input type="text" name="namaPasien" class="form-control" value="{{ $reg->nama }}" readonly="true" >
      </div>
    </div>
    <div class='form-group'>
      <label for='pasien' class="col-md-3 control-label">No. RM</label>
      <div class="col-md-9">
        <input type="text" name="no_rm" class="form-control" value="{{ $reg->no_rm }}" readonly="true">
      </div>
    </div>
    <div class='form-group'>
