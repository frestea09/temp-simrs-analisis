@extends('master')
@section('header')
  <h1>Penata Jasa Pemulasaran Jenazah <small></small></h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => '/rawat-inap/jenazah', 'class'=>'form-horizontal']) !!}
      <div class="row">
        <div class="col-md-6">
...
function addForm(registrasi_id){
  ...
  $('.modal-title').text('Input Penata Pemulasaran Jenazah')
  $('.select2').select2()
...
function save(){
  ...
  $.post('/rawat-inap/save-ambulance', data, function(resp){
    if(resp.sukses == true){
      ...
      alert('Penata jasa pemulasaran jenazah berhasil diinput.')
    }
  })
}
