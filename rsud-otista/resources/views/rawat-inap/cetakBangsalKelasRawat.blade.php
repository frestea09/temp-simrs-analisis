...
<html lang="en">
    ...
    <body onload="print()">
        <h3 class="text-center">Laporan Bangsal Berdasarkan Cara Bayar (Jaminan) Periode {{ date('d M Y', strtotime($tga)) }} Sampai {{ date('d M Y', strtotime($tgb)) }}</h3>
