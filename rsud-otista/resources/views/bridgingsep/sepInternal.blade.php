@extends('master')
@section('header')
  <h1>SEP Internal<small></small></h1>
@endsection
        ...
        <div class="col-sm-6">
          <form method="POST" class="form-horizontal" id="formKunjungan">
            ...
            <div class="form-group">
              <label for="poli" class="col-sm-3 control-label">Nomor SEP</label>
              <div class="col-sm-9">
            ...
            <table class="table table-hover table-bordered">
              <thead class="bg-primary">
                ...
                <tr>
                  ...
                  <th class="text-center" style="vertical-align: middle;">Tujuan Rujuk</th>
                  <th class="text-center" style="vertical-align: middle;">Poli Asal</th>
                  ...
                  <th class="text-center" style="vertical-align: middle;">Tgl.Rjk.Intrn</th>
                </tr>
              </thead>
              <tbody>
      ...
      .done(function(res) {
        ...
        if (data[0].metaData.code == '200') {
          ...
          $.each(data[1].list, function(index, val) {
            $('tbody').append('<tr> <td>'+(index + 1)+'</td><td>'+val.nmtujuanrujuk+'</td> <td>'+val.nmpoliasal+'</td> <td>'+val.nosep+'</td>  <td class="text-center">'+val.nosurat+'</td> <td>'+val.nmdokter+'</td> <td>'+val.tglrujukinternal+'</td></tr>')
          });
        }
      });
    }
