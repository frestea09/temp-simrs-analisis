@extends('master')
@section('header')
  <h1>Retur Obat Penjualan Bebas</h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => '/retur/bebas', 'class'=>'form-horizontal']) !!}
        <div class="row">
          <div class="col-md-6">
            <div class="input-group{{ $errors->has('tga') ? ' has-error' : '' }}">
                ...
                {!! Form::text('tga', null, ['class' => 'form-control datepicker', 'required' => true,'autocomplete'=>'off', 'onchange'=>'this.form.submit()']) !!}
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary btn-flat" onclick="saveRetur()">Simpan</button>
      </div>
    </div>
  </div>
</div>
...
@section('script')
  <script type="text/javascript">
    ...
    table = $('#dataTable').DataTable({
      ...
      processing: true,
      serverSide: true,
      ajax: '/retur/dataReturBebasByRequest',
      columns: [
    ...
    function retur(registrasi_id) {
      ...
      $('.modal-title').text('Retur Penjualan Bebas')
      $('#dataDetail').empty()
      $.ajax({
