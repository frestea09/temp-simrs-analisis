           ...
           <tbody>
               @foreach ($data as $key => $d)
                 @php
                   ...
                   $tgl_entry = App\Penjualan::where('registrasi_id', $d->registrasi_id)->orderBy('created_at', 'desc')->first();
                 @endphp
                   <tr>
                     <td>{{ $no++ }}</td>
                           ...
                           <div class="btn-group">
                              ...
                              @foreach($penjualan as $p)
                                 {{-- @if(resepLunas($p->no_resep) == 'N') --}}
                                    ...
                                    <li><a target="_blank" href="{{url('penjualan/editformpenjualan/Jalan/'.$d->registrasi_id.'/'.$p->id)}}" class="btn btn-sm btn-block">{{ $p->no_resep }}</a></li>
                                 {{-- @else
