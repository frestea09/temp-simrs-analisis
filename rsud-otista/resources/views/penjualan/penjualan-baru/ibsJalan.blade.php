...
@section('content')
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            {!! Form::open(['method' => 'GET', 'url' => 'penjualan/ibs-jalan-baru', 'class' => 'form-horizontal']) !!}
            <div class="row">
                <div class="col-md-4">
                    ...
                    <table class='table-striped table-bordered table-hover table-condensed table'>
                        ...
                        <tbody>
                            @foreach ($data as $key => $r)
                                @php
                                    $penjualan = App\Penjualan::where('registrasi_id', $r->registrasi_id)
                                        ->orderBy('created_at', 'asc')
                                        ->get();
                                    $tgl_entry = App\Penjualan::where('registrasi_id', $r->registrasi_id)
                                ...
                                <tr>
                                    ...
                                    @role('administrator')
                                        <td>
                                            <a onclick="insertTagihan({{ $r->registrasi_id }}, '{{ $r->no_rm }}')"
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right" role="menu" style="">
                                                @forelse ($r->e_resep->whereIn('status',['dikirim','diproses']) as $v)
                                                    <li>
                                                        ...
                                                        @else
                                                            <a href="{{ url('penjualan/form-penjualan-baru-ibs/' . $r->pasien_id . '/' . $r->registrasi_id . '?resep=' . $v->uuid) }}"
                                    ...
                                    <td>
                                        <a href="{{ url('penjualan/form-penjualan-baru-ibs/' . $r->pasien_id) . '/' . $r->registrasi_id }}"
                                    ...
                                    <td>
                                        <a href="{{ url('ranap-informasi-unit-item-rincian-biaya/' . $r->registrasi_id) }}"class="btn btn-danger btn-sm pull-right"
                                            style="margin-left:20px;" target="_blank"><span class="fa fa-print"></span></a>
                                    </td>
                                    <td>
                                        @if ($penjualan->first())
                                            <div class="btn-group">
                                    ...
                                    <td>
                                        @foreach ($penjualan as $d)
                                            @php
                                                $detail = \App\Penjualandetail::where('penjualan_id', $d->id)
                                                    ->where('is_kronis', 'Y')
                                                    ->first();
                                            @endphp
                                            @if ($detail != null)
                                                <a href="{{ url('farmasi/cetak-fakturkronis/' . $d->id) }}"
                                                    class="btn btn-danger btn-flat btn-sm" target="_blank"> <i
                                    ...
                                    <td>
                                        @if ($penjualan->first())
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right" role="menu" style="">
                                                    @foreach ($penjualan as $p)
                                                        <li><a href="{{ url('farmasi/laporan/etiket/' . $p->id) }}"
                                                                class="btn btn-flat btn-sm"
                                                                target="_blank">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right" role="menu"
                                                        ...
                                                        @foreach ($penjualan as $p)
                                                            ...
                                                            <li><a target="_blank"
                                                                    href="{{ url('penjualan/editformpenjualan/Inap/' . $d->registrasi_id . '/' . $p->id) }}"
