@foreach ($penjualan as $key => $d)
  <div class='table-responsive'>
    <table class='table table-striped table-bordered table-hover table-condensed'>
      ...
      <tbody>
        @php
          $det = App\CopyResepDetail::where('penjualan_id', $d->id)->get();
        @endphp
      ...
      <tfoot>
        ...
        <tr>
          ...
          <th class="text-right" colspan="2">
            <a href="{{ url('copy-resep/cetak-detail-copy-resep/'.$d->penjualan_id) }}" class="btn btn-danger btn-flat btn-sm"><i class="fa fa-file-pdf-o"></i></a>
          </th>
        </tr>
      </tfoot>
    </table>
