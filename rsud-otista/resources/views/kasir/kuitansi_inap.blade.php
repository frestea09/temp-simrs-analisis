    ...
    <table>
      ...
      <tr>
        ...
        <table>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" >
              ...
              <tfoot>
                <tr>
                  <td>Obat Farmasi</td>
                  <td class="text-right" colspan="3"><b>{{ number_format($jml_obat+$uangracik) }}</b></td>
                </tr>
                <tr>
          ...
          <div class="table-responsive">
            <table class="table table-bordered" style="width: 100%">
              ...
              <tfoot>
                <tr>
                  <th colspan="3" class="text-right">Obat Farmasi</th>
        ...
        {{-- <table>
          ...
          {{-- @if ($bayar->bayar <> 1) --}}
            <tr>
              <th colspan="2"><i>"{{ terbilang($tot+$jml_obat+$uangracik) }} Rupiah"</i></th>
            </tr>
          {{-- @endif --}}
