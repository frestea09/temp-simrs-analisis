    ...
    <table>
      ...
      <table>
        ...
        <tr>
          ...
          <td style="font-size:17px">: {{ date('d-m-Y H:i:s', strtotime($bayar->created_at)) }}</td>
        ...
        <table class="table table-bordered" >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><b>Rp. {{ $jml_irj+$uangracik }}</b></td>
            </tr>
          </tbody>
        </table>
      </div>
    @endif
      ...
      @if ($bayar->bayar <> 1)
        <tr>
          ...
          <th colspan="2"><i>"{{ terbilang($jml_irj+$uangracik) }} Rupiah"</i></th>
        </tr>
      @endif
