...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('kasir/rawatjalan') }}" ><img src="{{ asset('menu/fixed/kasir1.png') }}" width="50px" heigth="50px" class="img-responsive" alt=""/>
        </a>
        <h5>Rawat Jalan - Tindakan</h5>
      </div>
      <div class="col-sm-3 col-xs-6 iconModule">
        <a href="{{ route('kasir.eksekutif') }}" ><img src="{{ asset('menu/fixed/kasir1.png') }}" width="50px" heigth="50px" class="img-responsive" alt=""/>
        </a>
        <h5>Rawat Jalan - Eksekutif</h5>
      </div>
      <div class="col-sm-3 col-xs-6 iconModule">
