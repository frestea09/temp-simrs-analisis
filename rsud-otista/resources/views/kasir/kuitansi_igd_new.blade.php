...
<html>
  <head>
    <meta charset="utf-8">
    <title>Cetak Kwitansi Igd</title>
    <style>
      body{
        margin: 5px 10px;
        font-size: 8pt;
      ...
      <td class="text-right">
        <table style="width: 100%;">
          ...
          <tr style="font-size: 20px;"> 
             ...
             <td>: <b>{{ terbilang($jml_igd+$obat+$uangracik+$jml_igd_rad+$jml_igd_lab)}} Rupiah</b></td> 
          </tr>
          <tr style="font-size: 20px;"> 
         ...
         <tr style="font-size: 20px;"> 
          ...
          <td><b>Rp.{{ number_format($jml_igd+$obat+$uangracik+$jml_igd_rad+$jml_igd_lab) }}</b></td> 
       </tr>
        </table>
      </td>
    </tr>
