...
<html>
  ...
  <head>
  <body onload="window.print(); setTimeout( function(){window.close()}, 10000);">
    <table>
      <tr>
      ...
      <tr>
        <td>Uang sebesar </td> <td>: <b># {{ terbilang($kuitansi->dibayar+$uang_racik+$jasa_racik) }} Rupiah #</b></td>
      </tr>
      <tr>
        <td>Untuk</td>
        <td>:
      ...
      <tr>
        <td>Jumlah</td> <td>: Rp. {{ number_format($kuitansi->dibayar+$uang_racik+$jasa_racik) }}  </td>
      </tr>
      <tr>
        <td>Cara Bayar</td>
        <td>:
