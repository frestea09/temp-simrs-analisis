...
<!--   <script src="assets/vendor/jquery/jquery.min.js"></script> -->
  ...
  <script src="{{ asset('style') }}/assets/js/clock.js"></script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd2').load("/antrian-news/datalayarlcd/bawah/1");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd3').load("/antrian-news/datalayarlcd/bawah/2");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd4').load("/antrian-news/datalayarlcd/bawah/3");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd5').load("/antrian-news/datalayarlcd/bawah/4");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#antrian_loket_panggil').load("/antrian-new/terpanggil-new/bawah");
        },9000); //normal 13000
      });
    </script>
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#loket_panggil').load("/antrian-new/terpanggil-loket-new/bawah");
        },9000); //normal 13000
      });
    </script>
</body>
