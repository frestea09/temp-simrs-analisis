...
@section('header')
    <h1>Penilaian Status Lokalis Fisik</h1>
@endsection
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
               ...
               @else --}}
                    <canvas id="canvas" width="740" height="650"
                        style="background-image: url('/images/human2.jpg')"></canvas>
                    {{-- @endif --}}
                </div>
                ...
                <div class="col-md-12" style="margin: 20px 0px;">
                    ...
                    <table style="width: 100%; height: 150px;">
                        <tr>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][1]" class="form-control" id="keterangan1" placeholder="Keterangan 1" style="width: 80%;">
                            </td>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][2]" class="form-control" id="keterangan2" placeholder="Keterangan 2" style="width: 80%;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][3]" class="form-control" id="keterangan3" placeholder="Keterangan 3" style="width: 80%;">
                            </td>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][4]" class="form-control" id="keterangan4" placeholder="Keterangan 4" style="width: 80%;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][5]" class="form-control" id="keterangan5" placeholder="Keterangan 5" style="width: 80%;">
                            </td>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][6]" class="form-control" id="keterangan6" placeholder="Keterangan 6" style="width: 80%;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][7]" class="form-control" id="keterangan7" placeholder="Keterangan 7" style="width: 80%;">
                            </td>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][8]" class="form-control" id="keterangan8" placeholder="Keterangan 8" style="width: 80%;">
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][9]" class="form-control" id="keterangan9" placeholder="Keterangan 9" style="width: 80%;">
                            </td>
                            <td>
                                <input type="{{$unit == "igd" ? "number" : "text"}}" name="fisik[keterangan][10]" class="form-control" id="keterangan10" placeholder="Keterangan 10" style="width: 80%;">
                            </td>
                        </tr>
                    </table>
                </div>
    ...
    @section('script')
        ...
        <script>
            function saveDrawing(event) {
                ...
                $('[name^="fisik[keterangan]"]').each(function (){
                    var indexKeterangan = $(this).attr('name').match(/\[(\d+)\]/)[1];
                    var valueKeterangan = $(this).val();

                    fisikKeterangan.keterangan.push({[indexKeterangan]: valueKeterangan});
                });

                fisikKeterangan = JSON.stringify(fisikKeterangan);
                // console.log(fisikKeterangan);
                ...
                img.onload = function() {
                    ...
                    formData.append('fisikKeterangan', fisikKeterangan);

                    $.ajax({
                        url: "/emr-soap/penilaian/fisik/" + unit + "/" + regId,
                        type: "POST",
                        data: formData,
                        headers: {
                        ...
                        success: function(data) {
                            ...
                            // window.location.href = "/emr-soap/pemeriksaan/fisikCommon/"+unit+"/"+regId+"?poli="+poli+"&dpjp="+dpjp;
