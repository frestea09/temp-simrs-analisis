...
@section('header')
    <h1>Penilaian Status Lokalis 2 Mata</h1>
@endsection
        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div id="canvas_div" style="overflow-x: auto;">
               ...
               @else --}}
                <canvas id="canvas" width="700" height="250" style="background-image: url('/images/mata2.PNG')"></canvas>
               {{-- @endif --}}
              </div>
...
function saveDrawing(event) {
    ...
    img.onload = function() {
        ...
        $.ajax({
            url: "/emr-soap/penilaian/mata2/" + unit + "/" + regId,
            type: "POST",
            data: formData,
            headers: {
