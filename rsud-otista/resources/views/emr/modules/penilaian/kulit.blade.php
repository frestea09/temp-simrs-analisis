...
@section('header')
    <h1>Penilaian Status Lokalis Kulit & Kelamin</h1>
@endsection
        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div id="canvas_div" style="overflow-x: auto;">
               ...
               @else --}}
                <canvas id="canvas" width="740" height="650" style="background-image: url('/images/bgKulit.jpg'); background-repeat: no-repeat;"></canvas>
               {{-- @endif --}}
              </div>
...
function saveDrawing(event) {
    ...
    img.onload = function() {
        ...
        $.ajax({
            url: "/emr-soap/penilaian/kulit/" + unit + "/" + regId,
            type: "POST",
            data: formData,
            headers: {
