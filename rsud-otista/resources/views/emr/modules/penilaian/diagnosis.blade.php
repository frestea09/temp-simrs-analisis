...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/penilaian/diagnosis/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        <div class="col-md-12">
              ...
              <tr>
                {{-- <td style="width:20%;">Alat Bantu</td> --}}
                  <td style="padding: 5px;">
                    <textarea rows="15" name="diagnosis[diagnosis]" style="display:inline-block" placeholder="[masukkan diagnosis]" class="form-control"></textarea></td>
                  </td>
              </tr>
            ...
            <div class="box box-solid box-warning">
              ...
              <div class="box-body table-responsive" style="max-height: 400px">
                ...
                @foreach ($riwayat as $item)
                  <tr>
                    <td> 
                      <b>Keterangan	:</b> {{json_decode($item->diagnosis,true)['diagnosis']}}<br/>
