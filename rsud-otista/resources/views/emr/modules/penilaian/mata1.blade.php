...
@section('header')
    <h1>Penilaian Status Lokalis 1 Mata</h1>
@endsection
        ...
        <div class="box-body">
            ...
            <form class="form-horizontal">
              ...
              <div id="canvas_div" style="overflow-x: auto;">
               ...
               @else --}}
                <canvas id="canvas" width="800" height="1000" style="background-image: url('/images/mata-full2.png')"></canvas>
               {{-- @endif --}}
              </div>
...
function saveDrawing(event) {
    ...
    img.onload = function() {
        ...
        $.ajax({
            url: "/emr-soap/penilaian/mata1/" + unit + "/" + regId,
            type: "POST",
            data: formData,
            headers: {
            ...
            success: function(data) {
                ...
                // window.location.href = "/emr-soap/pemeriksaan/mata/"+unit+"/"+regId+"?poli="+poli+"&dpjp="+dpjp;
