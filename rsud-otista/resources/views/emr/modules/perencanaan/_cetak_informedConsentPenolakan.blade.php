      ...
      <div class="col-sm-12 text-center">
        ...
        <div style="page-break-before: always;">
          <table class="" style="width: 100%;">
            <tr class="border">
              <td colspan="4" class="bold text-center p-1">PERNYATAAN PENOLAKAN</td>
            </tr>
            {{-- <tr class="border">
            ...
            <table border="0" cellpadding="5" cellspacing="0" width="100%">
              <tr>
                  <td style="text-align: justify; padding: 5px;">1. Yang bertandatangan dibawah ini saya <b>MENYATAKAN MENOLAK</b> untuk dilaksanakan tindakan : <b>{{@$cetak->tindakan}}</b></td>
              </tr>
              <tr>
              ...
              <tr>
                  <td style="text-align: justify; padding: 5px;">2. Bila pasien berusia dibawah 21 tahun/tidak dapat menerima informasi dan tidak dapat <b>MEMBERI PENOLAKAN</b> tindakan kedokteran karena alasan lain, 
            ...
            <tr>
              <td style="text-indent: 30px">b. Saya menyatakan dapat menerima informasi dan mampu membuat keputusan untuk <b>MEMBERIKAN 
                PENOLAKAN</b> dilaksanakannya tindakan terhadap :</td>
            </tr>
          <tr>
