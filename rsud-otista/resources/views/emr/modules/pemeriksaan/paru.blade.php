...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/paru/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
            ...
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box"
              ...
              <tr>
                  <td style="padding: 5px;">
                    <textarea rows="3" required name="fisik[anamnesa]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan Anamnesa]" class="form-control" >{{ @$assesment['anamnesa'] ?? @$assesment['keluhan_utama'] }}</textarea>
              ...
              <h5>
                <b>4. STATUS LOKALIS</b>
                  ...
                  @elseif(@$reg->poli_id == '41')
                    <a href="{{url('/emr-soap/penilaian/paru/'.$unit.'/'.@$reg->id.'?poli='.$poli.'&dpjp='.$dpjp)}}" title="Status Lokalis" class="btn btn-default btn-sm btn-flat" target="_blank"><i class="fa fa-pencil"> </i> Isi Lokalis</a>&nbsp;&nbsp;
                  @else
