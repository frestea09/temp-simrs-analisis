                ...
                <div class="row">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <input class="form-check-input"
                                            name="fisik[kebutuhan_edukasi][tingkat_pendidikan][pilihan]"
                                            {{ @$assesment['kebutuhan_edukasi']['tingkat_pendidikan']['pilihan'] == 'Indonesia' ? 'checked' : '' }}
                                    ...
                                    <div>
                                        <input class="form-check-input"
                                            name="fisik[kebutuhan_edukasi][tingkat_pendidikan][pilihan]"
                                            {{ @$assesment['kebutuhan_edukasi']['tingkat_pendidikan']['pilihan'] == 'Daerah' ? 'checked' : '' }}
                                            type="radio" value="Daerah">
                                        <label class="form-check-label" style="font-weight: 400;">Daerah</label>
                                        <div>
                                            <input type="text" name="fisik[kebutuhan_edukasi][tingkat_pendidikan][pilihan_daerah]" placeholder="Bahasa Daerah" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['kebutuhan_edukasi']['tingkat_pendidikan']['pilihan_daerah']['pilihan_lain']}}">
                                        </div>
                                    </div>
                                    <div>
                                        <input class="form-check-input"
                                            name="fisik[kebutuhan_edukasi][tingkat_pendidikan][pilihan]"
                                            {{ @$assesment['kebutuhan_edukasi']['tingkat_pendidikan']['pilihan'] == 'Asing' ? 'checked' : '' }}
                                            type="radio" value="Asing">
                                        <label class="form-check-label" style="font-weight: 400;">Asing</label>
                                        <div>
                                            <input type="text" name="fisik[kebutuhan_edukasi][tingkat_pendidikan][pilihan_asing]" placeholder="Bahasa Asing" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['kebutuhan_edukasi']['tingkat_pendidikan']['pilihan_asing']['pilihan_lain']}}">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[perencanaan_edukasi][dokter_dpjp][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['perencanaan_edukasi']['dokter_dpjp']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[perencanaan_edukasi][perawat][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['perencanaan_edukasi']['perawat']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    Perawat / Bidan
                                </td>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[perencanaan_edukasi][farmasi][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['perencanaan_edukasi']['farmasi']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    Farmasi
                                </td>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[perencanaan_edukasi][nutrisionis][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['perencanaan_edukasi']['nutrisionis']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    Nutrisionis
                                </td>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[perencanaan_edukasi][lain_lain][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['perencanaan_edukasi']['lain_lain']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                    ...
                    <div class="col-md-12">
                        ...
                        <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][dokter_dpjp][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['dokter_dpjp']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][perawat][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['perawat']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][farmasi][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['farmasi']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                                    <b>Farmasi</b>
                                    <div>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][diet_dan_nutrisi][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['diet_dan_nutrisi']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][rehab_medik][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['rehab_medik']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][alat_medis][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['alat_medis']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][rohaniawan][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['rohaniawan']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                                    <b>Rohaniawan</b>
                                    <div>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][manajemen_nyeri][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['manajemen_nyeri']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
                                    <b>Manajemen Nyeri</b>
                                    <div>
                            ...
                            <tr style="border: 1px solid black;">
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;" class="text-center">
                                    <input type="datetime-local" name="fisik[pelaksanaan_edukasi][informasi_bagi_pasien][tanggal_waktu]" placeholder="Lainnya" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['pelaksanaan_edukasi']['informasi_bagi_pasien']['tanggal_waktu'] ?? date('Y-m-d\TH:i')}}">
                                </td>
                                <td style="border: 1px solid black; width: 10%; vertical-align: middle;">
