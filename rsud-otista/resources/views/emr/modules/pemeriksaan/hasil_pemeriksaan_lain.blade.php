...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr/upload-hasil/lain/'.$unit.'/'.$reg->id) }}" class="form-horizontal" enctype="multipart/form-data">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <br>
          <h4 class="text-center"><b>Upload Hasil Lainnya</b></h4>
          <div class="col-md-12">
            <div class="col-md-6">
                ...
                <div class="form-group{{ $errors->has('file') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        <input type="file" name="file" class="form-control" accept="application/pdf,image/jpeg,image/png,image/jpg" required>
                        <small>*File maks 2 MB dan Format PDF,jpg,jpeg,png</small>
            ...
            <div class="col-md-6">
                <div class="form-group{{ $errors->has('no_hasil') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-8">
                        {!! Form::text('no_hasil', '-',['class' => 'form-control']) !!}
    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">Hasil Pemeriksaan Lainnya</h3>
