...
@if (@$route != 'ibs')
  @if (@$reg->poli_id == '20')
  <button type="button" id="historiAskep" data-pasienID="{{ $reg->pasien_id }}"
    class="btn btn-md btn-info">
    <i class="fa fa-th-list"></i> Fisioterapi Sebelumnya
  </button>
  @else
  <button type="button" id="historiAskep" data-pasienID="{{ $reg->pasien_id }}"
    class="btn btn-md btn-info">
    <i class="fa fa-th-list"></i> Asuhan Keperawatan Sebelumnya
  </button>
  @endif
@endif

{{-- Modal Histori Askep --}}
<div class="modal fade" id="showHistoriAskep" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
  <div class="modal-dialog modal-lg">
      <div class="modal-content">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="">Asuhan Keperawatan Sebelumnya</h4>
          </div>
          <div class="modal-body">
              <div id="dataHistoriAskep">
...
<table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
  <tr>
    <td style="padding:5px;">
      <select class="form-control select2-diagnosis" name="diagnosa[]" id="select2-diagnosis" style="width: 100%;" onchange="getAskep()">
...
<table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
  <tr>
    <td style="padding:5px;">
      <input type="text" class="form-control" name="evaluasi"   style="width: 100%;"/>
    </td>
  </tr>
</table>
...
<script>
    ...
    function getAskep() {
        let diagnosis = [];
        $('select[name="diagnosa[]"]:not([disabled]').each(function (i) {
          if ($(this).val() != '') {
