...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_kulit/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis Kulit & Kelamin</b></h4>
          <br>
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                <tr>
                  <td style="width: 50%; font-weight: bold;">Status Lokalis</td>
                  <td>
                    <a href="{{url('/emr-soap/penilaian/kulit/'.$unit.'/'.@$reg->id.'?poli='.$poli.'&dpjp='.$dpjp)}}" title="Status Lokalis" class="btn btn-default btn-sm btn-flat" target="_blank"><i class="fa fa-pencil"></i> Isi Lokalis</a>&nbsp;&nbsp;
                ...
                <tr>
                  <td style="width: 50%; font-weight: bold;">A. Kepala</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Warna kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][warna_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['warna_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Tekstur kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][tekstur_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['tekstur_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Kelainan / lesi kulit</td>
                  <td style="padding: 5px;">
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][kepala][kelainan]"
                            {{ @$assesment['status_lokalis']['kepala']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                            type="radio" value="Bentuk lesi">
                        <label class="form-check-label">Bentuk lesi</label>
                        <input type="text" name="fisik[status_lokalis][kepala][kelainan_detail]" placeholder="Bentuk lesi" class="form-control" value="{{@$assesment['status_lokalis']['kepala']['kelainan_detail']}}">
                    </div>
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][kepala][kelainan]"
                            {{ @$assesment['status_lokalis']['kepala']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                            type="radio" value="Distribusi dan Kontribusi">
                        <label class="form-check-label">Distribusi dan kontribusi</label>
                        <input type="text" name="fisik[status_lokalis][kepala][kelainan_detail]" placeholder="Distribusi dan kontribusi" class="form-control" value="{{@$assesment['status_lokalis']['kepala']['kelainan_detail']}}">
                    </div>
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Tekstur dan Konsistensi</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][tekstur_dan_konsistensi]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['tekstur_dan_konsistensi'] }}">
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][suhu]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['suhu'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Turgor kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][turgor_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['turgor_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][ada_hyponostesia]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['ada_hyponostesia'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya nyeri</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kepala][ada_nyeri]" type="text" value="{{ @$assesment['status_lokalis']['kepala']['ada_nyeri'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">B. Leher</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Warna kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][warna_kulit]" type="text" value="{{ @$assesment['status_lokalis']['leher']['warna_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Tekstur kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][tekstur_kulit]" type="text" value="{{ @$assesment['status_lokalis']['leher']['tekstur_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Kelainan / lesi kulit</td>
                  <td style="padding: 5px;">
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][leher][kelainan]"
                            {{ @$assesment['status_lokalis']['leher']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                            type="radio" value="Bentuk lesi">
                        <label class="form-check-label">Bentuk lesi</label>
                        <input type="text" name="fisik[status_lokalis][leher][kelainan_detail]" placeholder="Bentuk lesi" class="form-control" value="{{@$assesment['status_lokalis']['leher']['kelainan_detail']}}">
                    </div>
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][leher][kelainan]"
                            {{ @$assesment['status_lokalis']['leher']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                            type="radio" value="Distribusi dan Kontribusi">
                        <label class="form-check-label">Distribusi dan kontribusi</label>
                        <input type="text" name="fisik[status_lokalis][leher][kelainan_detail]" placeholder="Distribusi dan kontribusi" class="form-control" value="{{@$assesment['status_lokalis']['leher']['kelainan_detail']}}">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][tekstur_dan_konsistensi]" type="text" value="{{ @$assesment['status_lokalis']['leher']['tekstur_dan_konsistensi'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Suhu</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][suhu]" type="text" value="{{ @$assesment['status_lokalis']['leher']['suhu'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Turgor kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][turgor_kulit]" type="text" value="{{ @$assesment['status_lokalis']['leher']['turgor_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][ada_hyponostesia]" type="text" value="{{ @$assesment['status_lokalis']['leher']['ada_hyponostesia'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya nyeri</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][leher][ada_nyeri]" type="text" value="{{ @$assesment['status_lokalis']['leher']['ada_nyeri'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">C. Dada</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Warna kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][warna_kulit]" type="text" value="{{ @$assesment['status_lokalis']['dada']['warna_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Tekstur kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][tekstur_kulit]" type="text" value="{{ @$assesment['status_lokalis']['dada']['tekstur_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Kelainan / lesi kulit</td>
                  <td style="padding: 5px;">
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][dada][kelainan]"
                            {{ @$assesment['status_lokalis']['dada']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                            type="radio" value="Bentuk lesi">
                        <label class="form-check-label">Bentuk lesi</label>
                        <input type="text" name="fisik[status_lokalis][dada][kelainan_detail]" placeholder="Bentuk lesi" class="form-control" value="{{@$assesment['status_lokalis']['dada']['kelainan_detail']}}">
                    </div>
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][dada][kelainan]"
                            {{ @$assesment['status_lokalis']['dada']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                            type="radio" value="Distribusi dan Kontribusi">
                        <label class="form-check-label">Distribusi dan kontribusi</label>
                        <input type="text" name="fisik[status_lokalis][dada][kelainan_detail]" placeholder="Distribusi dan kontribusi" class="form-control" value="{{@$assesment['status_lokalis']['dada']['kelainan_detail']}}">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][tekstur_dan_konsistensi]" type="text" value="{{ @$assesment['status_lokalis']['dada']['tekstur_dan_konsistensi'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Suhu</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][suhu]" type="text" value="{{ @$assesment['status_lokalis']['dada']['suhu'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Turgor kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][turgor_kulit]" type="text" value="{{ @$assesment['status_lokalis']['dada']['turgor_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][ada_hyponostesia]" type="text" value="{{ @$assesment['status_lokalis']['dada']['ada_hyponostesia'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya nyeri</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][dada][ada_nyeri]" type="text" value="{{ @$assesment['status_lokalis']['dada']['ada_nyeri'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">D. Kaki</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Warna kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][warna_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['warna_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Tekstur kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][tekstur_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['tekstur_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Kelainan / lesi kulit</td>
                  <td style="padding: 5px;">
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][kaki][kelainan]"
                            {{ @$assesment['status_lokalis']['kaki']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                            type="radio" value="Bentuk lesi">
                        <label class="form-check-label">Bentuk lesi</label>
                        <input type="text" name="fisik[status_lokalis][kaki][kelainan_detail]" placeholder="Bentuk lesi" class="form-control" value="{{@$assesment['status_lokalis']['kaki']['kelainan_detail']}}">
                    </div>
                    <div>
                        <input class="form-check-input"
                            name="fisik[status_lokalis][kaki][kelainan]"
                            {{ @$assesment['status_lokalis']['kaki']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                            type="radio" value="Distribusi dan Kontribusi">
                        <label class="form-check-label">Distribusi dan kontribusi</label>
                        <input type="text" name="fisik[status_lokalis][kaki][kelainan_detail]" placeholder="Distribusi dan kontribusi" class="form-control" value="{{@$assesment['status_lokalis']['kaki']['kelainan_detail']}}">
                    </div>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][tekstur_dan_konsistensi]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['tekstur_dan_konsistensi'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Suhu</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][suhu]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['suhu'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Turgor kulit</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][turgor_kulit]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['turgor_kulit'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][ada_hyponostesia]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['ada_hyponostesia'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Adanya nyeri</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_lokalis][kaki][ada_nyeri]" type="text" value="{{ @$assesment['status_lokalis']['kaki']['ada_nyeri'] }}">
                  </td>
                </tr>
                <tr>
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_kulit/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          </a>
