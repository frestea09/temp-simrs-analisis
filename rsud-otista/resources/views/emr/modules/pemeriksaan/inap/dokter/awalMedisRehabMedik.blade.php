...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_rehab_medik/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis Rehab Medik</b></h4>
          <br>
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                <tr>
                  <td colspan="2" style="font-weight: bold;">Status Fungsional</td>
                </tr>
                <tr>
                  <td>Aktifitas dan Mobilisasi</td>
                  <td>
                    <label for="aktifitas_1">
                      <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_1" value="Mandiri" {{ @$assesment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Mandiri' ? 'checked' : '' }}>
                      Mandiri
                    </label>
                    <label for="aktifitas_2">
                      <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_2" value="Perlu Bantuan" {{ @$assesment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Perlu Bantuan' ? 'checked' : '' }}>
                      Perlu Bantuan
                    </label>
                    <label for="aktifitas_3">
                      <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_3" value="Alat Bantu Jalan" {{ @$assesment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Alat Bantu Jalan' ? 'checked' : '' }}>
                      Alat Bantu Jalan
                    </label>
                    <br>
                    <input type="text" class="form-control" name="fisik[statusFungsional][aktifitasMobilisasi][sebutkan]" placeholder="Sebutkan" value="{{ @$assesment['statusFungsional']['aktifitasMobilisasi']['sebutkan'] }}">
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td>Pemeriksaan SSP (NI - XIII)</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanSSP]" value="{{ @$assesment['statusLokalis']['pemeriksaanSSP'] }}">
                  </td> 
                </tr>

                <tr>
                  <td colspan="2">Pemeriksaan at Regio (a/r)</td>
                </tr>
                <tr>
                  <td>a/r Head Neck</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][headNeck]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['headNeck'] }}">
                  </td> 
                </tr>
                <tr>
                  <td>a/r Thoraks</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][thoraks]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['thoraks'] }}">
                  </td> 
                </tr>
                <tr>
                  <td>a/r Abdomen</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][abdomen]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['abdomen'] }}">
                  </td> 
                </tr>
                <tr>
                  <td>a/r Back</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][back]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['back'] }}">
                  </td> 
                </tr>

                <tr>
                  <td colspan="2">a/r Anggota Gerak</td>
                </tr>
                <tr>
                  <td>Look (Decomitas, Pola Jalan)</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][anggotaGerak][look]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['anggotaGerak']['look'] }}">
                  </td>
                </tr>
                <tr>
                  <td>Feel (Tanda Radang, Nyeri Tekan, Tonus Turgor)</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][anggotaGerak][feel]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['anggotaGerak']['feel'] }}">
                  </td>
                </tr>

                <tr>
                  <td colspan="2">Movement (ROM, MMT, Nyeri)</td>
                </tr>
                <tr>
                  <td>Tes Provokasi</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][movement][tesProvokasi]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['movement']['tesProvokasi'] }}">
                  </td>
                </tr>
                <tr>
                  <td>Tes Fungsional</td>
                  <td>
                    <input type="text" class="form-control" name="fisik[statusLokalis][pemeriksaanRegio][movement][tesFungsional]" value="{{ @$assesment['statusLokalis']['pemeriksaanRegio']['movement']['tesFungsional'] }}">
                  </td>
                </tr>

                <tr>
                  <td colspan="2" style="font-weight: bold;">Diagnosa</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Impairment</td>
                  <td>
                    <textarea name="fisik[diagnosa][impairment]" class="form-control" style="resize: vertical;" rows="3">{{ @$assesment['diagnosa']['impairment'] }}</textarea>
                  </td>
                </tr>
                <tr>
                  <td>Disability</td>
                  <td>
                    <textarea name="fisik[diagnosa][disability]" class="form-control" style="resize: vertical;" rows="3">{{ @$assesment['diagnosa']['disability'] }}</textarea>
                  </td>
                </tr>
                <tr>
                  <td>Handicap</td>
                  <td>
                    <textarea name="fisik[diagnosa][handicap]" class="form-control" style="resize: vertical;" rows="3">{{ @$assesment['diagnosa']['handicap'] }}</textarea>
                  </td>
                </tr>
                <tr>
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_rehab_medik/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          </a>
