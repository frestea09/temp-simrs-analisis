            ...
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                ...
                <tr>
                  <td style="padding: 5px;">
                    ...
                    <input type="text" name="fisik[dada_dan_punggung][paru]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['paru']}}">
                  </td>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">Jantung</label><br/>
                    <input type="text" name="fisik[dada_dan_punggung][jantung]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['jantung']}}">
                  </td>
                </tr>
                <tr>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">Perut dan pinggang</label><br/>
                    <input type="text" name="fisik[dada_dan_punggung][perut_dan_pinggang]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['perut_dan_pinggang']}}">
                  </td>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">Anggota gerak</label><br/>
                    <input type="text" name="fisik[dada_dan_punggung][anggota_gerak]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['anggota_gerak']}}">
                  </td>
                </tr>
                <tr>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">Genitalia dan Anus</label><br/>
                    <input type="text" name="fisik[dada_dan_punggung][genitalia_dan_anus]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['genitalia_dan_anus']}}">
                  </td>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">Pemeriksaan neurologi</label><br/>
                    <input type="text" name="fisik[dada_dan_punggung][pemeriksaan_neurologi]" style="display:inline-block; width: 100%;" class="form-control" id="" value="{{@$assesment['dada_dan_punggung']['pemeriksaan_neurologi']}}">
                  </td>
                </tr>
              </table>
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[riwayat pekerjaan]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan Riwayat pekerjaan]" class="form-control" >{{@$assesment['riwayat pekerjaan']}}</textarea>
                  </td>
                </tr>
                <tr>
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_anak/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          </a>
