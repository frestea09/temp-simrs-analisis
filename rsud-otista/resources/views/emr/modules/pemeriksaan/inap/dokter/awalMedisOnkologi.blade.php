...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_onkologi/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis Onkologi</b></h4>
          <br>
            ...
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="padding: 5px;">
                    ...
                    <input type="text" name="fisik[tanda_vital][nadi]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['tanda_vital']['nadi'] ?? @$assesmen_perawat['keadaan_umum']['tanda_vital']['tekanan_darah']}}">
                  </td>
                </tr>
                <tr>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;">RR (x/menit)</label><br/>
                    <input type="text" name="fisik[tanda_vital][RR]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['tanda_vital']['RR'] ?? @$assesmen_perawat['keadaan_umum']['tanda_vital']['tekanan_darah']}}">
                  </td>
                  <td style="padding: 5px;">
                    <label class="form-check-label" style="font-weight: normal;"> Temp (°C)</label><br/>
                    <input type="text" name="fisik[tanda_vital][temp]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['tanda_vital']['temp'] ?? @$assesmen_perawat['keadaan_umum']['tanda_vital']['tekanan_darah']}}">
                  </td>
                </tr>
                <tr>
                  <td style="padding: 5px;">
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[statusGeneralis]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan Status Generalis]" class="form-control" >{{@$assesment['statusGeneralis']}}</textarea>
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  <td colspan="2" style="font-weight: bold;">Prognosa</td>
                </tr>
                <tr>
                  <td>Ad Functionam</td>
                  <td>
                    <label for="adFunctionam_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adFunctionam]" id="adFunctionam_1" value="Ad Bonam" {{ @$assesment['prognosa']['adFunctionam'] == 'Ad Bonam' ? 'checked' : '' }}>
                      Ad Bonam
                    </label>
                    <label for="adFunctionam_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adFunctionam]" id="adFunctionam_2" value="Ad Malam" {{ @$assesment['prognosa']['adFunctionam'] == 'Ad Malam' ? 'checked' : '' }}>
                      Ad Malam
                    </label>
                    <label for="adFunctionam_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adFunctionam]" id="adFunctionam_3" value="Dubia ad Bonam" {{ @$assesment['prognosa']['adFunctionam'] == 'Dubia ad Bonam' ? 'checked' : '' }}>
                      Dubia ad Bonam
                    </label>
                    <label for="adFunctionam_4" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adFunctionam]" id="adFunctionam_4" value="Dubia ad Malam" {{ @$assesment['prognosa']['adFunctionam'] == 'Dubia ad Malam' ? 'checked' : '' }}>
                      Dubia ad Malam
                    </label>
                  </td>
                </tr>
                <tr>
                  <td>Ad Vitam</td>
                  <td>
                    <label for="adVitam_1" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adVitam]" id="adVitam_1" value="Ad Bonam" {{ @$assesment['prognosa']['adVitam'] == 'Ad Bonam' ? 'checked' : '' }}>
                      Ad Bonam
                    </label>
                    <label for="adVitam_2" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adVitam]" id="adVitam_2" value="Ad Malam" {{ @$assesment['prognosa']['adVitam'] == 'Ad Malam' ? 'checked' : '' }}>
                      Ad Malam
                    </label>
                    <label for="adVitam_3" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adVitam]" id="adVitam_3" value="Dubia ad Bonam" {{ @$assesment['prognosa']['adVitam'] == 'Dubia ad Bonam' ? 'checked' : '' }}>
                      Dubia ad Bonam
                    </label>
                    <label for="adVitam_4" style="margin-right: 10px;">
                      <input type="radio" name="fisik[prognosa][adVitam]" id="adVitam_4" value="Dubia ad Malam" {{ @$assesment['prognosa']['adVitam'] == 'Dubia ad Malam' ? 'checked' : '' }}>
                      Dubia ad Malam
                    </label>
                  </td>
                </tr>
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_onkologi/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                          <i class="fa fa-eye"></i>
                          </a>
