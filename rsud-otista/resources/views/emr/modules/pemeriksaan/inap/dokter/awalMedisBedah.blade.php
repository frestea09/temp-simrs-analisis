...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_bedah/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
              <h5><b>Status Generalis</b></h5>
                ...
                <tr>
                  <td style="width: 50%;">Mata</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][kepala][mata]" type="text" value="{{ @$assesment['status_generalis']['kepala']['mata'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Telinga
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][kepala][telinga]" type="text" value="{{ @$assesment['status_generalis']['kepala']['telinga'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Hidung</td>
                  <td style="padding: 5px;">
                        <input type="text" name="fisik[status_generalis][kepala][hidung]" placeholder="Bentuk lesi" class="form-control" value="{{@$assesment['status_generalis']['kepala']['hidung']}}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Gigi</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][kepala][gigi]" type="text" value="{{ @$assesment['status_generalis']['kepala']['gigi'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Mulut</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][kepala][mulut]" type="text" value="{{ @$assesment['status_generalis']['kepala']['mulut'] }}">
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][leher][kgb]" type="text" value="{{ @$assesment['status_generalis']['leher']['kgb'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">C. Thorax</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Paru</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][thorax][paru]" type="text" value="{{ @$assesment['status_generalis']['thorax']['paru'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Jantung</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][thorax][jantung]" type="text" value="{{ @$assesment['status_generalis']['thorax']['jantung'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">D. Abdomen</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Hati</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][abdomen][hati]" type="text" value="{{ @$assesment['status_generalis']['abdomen']['hati'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Limpa</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][abdomen][limpa]" type="text" value="{{ @$assesment['status_generalis']['abdomen']['limpa'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">E. Genitalia</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[status_generalis][genitalia]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan status_generalis]" class="form-control" >{{@$assesment['status_generalis']['genitalia']}}</textarea>
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">F. Ekstremitas</td>
                </tr>
                <tr>
                  <td style="width: 50%;">Atas</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][ekstremitas][atas]" type="text" value="{{ @$assesment['status_generalis']['ekstremitas']['atas'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%;">Bawah</td>
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][ekstremitas][bawah]" type="text" value="{{ @$assesment['status_generalis']['ekstremitas']['bawah'] }}">
                  </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">G. Kulit</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[status_generalis][kulit]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan status_generalis]" class="form-control" >{{@$assesment['status_generalis']['kulit']}}</textarea>
                  </td>
                </tr>
                <tr>
                  ...
                  <td style="padding: 5px;">
                        <input class="form-control"
                            name="fisik[status_generalis][kaki][tekstur_kulit]" type="text" value="{{ @$assesment['status_generalis']['kaki']['tekstur_kulit'] }}">
                  </td>
                </tr>
                <tr>
