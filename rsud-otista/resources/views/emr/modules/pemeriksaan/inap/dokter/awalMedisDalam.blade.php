...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_dalam/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis Dalam</b></h4>
          <br>
            ...
            <tbody>
              ...
              @foreach ($riwayats as $riwayat)
                  <tr>
                      ...
                      <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_dalam/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-eye"></i>
                            </a>
