...
<div class="box box-primary">
  ...
  <div class="box-body">
    ...
    <form method="POST" action="{{ url('emr-soap/pemeriksaan/asesmen_awal_medis_pasien_tht/'.$unit.'/'.$reg->id) }}" class="form-horizontal">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <h4 style="text-align: center; padding: 10px"><b>Asesmen Awal Medis THT</b></h4>
          <br>
          ...
          <div class="col-md-6">
            <table style="width: 100%" class="table table-striped table-bordered table-hover table-condensed form-box" style="font-size:12px;">
                <tr>
                  <td colspan="2" style="width: 50%; font-weight: bold;">Status Generalis</td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: bold;">Auricula Dextra – Sinistra</td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Cae tenang</td>
                    <td>
                        <input type="text" placeholder="+" name="fisik[status_generalis][auricula][cae-tenang1]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['cae-tenang1']}}">
                        /
                        <input type="text" placeholder="+" name="fisik[status_generalis][auricula][cae-tenang2]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['cae-tenang2']}}"> 
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Sekret</td>
                    <td>
                        <input type="text" placeholder="Sekret" name="fisik[status_generalis][auricula][sekret]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['sekret']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Membran Tympani</td>
                    <td>
                        <input type="text" placeholder="Membran Tympani" name="fisik[status_generalis][auricula][membran_tympani]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['membran_tympani']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Intak</td>
                    <td>
                        <input type="text" placeholder="Intak" name="fisik[status_generalis][auricula][intak]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['intak']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Reflek Cahaya</td>
                    <td>
                        <input type="text" placeholder="Reflek Cahaya" name="fisik[status_generalis][auricula][reflek_cahaya]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['auricula']['reflek_cahaya']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: bold;">Cavum Nasi (CN)</td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Secret</td>
                    <td>
                        <input type="text" placeholder="Secret" name="fisik[status_generalis][cavum_nasi][secret]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['cavum_nasi']['secret']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Concha Inferior</td>
                    <td>
                        <input type="text" placeholder="Concha Inferior" name="fisik[status_generalis][cavum_nasi][concha_inferior]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['cavum_nasi']['concha_inferior']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Eutrofil</td>
                    <td>
                        <input type="text" placeholder="Eutrofil" name="fisik[status_generalis][cavum_nasi][eutrofil]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['cavum_nasi']['eutrofil']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: bold;">Nasofaring / Orofaring</td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Tonsil</td>
                    <td>
                        <input type="text" placeholder="Tonsil" name="fisik[status_generalis][nasofaring_orofaring][tonsil]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['nasofaring_orofaring']['tonsil']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Detritus</td>
                    <td>
                        <input type="text" placeholder="Detritus" name="fisik[status_generalis][nasofaring_orofaring][detritus]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['nasofaring_orofaring']['detritus']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Faring</td>
                    <td>
                        <input type="text" placeholder="Faring" name="fisik[status_generalis][nasofaring_orofaring][faring]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['nasofaring_orofaring']['faring']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: bold;">Maksilofasial</td>
                    <td>
                        <div>
                            <input class="form-check-input"
                                name="fisik[status_generalis][maksilofasial_simetris]"
                                {{ @$assesment['status_generalis']['maksilofasial_simetris'] == 'Simetris' ? 'checked' : '' }}
                                type="radio" value="Simetris">
                            <label class="form-check-label">Simetris</label>
                        </div>
                        <div>
                            <input class="form-check-input"
                                name="fisik[status_generalis][maksilofasial_simetris]"
                                {{ @$assesment['status_generalis']['maksilofasial_simetris'] == 'Tidak Simetris' ? 'checked' : '' }}
                                type="radio" value="Tidak Simetris">
                            <label class="form-check-label">Tidak Simetris</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Parese Nerveus Cranialis</td>
                    <td>
                        <input type="text" placeholder="-" name="fisik[status_generalis][maksilofasial][parese_nerveus1]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['status_generalis']['maksilofasial']['parese_nerveus1']}}">
                        /
                        <input type="text" placeholder="+" name="fisik[status_generalis][maksilofasial][parese_nerveus2]" style="display:inline-block; width: 100px;" class="form-control" id="" value="{{@$assesment['status_generalis']['maksilofasial']['parese_nerveus2']}}"> 
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width: 50%;">KGB</td>
                    <td>
                        <div>
                            <input class="form-check-input"
                                name="fisik[status_generalis][leher][kgb]"
                                {{ @$assesment['status_generalis']['leher']['kgb'] == 'Teraba' ? 'checked' : '' }}
                                type="radio" value="Teraba">
                            <label class="form-check-label">Teraba</label>
                        </div>
                        <div>
                            <input class="form-check-input"
                                name="fisik[status_generalis][leher][kgb]"
                                {{ @$assesment['status_generalis']['leher']['kgb'] == 'Tidak Teraba' ? 'checked' : '' }}
                                type="radio" value="Tidak Teraba">
                            <label class="form-check-label">Tidak Teraba</label>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Membesar</td>
                    <td>
                        <input type="text" placeholder="Membesar" name="fisik[status_generalis][leher][membesar]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['leher']['membesar']}}"> 
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Genitalia</td>
                    <td>
                        <input type="text" placeholder="Genitalia" name="fisik[status_generalis][genitalia]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['genitalia']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Ekstremitas</td>
                    <td>
                        <input type="text" placeholder="Ekstremitas" name="fisik[status_generalis][ekstremitas]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['ekstremitas']}}">
                    </td>
                </tr>
                <tr>
                    <td style="width: 50%; font-weight: 500;">Kulit</td>
                    <td>
                        <input type="text" placeholder="Kulit" name="fisik[status_generalis][kulit]" style="display:inline-block;" class="form-control" id="" value="{{@$assesment['status_generalis']['kulit']}}">
                    </td>
                </tr>
                <tr>
                  <td style="width: 50%; font-weight: bold;">Status Lokalis</td>
                  <td style="padding: 5px;">
                    <textarea rows="3" name="fisik[status_lokalis]" style="display:inline-block; resize: vertical;" placeholder="[Masukkan Status Lokalis]" class="form-control" >{{@$assesment['status_lokalis']}}</textarea>
                  </td>
                </tr>
                <tr>
              ...
              <tbody>
                ...
                @foreach ($riwayats as $riwayat)
                    <tr>
                        ...
                        <td style="text-align: center; {{ $riwayat->id == request()->asessment_id ? ' background-color:rgb(172, 247, 162)' : ''}}">
                        <a href="{{ url("emr-soap/pemeriksaan/asesmen_awal_medis_pasien_tht/".$unit."/".@$riwayat->registrasi_id."?asessment_id=".@$riwayat->id) }}" class="btn btn-info btn-sm">
                            <i class="fa fa-eye"></i>
                        </a>
