@extends('master')
@section('header')
  <h1>Input Hasil Lab Pasien Langsung</h1>
@endsection
...
<div class="box box-primary">
  ...
  <div class="box-body">
      {{-- @if (! session('pj')) --}}
    {!! Form::open(['method' => 'POST', 'url' => 'pemeriksaanlabCommonCommon/store-pasien-langsung', 'class' => 'form-horizontal']) !!}
      <div class="col-md-6">
      ...
      @if(count($hasillabs) > 0)
        ...
        @foreach ($rincian as $item)
          <tr>
            ...
            <td>
            <a href="{{ url('pemeriksaanlabCommon/hapus/'.$item->id) }}" class="btn btn-danger btn-sm btn-flat pull-right">Hapus</a>
            </td>
          </tr>
        @endforeach
        @endforeach
