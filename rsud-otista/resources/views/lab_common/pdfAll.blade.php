  ...
  <body>
    ...
    <table border=0 style="width:100%">
      ...
      {{--<td colspan="4" scope="row" style="width:170px;font-size: 10px;"></td>--}}
          ...
          <td style="width:140px;text-align:center;"></td>
          <td style="width:80px;text-align:center;"></td>
          {{-- <td style="width:80px;text-align:center;"><br><br><br><br><br>({{ Auth::user()->name}})</td> --}}
          <td style="width:80px;text-align:center;"><br><br><br><br><br>({{ baca_dokter($hasillab->penanggungjawab)}})</td>
      </tr>
      <tr>
