...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
		<form action="{{ url('laboratoriumCommon/simpan-transaksi-langsung') }}" method="POST" class="form-horizontal">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="text" name="nik" required="" class="form-control" value="">
						</div>
					</div>
		...
		<hr>
			{!! Form::open(['method' => 'POST', 'url' => 'laboratoriumCommon/entry-tindakan-langsung', 'class'=>'form-hosizontal']) !!}
			<div class="row">
				<div class="col-md-6">
					...
					<tbody>
						@foreach ($data as $d)
							<tr>
								...
								<td>
									<a href="{{ url('/laboratoriumCommon/entry-transaksi-langsung/'.$d->registrasi_id) }}" class="btn btn-flat btn-sm btn-primary"><i class="fa fa-edit"></i></a>
								</td>
								<td>
									<a href="{{ url('laboratoriumCommon/tindakan-cetak/'.$d->registrasi_id) }}" target="_blank" class="btn btn-flat btn-sm btn-warning"><i class="fa fa-print"></i></a>
								</td>
								<td>
