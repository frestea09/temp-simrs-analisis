      ...
      <div class="col-md-12">
            <div class="blockloket">
                <div class="loketheader text-center" style="font-size: 25pt !important;">
                    ...
                    <td>Dashboard E-Resep Pasien Umum {{date('d-m-Y')}} {{ucfirst($unit)}}</td>
                </div>
                <div class="text-center" style="z-index: 99">
                    <div style="background-color: red; padding: 1.5rem; color: white;">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $('.loading').css("display","none");
          $('#layarlcdumum').load("{{ route('farmasi.data_lcd_eresep_pasien_umum', $unit) }}");
