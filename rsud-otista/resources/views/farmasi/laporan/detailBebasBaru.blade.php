...
.table-hover>tbody>tr:hover {
  ...
  @endforeach
    ...
    <tr>
      <th style="text-align: right" colspan="3">Diskon</th>
      <th style="text-align: right">{{ !empty(@$folio->diskon) ? number_format(@$folio->diskon) : 0 }} %</th>
    </tr>
    <tr>
      <th>
       ...
       <th style="text-align: right">{{ number_format(($total- ($total * (@$folio->diskon/100)))+ (!empty($folio->jasa_racik) ? $folio->jasa_racik : 0)+$total_uang_racik)}}</th>
      </th>
    </tr>
     <th>
      ...
      <META HTTP-EQUIV="REFRESH" CONTENT="1; URL={{ url('penjualanbebas-baru') }}">
