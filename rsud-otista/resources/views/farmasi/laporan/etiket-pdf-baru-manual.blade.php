  ...
  <div class="ticket">
        ...
        <tr>
          ...
          <td style="text-align: left">
            <div class="text-center">
              <span style="font-size:8px;font-family:Arial"><b>INSTALASI FARMASI</b></span>
            </div>
            {{-- <b style="font-size:10px;font-family:Arial">BLUD UPT RSUD Kab. Kep. Meranti</b><br>
            <b style="font-size:10px;font-family:Arial">{{ configrs()->alamat }} Telp. {{ configrs()->tlp }}</b>
            <b style="font-size:10px;font-family:Arial">INSTALASI FARMASI</b> --}}
      ...
      <table style="text-align: left;">
        <tbody>
          ...
          <tr>
            <th style="font-size:10px;font-family:Arial"></th> <td style="font-size:10px;font-family:Arial;padding-left:130px"><b>Tgl : {{ date('d-m-Y', strtotime($penjualan->created_at)) }}</b></td>
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"> </td>
          </tr>
          <tr>
            <th style="font-size:10px;font-family:Arial">No.RM </th> <td style="font-size:10px;font-family:Arial"><b> : {{ \Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->no_rm }}</b></td>
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"> </td>
          </tr>
          <tr>
            <th style="font-size:10px;font-family:Arial">Nama </th> <td style="font-size:10px;font-family:Arial"><b> : {{ strtoupper(\Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->nama) }} / {{ strtoupper(\Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->kelamin == 'L') ? 'L' : 'P' }} / {{ hitung_umur(\Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->tgllahir,'Y') }}</b></td>
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"> </td>
          </tr>
          <tr>
            <th style="font-size:10px;font-family:Arial">Tgl.Lahir </th> <td style="font-size:10px;font-family:Arial"><b> : {{ tgl_indo(\Modules\Registrasi\Entities\Registrasi::find($penjualan->registrasi_id)->pasien->tgllahir) }}</b></td>
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"> </td>
          </tr>
          <tr>
            <th style="font-size:10px;"> </th> <td style="font-size:10px;font-family:Arial"><b>{{ substr(strtoupper($d->masterobat->nama),0,20) }} / {{ strtoupper($d->informasi1) }}  </b></td>
            @if( \App\LogistikBatch::where('id', $d->logistik_batch_id)->first() )
              <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"></b> {{ strtoupper($d->jumlahTotal) }}.0 </b></td>
            @else
              <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial">  </td>
            @endif
          </tr>
          <tr>
            ...
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"><b>{{ strtoupper($d->etiket) }}</b></td> 
            @else
            <th style="font-size:10px;"></th> <td style="font-size:9px;">-</td> 
            @endif
          </tr>
          <tr>
            @if (\App\masterCaraMinum::where('id',$d->cara_minum_id)->first())
            <th style="font-size:10px;"></th> <td style="font-size:10px;font-family:Arial"><b>{{ strtoupper(\App\masterCaraMinum::where('id',$d->cara_minum_id)->first()->nama) }}</b></td> 
            @else
            <th style="font-size:10px;"></th> <td style="font-size:9px;">-</td> 
            @endif
          </tr>
