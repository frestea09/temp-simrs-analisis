...
@section('content')
    <div class="box box-primary">
        ...
        <h4>Laporan Pemakaian Obat Psikotropika</h4>
        </div>
        <div class="box-body">
            <form action="{{ url('farmasi/laporan/pemakaian-obat-harian-psikotropika') }}" class="form-horizontal" role="form" method="POST">
                {{ csrf_field() }}
                <div class="row">
                <div class="col-sm-6">
...
<div class="box box-success">
    ...
    <div class="box-body">
        <div class="table-responsive">
            <br>
            <h3 class="box-title">Detail List Pemakaian Obat Psikotropika</h3>
