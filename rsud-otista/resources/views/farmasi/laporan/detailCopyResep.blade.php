  ...
  <body>
    ...
    <table style="width: 100%;font-size:12px;">
      ...
      <tr>
        ...
        <td>Tanggal</td>
        <td>:&nbsp;&nbsp;{{ date('d-m-Y' ,strtotime($penjualan->created_at)) }}
        </td>
      </tr>
      <tr>
          ...
          <td style="width:50%;vertical-align:top">
            <table>
              ...
              <tr>
                <td>
                  {{-- <b>R/</b>  --}}
                  {{--<span style="padding-left: 20px">--}}- {{@$d->masterobat->nama}}[{{$d->jumlah}}]<br/>
                  {{@$d->etiket ?? @$d->cara_minum}},{{@$d->informasi1}},{{@$d->informasi2}}<br/>
                </td>
              </tr>
              @endforeach
              <tr>
              ...
              <tr>
                <td>
                  <b>R/</b> 
                  <span style="padding-left: 20px">{{@$d->masterobat->nama}} [{{$d->jumlah}}]</span><br/>
    ...
    <table style="width: 100%" border="0" cellspacing="0">
      <tr>
            ...
            <tr >
              <td class="text-center">
                <p>Nama &amp; Tanda Tangan <br/> Apotik<br/><br/><br>
                  @php
                    $pegawai = \Modules\Pegawai\Entities\Pegawai::where('user_id', $penjualan->user_id)->first();
        ...
        <td style="vertical-align: top">
          <table border="1" style="width: 100%;font-size:11px;"  cellspacing="0">
            <tr >
              <td>Validasi</td>
              <td>Nama</td>
              <td>Paraf</td>
