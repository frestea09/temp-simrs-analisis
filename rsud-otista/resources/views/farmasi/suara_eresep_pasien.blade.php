...
<html>
  <head>
    <meta charset="utf-8">
    <title>Suara Antrian Eresep</title>
    <!-- Bootstrap 3.3.7 -->
      ...
      <div class="col-md-12">
            <div class="blockloket">
                <div class="loketheader text-center" style="font-size: 25pt !important;">
                    ...
                    <td>Suara Antrian E-Resep Pasien {{date('d-m-Y')}} {{ucfirst($unit)}}</td>
                </div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $('.loading').css("display","none");
          $('#layarlcd').load("{{ route('farmasi.data_suara_eresep_pasien', $unit) }}");
        setInterval(function () {
          $('.loading').css("display","none");
          $('#layarlcd').load("{{ route('farmasi.data_suara_eresep_pasien', $unit) }}");
        },13000); // 13 (detik) agar suara tidak terpotong
      });
    </script> 
