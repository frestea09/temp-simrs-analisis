            ...
            <div class="row">
              <div class="col-md-7">
                <div class="form-group{{ $errors->has('dokter_id') ? ' has-error' : '' }}">
                    {!! Form::label('dokter_radiologi', 'Dokter Radiologi', ['class' => 'col-sm-3 control-label']) !!}
                    <div class="col-sm-9">
                        ...
                        <small class="text-danger">{{ $errors->first('dokter_radiologi') }}</small>
                    </div>
                </div>
                <div class="form-group{{ $errors->has('pelaksana') ? ' has-error' : '' }}">
                    {!! Form::label('radiografer', 'Pelaksana ', ['class' => 'col-sm-3 control-label']) !!}
                    <div class="col-sm-9">
              ...
              <div class="col-md-5">
                ...
                <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                        ...
                        <a href="{{ url('radiologi/transaksi-langsung') }}" class="btn btn-primary btn-flat">SELESAI</a>
                    </div>
                </div>
              </div>
            </div>
