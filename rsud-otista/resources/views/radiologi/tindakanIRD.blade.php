...
@section('header')
  <h1>Billing System Radiologi - Rawat Darurat</h1>
@endsection
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/folder.png') }}">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        {!! Form::open(['method' => 'POST', 'url' => 'radiologi/tindakan-ird', 'class'=>'form-hosizontal']) !!}
        <div class="row">
          <div class="col-md-4">
          ...
          {{-- <div class="col-md-4 mt-3">
            <div class="input-group">
              <span class="input-group-btn">
                <button class="btn btn-default" type="button">Pilih Type Radiologi</button>
              </span>
              <select name="radiologi" id="" class="form-control" onchange="this.form.submit()">
          ...
          <table class='table table-striped table-bordered table-hover table-condensed' id='data'>
            ...
            <tbody>
              @foreach ($registrasi as $key => $d)
                  ...
                  <td>{{ !empty($d->poli->id) ? @$d->poli->nama : NULL }}</td>
                  ...
                  <td class="text-center">
                    <button type="button" id="exam"  data-reg="{{ $d->id }}" class="btn btn-warning btn-sm btn-flat pull-right">
                      <i class="fa fa-th-list"></i> Gambar RIS
                    </button>
                  </td>
                  <td class="text-center">
                  ...
                  <td class="text-center">
                    <a href="{{ url('radiologi/insert-kunjungan/'. $d->id.'/'.$d->pasien_id) }}" onclick="return confirm('YAKIN AKAN DIMASUKKAN TINDAKAN? KARENA AKAN MENAMBAH KUNJUNGAN RADIOLOGI')" class="btn btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                  </td>
                  {{-- <td class="text-center">
                    <a href="{{ url('radiologi/entry-expertise-igd/'. $d->id.'/'.$d->pasien_id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                  </td> --}}
                  {{-- <td class="text-center">
                    <button type="button" class="btn btn-danger btn-sm btn-flat" onclick="pemeriksaan_tindakan({{ $d->id }})"><i class="fa fa-edit"></i></button>
                  </td> --}}
                  <td class="text-center">
                      @if (Modules\Registrasi\Entities\Folio::where('registrasi_id', $d->id)->where('poli_tipe', 'R')->count() > 0)
                        <a href="{{ url('radiologi/cetakRincianRad/ird/'.$d->id) }}" target="_blank" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-print"></i></a>
                      @endif
                  </td>
                  {{-- cetak ekspertise --}}
                  <td class="text-center">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                      ...
                      {!! Form::text('tglPeriksa', null, ['placeholder'=>'Jika kosong, otomatis tgl hari ini','class' => 'form-control datepicker ', 'required' => 'required']) !!}
                  </td>
                </tr>
            ...
            @endphp
              ...
              <tr>
                ...
                <tr>
                  ...
                  <td colspan="3">
                    {!! Form::text('tanggal_eksp', null, ['placeholder'=>'Jika kosong, otomatis tgl hari ini','class' => 'form-control datepicker ', 'required' => 'required']) !!}
                  </td>
                </tr>
                <tr>
                  <th>Ekspertise</th>
                  <td colspan="3">
                    <textarea name="ekspertise" id="ekspertise" style="height: 500; width: 750;"></textarea>
                  </td>
                </tr>
              </tbody>
            </table>
    ...
    <div class="modal fade" id="showExam" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title" id="">Gambar RIS</h4>
          </div>
          <div class="modal-body">
            <div id="dataExam"></div>
          </div>
