@extends('master')
@section('header')
  <h1>Radiologi - Perawat <small></small></h1>
@endsection
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('radiologi/tindakan-irj') }}" ><img src="{{ asset('menu/fixed/rawatjalan.png') }}"  width="50px" heigth="50px"  class="img-responsive" alt=""/>
        </a>
        <h5>Rawat Jalan</h5>
      </div>
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('radiologi/tindakan-ird') }}" ><img src="{{ asset('menu/fixed/igd.png') }}"  width="50px" heigth="50px"  class="img-responsive" alt=""/>
        </a>
        <h5>Rawat Darurat</h5>
      </div>
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('radiologi/tindakan-irna') }}" ><img src="{{ asset('menu/fixed/rawatinap.png') }}"  width="50px" heigth="50px"  class="img-responsive" alt=""/>
        </a>
        <h5>Rawat Inap</h5>
      </div>
      <div class="col-md-2 col-sm-3 col-xs-6 iconModule">
        <a href="{{ url('radiologi/transaksi-langsung') }}" ><img src="{{ asset('menu/fixed/pasienlangsung.png') }}"  width="50px" heigth="50px"  class="img-responsive" alt=""/>
        </a>
