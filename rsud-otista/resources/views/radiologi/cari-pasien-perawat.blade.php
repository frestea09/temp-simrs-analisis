...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
		...
		{!! Form::close() !!} --}}
    {!! Form::open(['method' => 'POST', 'url' => 'radiologi/cari-pasien-perawat', 'class'=>'form-horizontal']) !!}
      <div class="row">
        <div class="col-md-4">
      ...
      <table class='table table-striped table-bordered table-hover table-condensed' id='data'>
        ...
        <tbody>
          ...
          @foreach ($registrasi as $key => $d)
              ...
              @endif
              <td>{{ $d->pasien ? $d->pasien->no_rm : '' }}</td>
              <td>{{ $d->pasien ? $d->pasien->nama : '' }}</td>
              ...
              <td class="text-center">
                ...
                <a href="{{ url('radiologi/entry-tindakan-irna/'. @$d->id.'/'.@$d->pasien_id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                @elseif(cek_jenis_reg(@$d->status_reg) == 'Rawat Jalan')  
                <a href="{{ url('radiologi/entry-tindakan-irj/'. @$d->id.'/'.@$d->pasien_id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                @elseif(substr(@$d->status_reg, 0, 1) == 'R')  
                <a href="{{ url('radiologi/entry-transaksi-langsung/'. @$d->id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                @else
                <a href="{{ url('radiologi/insert-kunjungan/'. $d->id.'/'.$d->pasien_id) }}" target="_blank" class="btn btn-danger btn-sm btn-info btn-flat"><i class="fa fa-edit"></i></a>
                @endif
              ...
              <td class="text-center">
                @if (@$folioRad > 0)
                 @if (cek_jenis_reg(@$d->status_reg) == 'Rawat Inap')
                  <a href="{{ url('radiologi/cetakRincianRad/irna/'.$d->id) }}" target="_blank" class="btn btn-danger btn-sm btn-flat"><i class="fa fa-print"></i></a>   
                  @elseif(cek_jenis_reg(@$d->status_reg) == 'Rawat Jalan')  
