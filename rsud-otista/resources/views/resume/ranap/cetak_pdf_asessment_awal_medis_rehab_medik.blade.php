...
<body>
    ...
    <table>
        ...
        <tr>
          ...
          <td colspan="5">
            <b>Aktifitas dan Mobilisasi :</b> <br>
            <label for="aktifitas_1">
              <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_1" value="Mandiri" {{ @$asessment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Mandiri' ? 'checked' : '' }}>
              Mandiri
            </label>
            <label for="aktifitas_2">
              <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_2" value="Perlu Bantuan" {{ @$asessment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Perlu Bantuan' ? 'checked' : '' }}>
              Perlu Bantuan
            </label>
            <label for="aktifitas_3">
              <input type="radio" name="fisik[statusFungsional][aktifitasMobilisasi][pilihan]" id="aktifitas_3" value="Alat Bantu Jalan" {{ @$asessment['statusFungsional']['aktifitasMobilisasi']['pilihan'] == 'Alat Bantu Jalan' ? 'checked' : '' }}>
              Alat Bantu Jalan
            </label>
            {{ @$asessment['statusFungsional']['aktifitasMobilisasi']['sebutkan'] }}
          </td>
        </tr>
        <tr>
          <td >
          ...
          <td colspan="5">
            <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
              <tr>
                ...
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanSSP'] }}
                </td> 
              </tr>

              <tr>
                <td colspan="2"><b>Pemeriksaan at Regio (a/r)</b></td>
              </tr>
              <tr>
                <td>a/r Head Neck</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['headNeck'] }}
                </td> 
              </tr>
              <tr>
                <td>a/r Thoraks</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['thoraks'] }}
                </td> 
              </tr>
              <tr>
                <td>a/r Abdomen</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['abdomen'] }}
                </td> 
              </tr>
              <tr>
                <td>a/r Back</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['back'] }}
                </td> 
              </tr>

              <tr>
                <td colspan="2"><b>a/r Anggota Gerak</b></td>
              </tr>
              <tr>
                <td>Look (Decomitas, Pola Jalan)</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['anggotaGerak']['look'] }}
                </td>
              </tr>
              <tr>
                <td>Feel (Tanda Radang, Nyeri Tekan, Tonus Turgor)</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['anggotaGerak']['feel'] }}
                </td>
              </tr>

              <tr>
                <td colspan="2"><b>Movement (ROM, MMT, Nyeri)</b></td>
              </tr>
              <tr>
                <td>Tes Provokasi</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['movement']['tesProvokasi'] }}
                </td>
              </tr>
              <tr>
                <td>Tes Fungsional</td>
                <td>
                  {{ @$asessment['statusLokalis']['pemeriksaanRegio']['movement']['tesFungsional'] }}
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <span><b>Impairment :</b></span> <br>
                  {{@$asessment['diagnosa']['impairment']}} <br>
                <span><b>Disability :</b></span> <br>
                  {{@$asessment['diagnosa']['disability']}} <br>
                <span><b>Handicap :</b></span> <br>
                  {{@$asessment['diagnosa']['handicap']}} <br>
            </td>
        </tr>
        <tr>
            <td style="vertical-align: top;">
