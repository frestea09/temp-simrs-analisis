    ...
    <table>
        <tr>
            ...
            <th colspan="5" style="font-size: 18pt;">
                <b>ASESMEN AWAL MEDIS KULIT &amp; KELAMIN</b>
            </th>
        </tr>
        <tr>
            <td colspan="6">
            ...
            <td colspan="5">
                <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
                      ...
                      <tr>
                        ...
                        <td style="padding: 5px;">
                              {{ @$asessment['status_lokalis']['kepala']['warna_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Tekstur kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['tekstur_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td style="padding: 5px;">
                          <div>
                              <input class="form-check-input"
                                  ...
                                  {{ @$asessment['status_lokalis']['kepala']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                                  type="radio" value="Bentuk lesi">
                              <label class="form-check-label">Bentuk lesi</label>
                              {{@$asessment['status_lokalis']['kepala']['kelainan_detail']}}
                          </div>
                          <div>
                              <input class="form-check-input"
                                  name="fisik[status_lokalis][kepala][kelainan]"
                                  {{ @$asessment['status_lokalis']['kepala']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                      ...
                      <tr>
                        ...
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['tekstur_dan_konsistensi'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Suhu</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['suhu'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Turgor kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['turgor_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['ada_hyponostesia'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya nyeri</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kepala']['ada_nyeri'] }}
                        </td>
                      </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">B. Leher</td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Warna kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['warna_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Tekstur kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['tekstur_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Kelainan / lesi kulit</td>
                        <td style="padding: 5px;">
                          <div>
                              <input class="form-check-input"
                                  ...
                                  {{ @$asessment['status_lokalis']['leher']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                                  type="radio" value="Bentuk lesi">
                              <label class="form-check-label">Bentuk lesi</label>
                              {{@$asessment['status_lokalis']['leher']['kelainan_detail']}}
                          </div>
                          <div>
                              <input class="form-check-input"
                                  name="fisik[status_lokalis][leher][kelainan]"
                                  {{ @$asessment['status_lokalis']['leher']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                                  type="radio" value="Distribusi dan Kontribusi">
                              <label class="form-check-label">Distribusi dan kontribusi</label>
                              {{@$asessment['status_lokalis']['leher']['kelainan_detail']}}
                          </div>
                      ...
                      <tr>
                        <td style="width: 50%;">Tekstur dan Konsistensi</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['tekstur_dan_konsistensi'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Suhu</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['suhu'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Turgor kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['turgor_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['ada_hyponostesia'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya nyeri</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['leher']['ada_nyeri'] }}
                        </td>
                      </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">C. Dada</td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Warna kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['warna_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Tekstur kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['tekstur_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Kelainan / lesi kulit</td>
                        <td style="padding: 5px;">
                          <div>
                              <input class="form-check-input"
                                  ...
                                  {{ @$asessment['status_lokalis']['dada']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                                  type="radio" value="Bentuk lesi">
                              <label class="form-check-label">Bentuk lesi</label>
                              {{@$asessment['status_lokalis']['dada']['kelainan_detail']}}
                          </div>
                          <div>
                              <input class="form-check-input"
                                  name="fisik[status_lokalis][dada][kelainan]"
                                  {{ @$asessment['status_lokalis']['dada']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                                  type="radio" value="Distribusi dan Kontribusi">
                              <label class="form-check-label">Distribusi dan kontribusi</label>
                              {{@$asessment['status_lokalis']['dada']['kelainan_detail']}}
                          </div>
                      ...
                      <tr>
                        <td style="width: 50%;">Tekstur dan Konsistensi</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['tekstur_dan_konsistensi'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Suhu</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['suhu'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Turgor kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['turgor_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['ada_hyponostesia'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya nyeri</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['dada']['ada_nyeri'] }}
                        </td>
                      </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td colspan="5">
                <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        <td colspan="2" style="width: 50%; font-weight: bold;">D. Kaki</td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Warna kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['warna_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Tekstur kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['tekstur_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Kelainan / lesi kulit</td>
                        <td style="padding: 5px;">
                          <div>
                              <input class="form-check-input"
                                  ...
                                  {{ @$asessment['status_lokalis']['kaki']['kelainan'] == 'Bentuk lesi' ? 'checked' : '' }}
                                  type="radio" value="Bentuk lesi">
                              <label class="form-check-label">Bentuk lesi</label>
                              {{@$asessment['status_lokalis']['kaki']['kelainan_detail']}}
                          </div>
                          <div>
                              <input class="form-check-input"
                                  name="fisik[status_lokalis][kaki][kelainan]"
                                  {{ @$asessment['status_lokalis']['kaki']['kelainan'] == 'Distribusi dan Kontribusi' ? 'checked' : '' }}
                                  type="radio" value="Distribusi dan Kontribusi">
                              <label class="form-check-label">Distribusi dan kontribusi</label>
                              {{@$asessment['status_lokalis']['kaki']['kelainan_detail']}}
                          </div>
                      ...
                      <tr>
                        <td style="width: 50%;">Tekstur dan Konsistensi</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['tekstur_dan_konsistensi'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Suhu</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['suhu'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Turgor kulit</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['turgor_kulit'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya hyponostesia / anestesia</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['ada_hyponostesia'] }}
                        </td>
                      </tr>
                      <tr>
                        <td style="width: 50%;">Adanya nyeri</td>
                        <td style="padding: 5px;">
                            {{ @$asessment['status_lokalis']['kaki']['ada_nyeri'] }}
                        </td>
                      </tr>
                </table>
            </td>
