            ...
            <td colspan="5">
                <table style="width: 100%; font-size:12px;" class="table table-striped table-bordered table-hover table-condensed form-box">
                    <tr>
                        ...
                        <td>
                            {{@$asessment['kategori_pemeriksaan']['riwayat_merokok']}}
                        </td>
                      </tr>
                      <tr>
                        <td>Saturasi</td>
                        <td>
                            {{@$asessment['kategori_pemeriksaan']['saturasi']}}
                        </td>
                      </tr>
                      <tr>
                        <td>Skala Nyeri</td>
                        <td>
                            <img src="{{public_path('images/skalaNyeriFix.jpg')}}" alt="" style="width: 200; height: 80px; padding-bottom: 10px;"><br/>
                            Skala Nyeri : {{@$asessment['kategori_pemeriksaan']['skala_nyeri']['pilihan']}}
                        </td>
                      </tr>
                </table>
            </td>
