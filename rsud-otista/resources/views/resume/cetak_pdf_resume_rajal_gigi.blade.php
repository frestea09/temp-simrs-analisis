        ...
        <tr>
            ...
            <td colspan="5">
                ...
                <div>
                    ...
                    Pada {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['waktu'] }}, di {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['lokasi'] }}, dengan diagnosa: {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['diagnosa'] }}
                    @else
                        Tidak
                    @endif
                </div>
        ...
        <tr>
          ...
          <td colspan="5">
            ...
            @if (@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['isDiTetapkan'] == 'true')
                Sudah dapat ditetapkan, {{@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['hari']}} Hari, rencana tanggal pulang pada {{@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['tanggalPulang']}}
            @else
                Belum bisa ditetapkan kerena {{@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['alasan']}}
            @endif
            <br>
            @if (@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['isPerawatanLanjutan'] == 'true')
                Ketika pulang masih memerlukan perawatan lanjutan: {{@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['perawatanLanjutan']}}
            @else
