  ...
  <body>
    ...
    <table>
        ...
        <tr>
          ...
          <td colspan="5">
            - TD : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['tekanan_darah'] }} mmHG &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - Nadi : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['nadi'] }} x/menit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - RR : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['RR'] }} x/menit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - Temp : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['temp'] }} °C &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - Berat Badan : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['BB'] }} Kg &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - Tinggi Badan : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['TB'] }} Cm &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - Lingkar Perut : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['lingkar_perut'] }} Cm &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
            - BMI : {{ @json_decode(@$emrPemeriksaan->fisik, true)['tanda_vital']['BMI'] }} Cm &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <br>
          </td>
        </tr>
        <tr>
          <td>
