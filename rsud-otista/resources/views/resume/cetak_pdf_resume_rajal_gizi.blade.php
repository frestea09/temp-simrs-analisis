    ...
    <table>
        <tr>
            ...
            <th colspan="5" style="font-size: 18pt;">
                <b>ASESMEN AWAL POLIKLINIK {{ baca_poli(@$reg->poli_id) }}</b>
            </th>
        </tr>
        <tr>
            <td colspan="6">
        ...
        <tr>
            ...
            <td colspan="5">
                <div>
                    ...
                    <p>{{ @json_decode(@$soap->fisik, true)['riwayatPenyakitSekarang'] }}</p>
                </div>
                <div>
                    <strong>Riwayat Penyakit Dahulu</strong><br>
                    <p>{{ @json_decode(@$soap->fisik, true)['riwayatPenyakitDahulu'] }}</p>
                </div>
                <div>
                    <strong>Riwayat Penyakit Keluarga</strong><br>
                    <p>{{ @json_decode(@$soap->fisik, true)['riwayatPenyakitKeluarga'] }}</p>
                </div>
                <div>
                    <strong>Riwayat Medis Lainnya</strong><br>
                    <p>{{ @json_decode(@$soap->fisik, true)['riwayatLain'] }}</p>
                </div>
                <div>
                    <strong>Pernah Dirawat</strong><br>
                    @if (@json_decode(@$soap->fisik, true)['isPernahDirawat'] == 'true')
                        Pada {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['waktu'] }}, di
                        {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['lokasi'] }}, dengan diagnosa:
                        {{ @json_decode(@$soap->fisik, true)['pernahDirawat']['diagnosa'] }}
                    @else
                        Tidak
                    @endif
                </div>
        ...
        <tr>
            ...
            <td colspan="5">
                1. Tanda Vital <br />
                - TD : {{ @json_decode(@$soap->fisik, true)['tanda_vital']['tekanan_darah1']['sebutkan'] }} / {{ @json_decode(@$soap->fisik, true)['tanda_vital']['tekanan_darah2']['sebutkan'] }} mmHG
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                2. GCS <br>
                - E: {{ @json_decode(@$soap->fisik, true)['GCS']['E'] ? @json_decode(@$soap->fisik, true)['GCS']['E'] : '-' }}
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                - M: {{ @json_decode(@$soap->fisik, true)['GCS']['M'] ? @json_decode(@$soap->fisik, true)['GCS']['M'] : '-' }}
                - V: {{ @json_decode(@$soap->fisik, true)['GCS']['V'] ? @json_decode(@$soap->fisik, true)['GCS']['V'] : '-' }}
                - Total: {{ @json_decode(@$soap->fisik, true)['GCS']['Total'] ? @json_decode(@$soap->fisik, true)['GCS']['Total'] : '-' }}
                <br /><br />

                4. Kesadaran:  {{ @json_decode(@$soap->fisik, true)['tanda_vital']['kesadaran']['sebutkan'] ? @json_decode(@$soap->fisik, true)['tanda_vital']['kesadaran']['sebutkan'] : '-' }}
                <br /><br />
                5. Keadaan Umum: {{ @json_decode(@$soap->fisik, true)['keadaan_umum'] ? @json_decode(@$soap->fisik, true)['keadaan_umum'] : '-' }}
                <br /><br />

                3. Pemeriksaan Fisik Dokter : <br />
                ...
                <table style="width: 100%;" id="tablePemeriksaanFisik">
                    ...
                    <tr>
                        ...
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['6']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td  style="width:50%">
                    ...
                    <tr>
                        ...
                        <td  style="width:50%">Tidak ada ( A )</td>
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['7']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td  style="width:50%">
                    ...
                    <tr>
                        ...
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['8']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  style="width:50%">Tidak ada  ( A )</td>
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['9']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th style="width:40%;text-align:center">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['10']['skor']}}</span>
                        </th>
                    </tr>
        ...
        <tr>
            <td colspan="2" style="vertical-align: top">
                <b>STATUS PEDIATRI</b>
                <br>
                {{ @json_decode(@$soap->fisik, true)['status_pediatri']['status_gizi'] }}
                <br>
                {{ @json_decode(@$soap->fisik, true)['status_pediatri']['riwayat_imunisasi'] }}
                <br>
                {{ @json_decode(@$soap->fisik, true)['status_pediatri']['riwayat_tumbuh_kembang'] }}
            </td>
                ...
                <table style="width: 100%;" id="tableLokalisGizi">
                    ...
                    <tr>
                        ...
                        <td  style="width:10%" rowspan="5">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['1']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  style="width:10%" rowspan="4">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['2']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td rowspan="3"  style="width:40%">
                            ...
                            <div>
                                ...
                                <span>{{@$assesment['lokalisGizi']['3']['mual']}}</span>
                                <br>
                                

                                <label class="control-lable">Muntah</label>
                                <span>{{@$assesment['lokalisGizi']['3']['muntah']}}</span>
                                <br>
                          
                                    <label class="control-lable">Diare</label>
                                <span>{{@$assesment['lokalisGizi']['3']['diare']}}</span>
                                <br>

                                <label class="control-lable">Anoreksia</label>
                                <span>{{@$assesment['lokalisGizi']['3']['anoreksia']}}</span>
                                <br>
                            </div>
                        </td>
                        <td  style="width:50%">Jika ada beberapa gejala atau tidak ada gejala, sebentar-sebentar ( A )</td>
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['3']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['4']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  style="width:50%">Tidak ada ( A )</td>
                        <td  style="width:10%" rowspan="3">
                            <span style="font-size: 24px;font-weight:bold">{{@json_decode(@$soap->fisik, true)['lokalisGizi']['5']['skor']}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td  style="width:50%">
        ...
        <tr>
            <td colspan="6">
                <b>HASIL SKRINING: </b> {{@json_decode(@$soap->fisik, true)['hasilSkrining']}} <br>
                <b>TINDAK LANJUR SKRINING: </b> 
                {{@json_decode(@$soap->fisik, true)['tindakLanjutSkrining']['monitoring'] != '' ? @json_decode(@$soap->fisik, true)['tindakLanjutSkrining']['monitoring'] . " - " : ''}}
                {{@json_decode(@$soap->fisik, true)['tindakLanjutSkrining']['konseling'] != '' ? @json_decode(@$soap->fisik, true)['tindakLanjutSkrining']['konseling'] : ''}}
                <br>
                <b>KONSELING DAN EDUKASI GIZI: </b> <br>
                - Materi : {{@json_decode(@$soap->fisik, true)['edukasi']['materi']}} <br>
                - Leaflet yang diberikan : {{@json_decode(@$soap->fisik, true)['edukasi']['leaflet']}} <br>
                - Data penting terkait : {{@json_decode(@$soap->fisik, true)['edukasi']['dataPenting']}} <br>
            </td>
        </tr>
        <tr>
            <td colspan="6">
        ...
        <tr>
            ...
            <td colspan="5">
                <strong>Rencana Lama Rawat</strong><br>
                @if (@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['isDiTetapkan'] == 'true')
                    Sudah dapat ditetapkan,
                    {{ @json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['hari'] }} Hari,
                    rencana tanggal pulang pada
                    {{ @json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['tanggalPulang'] }}
                @else
                    Belum bisa ditetapkan kerena
                    {{ @json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['alasan'] }}
                @endif
                <br>
                @if (@json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['isPerawatanLanjutan'] == 'true')
                    Ketika pulang masih memerlukan perawatan lanjutan:
                    {{ @json_decode(@$soap->fisik, true)['dischargePlanning']['rencanaLamaRawat']['perawatanLanjutan'] }}
                @else
