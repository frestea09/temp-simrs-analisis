...
@section('content')
    <div class="box box-primary">
      ...
      <div class="box-body">
        {!! Form::open(['method' => 'POST', 'route' => 'icd10-im.store', 'class' => 'form-horizontal']) !!}

        <div class="form-group{{ $errors->has('icd10') ? ' has-error' : '' }}">
            {!! Form::label('icd10', 'Nama ICD10', ['class' => 'col-sm-3 control-label']) !!}
            <div class="col-sm-9">
              <select name="icd10[]" class="form-control select2" style="width: 100%;" multiple required>
        ...
        <div class="form-group{{ $errors->has('nama_icd10_im') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
                {!! Form::text('nama_icd10_im', null, ['class' => 'form-control']) !!}
