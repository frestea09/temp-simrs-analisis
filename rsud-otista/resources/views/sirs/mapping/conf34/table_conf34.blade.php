...
<div class="box box-primary">
    <div class="box-header with-border">
        ...
        <!-- <a href="{{route('mastermapping_confrl34.index')}}" class="btn btn-default btn-flat">
            <i class="fa fa-plus"></i> List Mapping CONF.RL34 
        </a>         -->
    </div>
    <div class="box-body">
        <div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class='table-responsive'>
                                <table id='table_conf_rl34' class='table table-striped table-bordered table-hover table-condensed'>
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Kegiatan</th>
...
<script type="text/javascript">
    $(document).ready(function(e) {
        var table = $('#viewMapping').DataTable({
            ...
            ajax: {
                url: '{{ route("data-mastermapping_confrl34") }}',
                data: {
                    jenis: 'laporan'
                }
            },            columns: [{
    ...
    function editForm(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                console.log(data);
                $('input[name="id"]').val(data.id_conf_rl34)
    ...
    function saveForm() {
        ...
        if (id == '') {
            url = '{{ route("mastermapping_confrl34.store") }}';
            type = 'POST';
        } else {
    ...
    function detailconfrl34(id) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            success: function(data) {
                $('.modal-title').text('Conf.RL34  ' + data.kegiatan)
            }
        });


        $('#table_conf_rl34').DataTable({
            'language': {
    ...
    function hapusMapping(conf_rl34_id, tarif_id) {
        if (confirm('Yakin akan dihapus') == true) {
            $.ajax({
                    url: '/hapus-conf-rl34/' + tarif_id,
                    type: 'GET',
                    dataType: 'json',
                })
                .done(function(data) {
                    detailconfrl34(conf_rl34_id)
                });
