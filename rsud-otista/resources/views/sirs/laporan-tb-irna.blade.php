@extends('master')
@section('header')
  <h1>Laporan 10 Besar TB IRNA </h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'sirs/rl/laporan-tb-irna', 'class'=>'form-horizontal']) !!}
      <div class="row">
        {{-- <div class="col-md-2">
        ...
        <div class='table-responsive'>
          <table class='table table-striped table-bordered table-hover table-condensed' id="data">
            ...
            <tbody>
              ...
              // $ranap = App\Rawatinap::where('registrasi_id', $d->registrasi_id)->first();
              ...
              @endphp
                ...
                <tr>
                  ...
                  <td>{{ baca_kelompok(@$d->kelompok) }}</td>
                  <td>{{ Carbon\Carbon::parse(@$d->tgl_masuk)->format('d-m-Y') }}</td>
                  <td>{{ Carbon\Carbon::parse(@$d->tgl_keluar)->format('d-m-Y') }}</td>
