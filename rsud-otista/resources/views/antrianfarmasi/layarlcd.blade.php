  ...
  <div class="row">
    <div class="col-md-12">
      <div id="judul" class="text-center">
        Antrian Loket "Farmasi" <br>{{ configrs()->nama }}<BR></div>
    </div>
  </div>
    <div class="row">
      <div class="col-md-12">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd').load("{{ route('antrianfarmasi.datalayarlcd1') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd2').load("{{ route('antrianfarmasi.datalayarlcd2') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd3').load("{{ route('antrianfarmasi.datalayarlcd3') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        setInterval(function () {
          $('#layarlcd4').load("{{ route('antrianfarmasi.datalayarlcd4') }}");
        },9000); //normal 13000
      });
    </script>
    ...
    <script>
      $(document).ready(function() {
        ...
        function myAjax() {
            $.ajax({
              url: '{{ url("/") }}/antrian-farmasi/layarlcd/nextantrian',
              type: 'get',
              contentType: false,
              processData: false,
