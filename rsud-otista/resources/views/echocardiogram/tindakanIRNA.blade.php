...
@section('header')
  <h1>Billing System Echocardiogram - Rawat Inap </h1>
@endsection
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('vendor/laravel-filemanager/img/folder.png') }}">
    ...
    <div class="box box-primary">
      ...
      <div class="box-body">
        ...
        {!! Form::open(['method' => 'POST', 'url' => 'echocardiogram/tindakan-irna', 'class'=>'form-hosizontal']) !!}
        <div class="row">
          <div class="col-md-6">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="POST" class="form-horizontal" id="formEkspertise">
              ...
              <input type="hidden" name="jenis" value="TI">
