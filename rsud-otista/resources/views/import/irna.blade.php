           ...
           <div class="form-group{{ $errors->has('carabayar') ? ' has-error' : '' }}">
            ...
            <div class="form-group{{ $errors->has('jenis') ? ' has-error' : '' }}">
              ...
              {{--<div class="form-group{{ $errors->has('kelas_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    {!! Form::select('kelas_id', Modules\Kategoritarif\Entities\Kategoritarif::pluck('namatarif', 'id'), null, ['class' => 'chosen-select']) !!}
                    <select name="kelas_id" class="form-control chosen-select">
                      <option value=""></option>
                      @foreach (Modules\Kelas\Entities\Kelas::all() as $d)
            ...
            <div class="form-group{{ $errors->has('nama'.$i) ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    ...
                    <select class="form-control chosen-select" name="nama{{ $i }}">
                      <option value=""></option>
                      @foreach (App\Mastersplit::where('kategoriheader_id', 4)->get() as $key => $d)
