      ...
      <div class="rows">
        <div class="col-md-8">
          @php
            $kategori_header = 1;
          @endphp
          {!! Form::open(['method' => 'POST', 'route' => 'import-irj', 'class' => 'form-horizontal','files'=>true]) !!}

            <div class="form-group">
                {!! Form::label('inputname', 'Download Template', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-9">
                  <a href="{{ route('template-irj') }}" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-cloud-download"></i> DOWNLOAD </a>
                </div>
            </div>
            ...
            <div class="form-group{{ $errors->has('jenis') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-9">
                    ...
                    @endphp --}}
                    {!! Form::select('jenis', ['TA'=>'TA'], null, ['class' => 'chosen-select']) !!}
