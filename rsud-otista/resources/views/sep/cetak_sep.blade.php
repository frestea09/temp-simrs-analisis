      ...
      <tr>
        <td>
          <table>
            ...
            <tr>
              <td>DPJP Yg Melayani</td> <td>: 
                @if (@$reg->rawat_inap->dokter_id)
                  {{ baca_dokter($reg->rawat_inap->dokter_id) }}
                @else
        ...
        <td>
          <table>
            ...
            <tr>
              <td style="padding-left:30px; text-align:center;" colspan="2" class="text-center">
