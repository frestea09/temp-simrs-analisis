        ...
        <div class="row">
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" value="{{ $user_gudang }}" class="form-control"  readonly="true" disabled>
              </div>
            </div>
            <div class="form-group">
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" readonly="true" name="sisa_stock_tujuan" class="form-control" disabled>
              </div>
            </div>
             <div class="form-group">
