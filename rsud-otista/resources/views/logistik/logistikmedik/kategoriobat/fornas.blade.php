...
@section('header')
  <h1>
    <small>Kategori Obat</small> Fornas
...
<script type="text/javascript">
  ...
  function masterObat() {
    $('#dataObat').modal('show')
    $('.modal-title').text('Tambahkan Obat Fornas')
    $('input[name="kategoriobat"]').val('fornas');
  }
