@extends('master')
@section('header')
  <h1>Logistik Non Medik - Master Sub Kelompok</h1>
@endsection
...
@section('script')
  <script type="text/javascript">
    ...
    function edit(id){
      ...
      $.get('/logistiknonmedik/sub-kelompok/'+id+'/edit', function(resp){
    ...
    function save(){
        ...
        if(id == ''){
            var url = '{{ route('sub-kelompok.store') }}'
        } else {
            var url = '/logistiknonmedik/sub-kelompok/'+id
        }
