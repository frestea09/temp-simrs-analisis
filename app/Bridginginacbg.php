...
class Bridginginacbg extends Model
{
  function getKey()
  {
    $keyRS = "fdebbbf559baacee2576b7d9984775e6a195d4f4dc9ff3a7ed62bc5b99d1b35e";
    return $keyRS;
  }

  function getUrlWS()
  {
    $UrlWS = "http://10.10.10.4/E-Klaim/ws.php";
    return $UrlWS;
  }
  ...
  function Request($request) {
    $json   = mc_encrypt($request, $this->getKey());
    ...
    $hasildecrypt  = mc_decrypt($hasilresponse, $this->getKey());
    //echo $hasildecrypt;
