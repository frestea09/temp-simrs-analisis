    ...
    <div class="col-md-12">
        ...
        <form id="form-bc" method="POST" action="" accept-charset="UTF-8">
            ...
            <div class="row" id="section-cek-mr">
                ...
                <div class="col-md-12 dataMR d-none mt-1">
    ...
    if(no_rm != ''){
        ...
        .done(function(data) {
            ...
            if (data.status == 200) {
                ...
                $('#dataPasien').html('<table><tr> <th>No.RM</th><td>'+(val.no_rm)+'</td></tr><tr><th>Nama</th><td>'+(val.nama)+
                    ...
                    +'</td></tr><tr><th>&nbsp;</th><td class="text-left"><button type="button" onclick="printKarcisKlinik()" class="btn btn-success btn-pilih col-form-label btn-sm"><i class="fa fa-arrow-right"></i> &nbsp;Lanjutkan</button></td></tr></table>');
