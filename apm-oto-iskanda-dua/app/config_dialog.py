...
def open_config_dialog(root: tk.Tk):
    ...
    entries = {
        ...
        "BPJS Endpoint Tambah Antrean": tk.StringVar(value=config.BPJS_ANTREAN_ADD_ENDPOINT),
        "BPJS Endpoint Update Waktu": tk.StringVar(value=config.BPJS_ANTREAN_UPDATE_ENDPOINT),
        "API Endpoint Registrasi Dummy": tk.StringVar(value=config.API_REGISTRATION_DUMMY_ENDPOINT),
        "Judul Tiket Admisi": tk.StringVar(value=config.ADMISSION_TICKET_TITLE),
        "Pesan Tiket Admisi": tk.StringVar(value=config.ADMISSION_TICKET_MESSAGE),
    ...
    def save_config():
        try:
            updated_settings = {
                ...
                "BPJS_ANTREAN_ADD_ENDPOINT": entries["BPJS Endpoint Tambah Antrean"].get(),
                "BPJS_ANTREAN_UPDATE_ENDPOINT": entries["BPJS Endpoint Update Waktu"].get(),
                "API_REGISTRATION_DUMMY_ENDPOINT": entries["API Endpoint Registrasi Dummy"].get(),
                "ADMISSION_TICKET_TITLE": entries["Judul Tiket Admisi"].get(),
                "ADMISSION_TICKET_MESSAGE": entries["Pesan Tiket Admisi"].get(),
