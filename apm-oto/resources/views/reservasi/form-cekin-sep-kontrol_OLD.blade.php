                    ...
                    <thead>
                      ...
                      <tr>
                        ...
                        <td> 
                          ...
                          <input type="text" id="diagnosa_awal" name="diagnosa_awal" class="form-control" value="{{@$data[1]['rujukan']['diagnosa']['kode']}}"/>
                        </td>
                     ...
                     <tr id="row_ppk_rujukan" style="display:none;">
                          ...
                          <td>
                              <input type="text" readonly name="ppk_rujukan" id="ppk_text" value="1002R006" disabled>
                              <input type="text" readonly name="nama_ppk_rujukan" id="nama_ppk_text" value="RSUD OTISTA" disabled>
                          </td>
                      </tr>
                      {{-- <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          @else --}}
                            <input type="text" id="noSurat" name="noSurat" class="form-control" value="{{$no_surkon}}"/>
                          {{-- @endif  --}}
                        </td> 
                      </tr>
                      <tr>
                        ...
                        <td> 
                            ...
                            <select name="jenisKunjungan" class="form-control select2" style="width:100%">
                              <option value="3" {{ old('jenisKunjungan', '') == '3' ? 'selected' : '' }}>Kontrol</option>
                                <option value="1" {{ old('jenisKunjungan', '') == '1' ? 'selected' : '' }}>Rujukan FKTP (POST RAWAT)</option>
                                <option value="2" {{ old('jenisKunjungan', '') == '2' ? 'selected' : '' }}>Rujukan Internal</option>
                                <option value="4" {{ old('jenisKunjungan', '') == '4' ? 'selected' : '' }}>Rujukan Antar RS</option>
                            </select>
                      ...
                      <tr>
                        ...
                        <td> 
                            ...
                            <select name="flagProcedure" class="form-control" style="width:100%">
                                <option value="">--Lewati Jika Tujuan Kunjungan "Normal"--</option>
                                <option value="0" {{ old('flagProcedure') == '0' ? 'selected' : '' }}>Prosedur Tidak Berkelanjutan</option>
                                <option value="1" {{ old('flagProcedure') == '1' ? 'selected' : '' }}>Prosedur dan Terapi Berkelanjutan</option>
                            </select>
                        ...
                        <tr>
                          ...
                          <td> 
                            ...
                            <select name="kdPenunjang" class="form-control" style="width:100%">
                                  <option value="">--Lewati Jika Tujuan Kunjungan "Normal"--</option>
                                  <option value="1" {{ old('kdPenunjang') == '1' ? 'selected' : '' }}>Radioterapi</option>
                                  <option value="2" {{ old('kdPenunjang') == '2' ? 'selected' : '' }}>Kemoterapi</option>
                                  <option value="3" {{ old('kdPenunjang') == '3' ? 'selected' : '' }}>Rehabilitasi Medik</option>
                                  <option value="4" {{ old('kdPenunjang') == '4' ? 'selected' : '' }}>Rehabilitasi Psikososial</option>
                                  <option value="5" {{ old('kdPenunjang') == '5' ? 'selected' : '' }}>Transfusi Darah</option>
                                  <option value="6" {{ old('kdPenunjang') == '6' ? 'selected' : '' }}>Pelayanan Gigi</option>
                                  <option value="7" {{ old('kdPenunjang') == '7' ? 'selected' : '' }}>Laboratorium</option>
                                  <option value="8" {{ old('kdPenunjang') == '8' ? 'selected' : '' }}>USG</option>
                                  <option value="9" {{ old('kdPenunjang') == '9' ? 'selected' : '' }}>Farmasi</option>
                                  <option value="10" {{ old('kdPenunjang') == '10' ? 'selected' : '' }}>Lain-Lain</option>
                                  <option value="11" {{ old('kdPenunjang') == '11' ? 'selected' : '' }}>MRI</option>
                                  <option value="12" {{ old('kdPenunjang') == '12' ? 'selected' : '' }}>Hemodialisa</option>
                              </select>
                          </td> 
                        </tr>
                        {{-- @endif  --}}
                        <tr>
                          ...
                          <td> 
                            ...
                            <select name="assesmentPel" class="form-control" style="width:100%">
                                <option value="">--Lewati Jika Tujuan Kunjungan "Normal"--</option>
                                <option value="1" {{ old('assesmentPel') == '1' ? 'selected' : '' }}>Poli spesialis tidak tersedia pada hari sebelumnya</option>
                                <option value="2" {{ old('assesmentPel') == '2' ? 'selected' : '' }}>Jam Poli telah berakhir pada hari sebelumnya</option>
                                <option value="3" {{ old('assesmentPel') == '3' ? 'selected' : '' }}>Dokter Spesialis yang dimaksud tidak praktek pada hari sebelumnya</option>
                                <option value="4" {{ old('assesmentPel') == '4' ? 'selected' : '' }}>Atas Instruksi RS</option>
                                <option value="5" {{ old('assesmentPel') == '5' ? 'selected' : '' }}>Tujuan Kontrol</option>
                            </select>
                      ...
                      <tr>
                        <th>Dokter</th>
                        <td>
                          <input type="hidden" name="dokter_id" value="{{@$dataSkdp['kodeDokter']}}_{{baca_dokter_bpjs(@$dataSkdp['kodeDokter'])}}_{{@$regdum->jampraktek}}_{{@$regdum->kode_poli}}_{{@baca_kode_poli($regdum->kode_poli)}}" class="form-control">
                          @php
                              @$dokter = \App\Models\Pegawai::where('kode_bpjs',@$dataSkdp['kodeDokter'])->first();
                          @endphp
                          {{$dokter->nama}}
                          {{-- @if ($kode_hfis == 201) --}}
...
$(document).ready(function() {
    function handleJenisKunjungan() {
        var jenis = $('select[name="jenisKunjungan"]').val();
        ...
        if (jenis == '3') {
            // Jika Kontrol → Konsul Dokter
            tujuanKunj.val('2').trigger('change');
        } else {
            // Selain Kontrol → Normal
            tujuanKunj.val('0').trigger('change');
        }
