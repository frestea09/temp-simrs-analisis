...
@section('content')
<div class="container">
    <span class="text-center" style="display: block;font-size:20px;font-weight:900;color:green">SEP RAWAT JALAN KUNJUNGAN PERTAMA</span>
  ...
  .done(function(data) {
    ...
    if (data.status == 200) {
      ...
      if(data.result.status == 'pending'){
        ...
        cetak2 = '<a onclick="disableButton2()"; class="btn btn-danger btncheckin2 btn-sm" href="/reservasi/sep/'+data.result.id+'/'+data.result.no_rm+'">SEP <span class="fa fa-print"></span></a>';
