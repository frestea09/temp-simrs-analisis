                        ...
                        {{-- <form action="" method="post" class="enlarged"> --}}
                            ...
                            <div class="row box" style="margin-right: -180px !important;    margin-left: 15px !important;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="box-title3">PASIEN BARU (RUJUKAN BARU)</div>
                                </div> 
                                <div class="col-md-3">
                                    <div class="box-center">
                                        <div id="btn_saderek_2">
                                            <img src="{{asset('rsud/img/button/led-circle-yellow-md.png')}}" width="200px">
                                        </div>
                                    </div>
                                    <div class="box-title3">PASIEN KONTROL</div>
                                </div> 
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btn_saderek_2').click(function(event) {
            window.location.href = "{{URL::to('reservasi/cek-kontrol')}}"
        });
