...
<html>
  ...
  <body onload="print()">
      ...
      <table style="width:100%" cellpadding="5">
        ...
        {{-- {{dd($data->registrasi)}} --}}
        <tr>
          <td style="width:50px;font-weight:bold;">KODE BPJS</td><td style="width:20px;">:</td> <td><b style="color:green;font-size:15px;">
            {{-- {{substr(@$data->nomorantrian,8,6)}} --}}
            {{-- {{$data['kode_poli'].$data['angkaantrian']}} --}}
            {{$data->nomorantrian}}
      ...
      <table style="width:100%" cellpadding="5">
        ...
        {{-- <tr>
          <td style="width:100px;font-weight:bold;">Kode MJKN</td><td>:</td> <td><b>{{substr(@$data->nomorantrian,8,5)}}</b></td>
        </tr> --}}
