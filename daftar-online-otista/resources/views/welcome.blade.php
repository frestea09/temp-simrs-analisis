...
<div id="modalPilihPoliklinik" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="success-header-modalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-full-width modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h4 class="modal-title text-white" id="success-header-modalLabel">Pilih Poliklinik</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body">
                <form action="" name="form-detail" method="post" accept-charset="utf-8"  enctype="multipart/form-data">
                    ...
                    <div style="padding:10px;">
                        ...
                        <div class="row">
                                                                <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('INT','Klinik Penyakit Dalam','893')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Penyakit Dalam</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('GIG','Klinik Gigi dan Mulut','896')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Gigi dan Mulut</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('BDM','Klinik Bedah Mulut','897')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Bedah Mulut</span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('BED','Klinik Bedah','898')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Bedah</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('MAT','Klinik Mata','904')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Mata</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('GIZ','Klinik Gizi','907')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Gizi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('IRM','Klinik Rehabilitasi Medik (Fisioterapi)','909')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Rehabilitasi Medik (Fisioterapi)</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('HIV','Klinik DOTS','910')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik DOTS</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('OBG','Klinik Kebidanan dan Kandungan','913')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Kebidanan dan Kandungan</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('JAN','Klinik Jantung','914')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Jantung</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('THT','Klinik THT','915')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik THT</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('KLT','Klinik Kulit dan Kelamin','935')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Kulit dan Kelamin</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('MCU','Medical Check Up','918')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Medical Check Up</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('ORT','Klinik Orthopedi','937')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Orthopedi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('SAR','Klinik Saraf','939')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Saraf</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('ANA','Klinik Anak','941')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Anak</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('JIW','Klinik Psikiatri','942')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Psikiatri</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('','Klinik ASTER (Eksekutif Anak)','943')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik ASTER (Eksekutif Anak)</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('HIV','Klinik Kemuning','944')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Kemuning</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('GND','Klinik GIGI ENDODONSI','945')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik GIGI ENDODONSI</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('032','Klinik Jantung Anak','1128')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Jantung Anak</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('','P2TP2A','1143')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">P2TP2A</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('KEM','Klinik Kemoterapi','1130')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Kemoterapi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('BDA','Klinik Bedah Anak','1188')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Bedah Anak</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('BSY','Klinik Bedah Saraf','1198')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Bedah Saraf</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('HDL','HEMODIALISA','1199')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">HEMODIALISA</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('ANT','Klinik Anestesi','983')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Anestesi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('GER','Klinik Geriatri','947')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Geriatri</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('','Klinik Hematologi dan Onkologi','946')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Hematologi dan Onkologi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('PAA','Klinik Patologi Anatomi','982')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Patologi Anatomi</span>
                                                                        ...
                                                                        <div class="col-md-4">
                                        <div class="card bg-orange text-white" onclick="pilih_jadwal('','Klinik Laktasi','981')">
                                            <div class="card-body">
                                                <div class="no-block align-items-center text-center">
                                                    
                                                    <span style="vertical-align: middle; text-align: center;" class="items text-white">Klinik Laktasi</span>
    ...
    <div class="modal-dialog modal-lg" role="document" style="max-width:1000px !important">
      <div class="modal-content">
        <div class="modal-header">
          <h2 class="modal-title" id="modalSayaLabel">PILIH POLIKLINIK</h2>
