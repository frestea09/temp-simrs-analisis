    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          ...
          <a href="{{ route('journal_memorial.create') }}" class="btn btn-default btn-sm"><i class="fa fa-plus"></i></a>
        </h3>
      </div>
      <div class="box-body">
            ...
            <tbody>
              @foreach ($data as $d)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('journal_memorial.show', $d['id']) }}" class="btn btn-success btn-sm"><i class="fa fa-info"></i></a>
                    @if ($d['verifikasi'] == 0)
