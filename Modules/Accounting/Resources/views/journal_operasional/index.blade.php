...
@section('content')
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          Data Jurnal Penerimaan &nbsp;
        </h3>
      </div>
      <div class="box-body">
        {!! Form::open(['method' => 'POST', 'url' => 'accounting/journal_operasional', 'class'=>'form-horizontal']) !!}
        <div class="row">
          <div class="col-md-12">
            ...
            <tbody>
              @foreach ($data as $d)
                <tr>
                  ...
                  <td>
                    <a href="{{ route('journal_operasional.show', $d['id']) }}" class="btn btn-success btn-sm"><i class="fa fa-info"></i></a>
                    @if ($d['verifikasi'] == 0)
                      <a href="{{ route('journal_operasional.verifikasi', $d['id']) }}" class="btn btn-sm btn-info btn-flat"><i class="fa fa-credit-card"></i></a>
                    @endif
                    @if (isset($d['id']))
                      <a href="{{ route('journal_operasional.edit', $d['id']) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                    @endif
                  </td>
                </tr>
              @endforeach
