@extends('master')
@section('header')
  <h1>Laporan Jurnal Pengeluaran </h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      <div class="row">
        {!! Form::open(['method' => 'POST', 'url' => 'accounting/laporan/journal_pengeluaran', 'class'=>'form-horizontal']) !!}
        <div class="col-md-6">
        ...
        {!! Form::close() !!}
        {!! Form::open(['method' => 'POST', 'url' => 'accounting/laporan/journal_pengeluaran_export', 'class' =>
        'form-horizontal']) !!}
        <div class="col-md-6">
            <div class="form-group">
