@extends('master')
@section('header')
  <h1>Laporan Realisasi Anggaran Pengeluaran </h1>
@endsection
...
@section('content')
  <div class="box box-primary">
    ...
    <div class="box-body">
      {!! Form::open(['method' => 'POST', 'url' => 'accounting/laporan/realisasi_anggaran_pengeluaran', 'class'=>'form-horizontal']) !!}
      <div class="row">
        <div class="col-md-4">
        ...
        <table class='table table-striped table-bordered table-hover table-condensed' id='laporan_akutansi'>
          <thead>
            <tr>
              ...
              <th colspan="3">@if (isset($tha)) {{$tha}} @else - @endif</th>
