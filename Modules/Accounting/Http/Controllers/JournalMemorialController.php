...
class JournalMemorialController extends Controller
{
    ...
    {
        $getJournal['data'] = Journal::with('journal_detail')->where('type', 'journal_memorial')->orderBy('tanggal')->get()->toArray();
        ...
        return view('accounting::journal_memorial.index', $getJournal);
    }
    ...
    public function create()
    {
        ...
        return view('accounting::journal_memorial.add-edit', $data);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($journalDetail as $jd) {
                ...
                $jd['type']         = 'journal_memorial';

                JournalDetail::create($jd);
            }

            DB::commit();
            Flashy::success('Data Journal Memorial Berhasil Di Tambahkan');
            return redirect(route('journal_memorial.index'));
        } catch (\Exception $e) {
            DB::rollback();
    ...
    public function show($id)
    {
        ...
        return view('accounting::journal_memorial.detail', $getJournal);
    }
