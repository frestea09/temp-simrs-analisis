...
class JournalPengeluaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('accounting::journal_pengeluaran.index', $getJournal);
    }
    ...
    public function show($id)
    {
        ...
        // return $getJournal;
        // return $getJournal;
        return view('accounting::journal_pengeluaran.detail', $getJournal);
    }
    ...
    public function verifikasi($id)
    {
        ...
        return view('accounting::journal_pengeluaran.verifikasi', $getJournal);
    }
    public function verifikasiVerif($id)
    {
        ...
        return redirect('accounting/journal_pengeluaran/' . $id);
    }
    ...
    public function edit($id)
    {
        ...
        return view('accounting::journal_pengeluaran.edit', $data);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            return redirect(route('journal_pengeluaran.show', $id));
        } catch (\Exception $e) {
            DB::rollback();
