...
Route::post('rekap-antrian', 'ApiController@rekapAntrian');
Route::post('operasi', 'ApiController@Operasi');
Route::post('search-operasi', 'ApiController@tanggalOperasi');
Route::post('sisa-antrian', 'ApiController@sisaAntrian');
Route::post('batal-antrian', 'ApiController@batalAntrian');
Route::post('cek-in', 'ApiController@cekIn');
Route::post('pasien-baru', 'ApiController@pasienBaru');

Route::get('tambah-antrian', 'ApiController@tambahAntrian');
Route::get('updatewaktu', 'ApiController@updatewaktu');
Route::get('batal-antrian', 'ApiController@batalAntrianBpjs');
